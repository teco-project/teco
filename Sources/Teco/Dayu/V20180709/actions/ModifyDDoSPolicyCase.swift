...
extension Dayu {
    ...
    public struct ModifyDDoSPolicyCaseRequest: TCRequest {
    ...
    public struct ModifyDDoSPolicyCaseResponse: TCResponse {
        /// 成功码
