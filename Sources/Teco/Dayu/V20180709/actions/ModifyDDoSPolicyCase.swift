...
extension Dayu {
    ...
    public struct ModifyDDoSPolicyCaseRequest: TCRequestModel {
        ...
        public init (business: String, sceneId: String, platformTypes: [String]?, appType: String?, appProtocols: [String]?, tcpSportStart: String?, tcpSportEnd: String?, udpSportStart: String?, udpSportEnd: String?, hasAbroad: String?, hasInitiateTcp: String?, hasInitiateUdp: String?, peerTcpPort: String?, peerUdpPort: String?, tcpFootprint: String?, udpFootprint: String?, webApiUrl: [String]?, minTcpPackageLen: String?, maxTcpPackageLen: String?, minUdpPackageLen: String?, maxUdpPackageLen: String?, hasVPN: String?, tcpPortList: String?, udpPortList: String?) {
