...
extension Eb {
    /// PublishEvent请求参数结构体
    public struct PublishEventRequest: TCRequest {
        /// 事件列表
    ...
    /// PublishEvent返回参数结构体
    public struct PublishEventResponse: TCResponse {
    ...
    public func publishEvent(eventList: [Event], eventBusId: String, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PublishEventResponse> {
        self.publishEvent(.init(eventList: eventList, eventBusId: eventBusId), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func publishEvent(eventList: [Event], eventBusId: String, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> PublishEventResponse {
        try await self.publishEvent(.init(eventList: eventList, eventBusId: eventBusId), region: region, logger: logger, on: eventLoop)
    }
}
