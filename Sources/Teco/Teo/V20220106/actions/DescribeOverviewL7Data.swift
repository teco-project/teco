...
extension Teo {
    ...
    /// 本接口（DescribeOverviewL7Data）用于查询七层监控类时序流量数据。
    @inlinable
    public func describeOverviewL7Data(startTime: Date, endTime: Date, metricNames: [String], interval: String, zoneIds: [String]? = nil, domains: [String]? = nil, protocol: String? = nil, area: String? = nil, filters: [QueryCondition]? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture < DescribeOverviewL7DataResponse > {
        self.describeOverviewL7Data(DescribeOverviewL7DataRequest(startTime: startTime, endTime: endTime, metricNames: metricNames, interval: interval, zoneIds: zoneIds, domains: domains, protocol: `protocol`, area: area, filters: filters), logger: logger, on: eventLoop)
    }
    ...
    /// 本接口（DescribeOverviewL7Data）用于查询七层监控类时序流量数据。
    @inlinable
    public func describeOverviewL7Data(startTime: Date, endTime: Date, metricNames: [String], interval: String, zoneIds: [String]? = nil, domains: [String]? = nil, protocol: String? = nil, area: String? = nil, filters: [QueryCondition]? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeOverviewL7DataResponse {
        try await self.describeOverviewL7Data(DescribeOverviewL7DataRequest(startTime: startTime, endTime: endTime, metricNames: metricNames, interval: interval, zoneIds: zoneIds, domains: domains, protocol: `protocol`, area: area, filters: filters), logger: logger, on: eventLoop)
    }
}
