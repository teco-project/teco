...
extension Teo {
    ...
    /// 查询所有DDoS防护分区
    @inlinable
    public func describeZoneDDoSPolicy(zoneId: String? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture < DescribeZoneDDoSPolicyResponse > {
        self.describeZoneDDoSPolicy(DescribeZoneDDoSPolicyRequest(zoneId: zoneId), logger: logger, on: eventLoop)
    }
    
    /// 查询所有DDoS防护分区
    @inlinable
    public func describeZoneDDoSPolicy(zoneId: String? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeZoneDDoSPolicyResponse {
        try await self.describeZoneDDoSPolicy(DescribeZoneDDoSPolicyRequest(zoneId: zoneId), logger: logger, on: eventLoop)
    }
}
