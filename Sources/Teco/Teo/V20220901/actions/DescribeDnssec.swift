...
extension Teo {
    ...
    /// 用于查询 DNSSEC 相关信息
    @inlinable
    public func describeDnssec(zoneId: String, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDnssecResponse> {
        self.describeDnssec(DescribeDnssecRequest(zoneId: zoneId), region: region, logger: logger, on: eventLoop)
    }
    ...
    /// 用于查询 DNSSEC 相关信息
    @inlinable
    public func describeDnssec(zoneId: String, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeDnssecResponse {
        try await self.describeDnssec(DescribeDnssecRequest(zoneId: zoneId), region: region, logger: logger, on: eventLoop)
    }
}
