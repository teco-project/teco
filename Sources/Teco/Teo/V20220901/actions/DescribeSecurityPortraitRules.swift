...
extension Teo {
    ...
    /// 查询Bot用户画像规则
    @inlinable
    public func describeSecurityPortraitRules(zoneId: String? = nil, entity: String? = nil, templateId: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeSecurityPortraitRulesResponse> {
        self.describeSecurityPortraitRules(DescribeSecurityPortraitRulesRequest(zoneId: zoneId, entity: entity, templateId: templateId), region: region, logger: logger, on: eventLoop)
    }

    /// 查询Bot用户画像规则
    @inlinable
    public func describeSecurityPortraitRules(zoneId: String? = nil, entity: String? = nil, templateId: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeSecurityPortraitRulesResponse {
        try await self.describeSecurityPortraitRules(DescribeSecurityPortraitRulesRequest(zoneId: zoneId, entity: entity, templateId: templateId), region: region, logger: logger, on: eventLoop)
    }
}
