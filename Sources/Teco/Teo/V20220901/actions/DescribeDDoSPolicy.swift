...
extension Teo {
    ...
    /// 查询DDoS防护配置详情
    @inlinable
    public func describeDDoSPolicy(zoneId: String, policyId: Int64, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDDoSPolicyResponse> {
        self.describeDDoSPolicy(DescribeDDoSPolicyRequest(zoneId: zoneId, policyId: policyId), region: region, logger: logger, on: eventLoop)
    }

    /// 查询DDoS防护配置详情
    @inlinable
    public func describeDDoSPolicy(zoneId: String, policyId: Int64, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeDDoSPolicyResponse {
        try await self.describeDDoSPolicy(DescribeDDoSPolicyRequest(zoneId: zoneId, policyId: policyId), region: region, logger: logger, on: eventLoop)
    }
}
