...
extension Teo {
    ...
    public struct DescribeOriginProtectionRequest: TCRequestModel {
        /// 查询的站点集合，不填默认查询所有站点。
    ...
    public struct DescribeOriginProtectionResponse: TCResponseModel {
        /// 源站防护信息。
    ...
    public func describeOriginProtection(zoneIds: [String]? = nil, filters: [Filter]? = nil, offset: Int64? = nil, limit: Int64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeOriginProtectionResponse> {
        self.describeOriginProtection(DescribeOriginProtectionRequest(zoneIds: zoneIds, filters: filters, offset: offset, limit: limit), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func describeOriginProtection(zoneIds: [String]? = nil, filters: [Filter]? = nil, offset: Int64? = nil, limit: Int64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeOriginProtectionResponse {
        try await self.describeOriginProtection(DescribeOriginProtectionRequest(zoneIds: zoneIds, filters: filters, offset: offset, limit: limit), region: region, logger: logger, on: eventLoop)
    }
}
