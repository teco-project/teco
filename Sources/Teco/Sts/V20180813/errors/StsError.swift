public struct TCStsError: TCErrorType {
    enum Code: String {
...
extension TCStsError {
    public static var domains: [TCErrorType.Type] {
        return [AuthFailure.self, InternalError.self, InvalidParameter.self, ResourceNotFound.self]
    }
}

extension TCStsError: Equatable {
    public static func == (lhs: TCStsError, rhs: TCStsError) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCStsError: CustomStringConvertible {
