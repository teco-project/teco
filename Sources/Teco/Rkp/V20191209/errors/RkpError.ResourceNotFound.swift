...
extension TCRkpError.ResourceNotFound: Equatable {
    public static func == (lhs: TCRkpError.ResourceNotFound, rhs: TCRkpError.ResourceNotFound) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCRkpError.ResourceNotFound: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCRkpError.ResourceNotFound {
