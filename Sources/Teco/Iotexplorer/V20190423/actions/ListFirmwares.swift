...
extension Iotexplorer {
    ...
    public func listFirmwaresPaginator(_ input: ListFirmwaresRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> (results: TCClient.Paginator<ListFirmwaresRequest, ListFirmwaresResponse>.ResultSequence, responses: TCClient.Paginator<ListFirmwaresRequest, ListFirmwaresResponse>.ResponseSequence) {
        let results = TCClient.Paginator<ListFirmwaresRequest, ListFirmwaresResponse>.ResultSequence(input: input, region: region, command: self.listFirmwares, logger: logger, on: eventLoop)
        let responses = TCClient.Paginator<ListFirmwaresRequest, ListFirmwaresResponse>.ResponseSequence(input: input, region: region, command: self.listFirmwares, logger: logger, on: eventLoop)
