...
extension Iotexplorer {
    ...
    public struct CreateStudioProductRequest: TCRequest {
    ...
    public struct CreateStudioProductResponse: TCResponse {
        /// 产品描述
    ...
    public func createStudioProduct(productName: String, categoryId: Int64, productType: Int64, encryptionType: String, netType: String, dataProtocol: Int64, productDesc: String, projectId: String, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateStudioProductResponse> {
        self.createStudioProduct(.init(productName: productName, categoryId: categoryId, productType: productType, encryptionType: encryptionType, netType: netType, dataProtocol: dataProtocol, productDesc: productDesc, projectId: projectId), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func createStudioProduct(productName: String, categoryId: Int64, productType: Int64, encryptionType: String, netType: String, dataProtocol: Int64, productDesc: String, projectId: String, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateStudioProductResponse {
        try await self.createStudioProduct(.init(productName: productName, categoryId: categoryId, productType: productType, encryptionType: encryptionType, netType: netType, dataProtocol: dataProtocol, productDesc: productDesc, projectId: projectId), region: region, logger: logger, on: eventLoop)
    }
}
