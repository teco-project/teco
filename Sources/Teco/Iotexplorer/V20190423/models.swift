...
extension Iotexplorer {
    ...
    public struct InstanceDetail: TCOutputModel {
        ...
        /// 支持设备总数
        public let totalDeviceNum: Int64

        /// 以注册设备数
        public let usedDeviceNum: Int64

        /// 项目数
        public let projectNum: Int64

        /// 产品数
        public let productNum: Int64
        ...
        /// 总设备数
        /// 注意：此字段可能返回 null，表示取不到有效值。
        public let totalDevice: Int64?

        /// 激活设备数
        /// 注意：此字段可能返回 null，表示取不到有效值。
        public let activateDevice: Int64?
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case region = "Region"
            case zoneId = "ZoneId"
            case totalDeviceNum = "TotalDeviceNum"
            case usedDeviceNum = "UsedDeviceNum"
            case projectNum = "ProjectNum"
            case productNum = "ProductNum"
            case createTime = "CreateTime"
            case updateTime = "UpdateTime"
            case expireTime = "ExpireTime"
            case totalDevice = "TotalDevice"
            case activateDevice = "ActivateDevice"
        }
    }
