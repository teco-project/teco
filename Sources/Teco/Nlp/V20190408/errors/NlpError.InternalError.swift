...
extension TCNlpError.InternalError: Equatable {
    public static func == (lhs: TCNlpError.InternalError, rhs: TCNlpError.InternalError) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCNlpError.InternalError: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCNlpError.InternalError {
