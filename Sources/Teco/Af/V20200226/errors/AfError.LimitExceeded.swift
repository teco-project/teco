...
extension TCAfError.LimitExceeded: Equatable {
    public static func == (lhs: TCAfError.LimitExceeded, rhs: TCAfError.LimitExceeded) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCAfError.LimitExceeded: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCAfError.LimitExceeded {
