...
extension TCAfError.InvalidParameter: Equatable {
    public static func == (lhs: TCAfError.InvalidParameter, rhs: TCAfError.InvalidParameter) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCAfError.InvalidParameter: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCAfError.InvalidParameter {
