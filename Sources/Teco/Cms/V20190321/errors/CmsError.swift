public struct TCCmsError: TCErrorType {
    enum Code: String {
...
extension TCCmsError: Equatable {
    public static func == (lhs: TCCmsError, rhs: TCCmsError) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCCmsError: CustomStringConvertible {
