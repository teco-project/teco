...
extension Cdn {
    /// AddCdnDomain请求参数结构体
    public struct AddCdnDomainRequest: TCRequest {
        /// 域名
    ...
    /// AddCdnDomain返回参数结构体
    public struct AddCdnDomainResponse: TCResponse {
    ...
    /// AddCdnDomain 用于新增内容分发网络加速域名。1分钟内最多可新增100个域名。
    @inlinable @discardableResult
    public func addCdnDomain(domain: String, serviceType: String, origin: Origin, projectId: Int64? = nil, ipFilter: IpFilter? = nil, ipFreqLimit: IpFreqLimit? = nil, statusCodeCache: StatusCodeCache? = nil, compression: Compression? = nil, bandwidthAlert: BandwidthAlert? = nil, rangeOriginPull: RangeOriginPull? = nil, followRedirect: FollowRedirect? = nil, errorPage: ErrorPage? = nil, requestHeader: RequestHeader? = nil, responseHeader: ResponseHeader? = nil, downstreamCapping: DownstreamCapping? = nil, cacheKey: CacheKey? = nil, responseHeaderCache: ResponseHeaderCache? = nil, videoSeek: VideoSeek? = nil, cache: Cache? = nil, originPullOptimization: OriginPullOptimization? = nil, https: Https? = nil, authentication: Authentication? = nil, seo: Seo? = nil, forceRedirect: ForceRedirect? = nil, referer: Referer? = nil, maxAge: MaxAge? = nil, ipv6: Ipv6? = nil, specificConfig: SpecificConfig? = nil, area: String? = nil, originPullTimeout: OriginPullTimeout? = nil, tag: [Tag]? = nil, ipv6Access: Ipv6Access? = nil, offlineCache: OfflineCache? = nil, quic: Quic? = nil, awsPrivateAccess: AwsPrivateAccess? = nil, ossPrivateAccess: OssPrivateAccess? = nil, hwPrivateAccess: HwPrivateAccess? = nil, qnPrivateAccess: QnPrivateAccess? = nil, othersPrivateAccess: OthersPrivateAccess? = nil, httpsBilling: HttpsBilling? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AddCdnDomainResponse> {
        self.addCdnDomain(.init(domain: domain, serviceType: serviceType, origin: origin, projectId: projectId, ipFilter: ipFilter, ipFreqLimit: ipFreqLimit, statusCodeCache: statusCodeCache, compression: compression, bandwidthAlert: bandwidthAlert, rangeOriginPull: rangeOriginPull, followRedirect: followRedirect, errorPage: errorPage, requestHeader: requestHeader, responseHeader: responseHeader, downstreamCapping: downstreamCapping, cacheKey: cacheKey, responseHeaderCache: responseHeaderCache, videoSeek: videoSeek, cache: cache, originPullOptimization: originPullOptimization, https: https, authentication: authentication, seo: seo, forceRedirect: forceRedirect, referer: referer, maxAge: maxAge, ipv6: ipv6, specificConfig: specificConfig, area: area, originPullTimeout: originPullTimeout, tag: tag, ipv6Access: ipv6Access, offlineCache: offlineCache, quic: quic, awsPrivateAccess: awsPrivateAccess, ossPrivateAccess: ossPrivateAccess, hwPrivateAccess: hwPrivateAccess, qnPrivateAccess: qnPrivateAccess, othersPrivateAccess: othersPrivateAccess, httpsBilling: httpsBilling), region: region, logger: logger, on: eventLoop)
    }
    ...
    /// AddCdnDomain 用于新增内容分发网络加速域名。1分钟内最多可新增100个域名。
    @inlinable @discardableResult
    public func addCdnDomain(domain: String, serviceType: String, origin: Origin, projectId: Int64? = nil, ipFilter: IpFilter? = nil, ipFreqLimit: IpFreqLimit? = nil, statusCodeCache: StatusCodeCache? = nil, compression: Compression? = nil, bandwidthAlert: BandwidthAlert? = nil, rangeOriginPull: RangeOriginPull? = nil, followRedirect: FollowRedirect? = nil, errorPage: ErrorPage? = nil, requestHeader: RequestHeader? = nil, responseHeader: ResponseHeader? = nil, downstreamCapping: DownstreamCapping? = nil, cacheKey: CacheKey? = nil, responseHeaderCache: ResponseHeaderCache? = nil, videoSeek: VideoSeek? = nil, cache: Cache? = nil, originPullOptimization: OriginPullOptimization? = nil, https: Https? = nil, authentication: Authentication? = nil, seo: Seo? = nil, forceRedirect: ForceRedirect? = nil, referer: Referer? = nil, maxAge: MaxAge? = nil, ipv6: Ipv6? = nil, specificConfig: SpecificConfig? = nil, area: String? = nil, originPullTimeout: OriginPullTimeout? = nil, tag: [Tag]? = nil, ipv6Access: Ipv6Access? = nil, offlineCache: OfflineCache? = nil, quic: Quic? = nil, awsPrivateAccess: AwsPrivateAccess? = nil, ossPrivateAccess: OssPrivateAccess? = nil, hwPrivateAccess: HwPrivateAccess? = nil, qnPrivateAccess: QnPrivateAccess? = nil, othersPrivateAccess: OthersPrivateAccess? = nil, httpsBilling: HttpsBilling? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> AddCdnDomainResponse {
        try await self.addCdnDomain(.init(domain: domain, serviceType: serviceType, origin: origin, projectId: projectId, ipFilter: ipFilter, ipFreqLimit: ipFreqLimit, statusCodeCache: statusCodeCache, compression: compression, bandwidthAlert: bandwidthAlert, rangeOriginPull: rangeOriginPull, followRedirect: followRedirect, errorPage: errorPage, requestHeader: requestHeader, responseHeader: responseHeader, downstreamCapping: downstreamCapping, cacheKey: cacheKey, responseHeaderCache: responseHeaderCache, videoSeek: videoSeek, cache: cache, originPullOptimization: originPullOptimization, https: https, authentication: authentication, seo: seo, forceRedirect: forceRedirect, referer: referer, maxAge: maxAge, ipv6: ipv6, specificConfig: specificConfig, area: area, originPullTimeout: originPullTimeout, tag: tag, ipv6Access: ipv6Access, offlineCache: offlineCache, quic: quic, awsPrivateAccess: awsPrivateAccess, ossPrivateAccess: ossPrivateAccess, hwPrivateAccess: hwPrivateAccess, qnPrivateAccess: qnPrivateAccess, othersPrivateAccess: othersPrivateAccess, httpsBilling: httpsBilling), region: region, logger: logger, on: eventLoop)
    }
}
