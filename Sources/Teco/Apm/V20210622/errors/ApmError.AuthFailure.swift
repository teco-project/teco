...
extension TCApmError.AuthFailure: Equatable {
    public static func == (lhs: TCApmError.AuthFailure, rhs: TCApmError.AuthFailure) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCApmError.AuthFailure: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCApmError.AuthFailure {
