...
extension Bmlb {
    ...
    public struct SetTrafficMirrorHealthSwitchRequest: TCRequestModel {
        ...
        public init (trafficMirrorId: String, healthSwitch: Int64, healthNum: Int64?, unhealthNum: Int64?, intervalTime: Int64?, httpCheckDomain: String?, httpCheckPath: String?, httpCodes: [Int64]?) {
