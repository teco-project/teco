...
extension TCTcbError.AuthFailure: Equatable {
    public static func == (lhs: TCTcbError.AuthFailure, rhs: TCTcbError.AuthFailure) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCTcbError.AuthFailure: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCTcbError.AuthFailure {
