...
extension TCTcbError.OperationDenied: Equatable {
    public static func == (lhs: TCTcbError.OperationDenied, rhs: TCTcbError.OperationDenied) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCTcbError.OperationDenied: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCTcbError.OperationDenied {
