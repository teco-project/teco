...
extension Monitor {
    ...
    public struct DescribeAlarmHistoriesRequest: TCPaginatedRequest {
        ...
        public func getNextPaginatedRequest(with response: DescribeAlarmHistoriesResponse) -> DescribeAlarmHistoriesRequest? {
    ...
    public func describeAlarmHistories(module: String, pageNumber: Int64? = nil, pageSize: Int64? = nil, order: String? = nil, startTime: Int64? = nil, endTime: Int64? = nil, monitorTypes: [String]? = nil, alarmObject: String? = nil, alarmStatus: [String]? = nil, projectIds: [Int64]? = nil, instanceGroupIds: [Int64]? = nil, namespaces: [MonitorTypeNamespace]? = nil, metricNames: [String]? = nil, policyName: String? = nil, content: String? = nil, receiverUids: [Int64]? = nil, receiverGroups: [Int64]? = nil, policyIds: [String]? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeAlarmHistoriesResponse> {
        ...
        return self.client.execute(action: "DescribeAlarmHistories", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeAlarmHistoriesPaginator(_ input: DescribeAlarmHistoriesRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> (results: TCClient.Paginator<DescribeAlarmHistoriesRequest, DescribeAlarmHistoriesResponse>.ResultSequence, responses: TCClient.Paginator<DescribeAlarmHistoriesRequest, DescribeAlarmHistoriesResponse>.ResponseSequence) {
        let results = TCClient.Paginator<DescribeAlarmHistoriesRequest, DescribeAlarmHistoriesResponse>.ResultSequence(input: input, region: region, command: self.describeAlarmHistories, logger: logger, on: eventLoop)
        let responses = TCClient.Paginator<DescribeAlarmHistoriesRequest, DescribeAlarmHistoriesResponse>.ResponseSequence(input: input, region: region, command: self.describeAlarmHistories, logger: logger, on: eventLoop)
