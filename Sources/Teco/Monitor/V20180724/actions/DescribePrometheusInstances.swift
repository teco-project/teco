...
extension Monitor {
    ...
    public struct DescribePrometheusInstancesRequest: TCPaginatedRequest {
    ...
    public struct DescribePrometheusInstancesResponse: TCPaginatedResponse {
        /// 实例详细信息列表。
        ...
        /// Extract the returned ``PrometheusInstancesItem`` list from the paginated response.
        public func getItems() -> [PrometheusInstancesItem] {
            self.instanceSet ?? []
        }
