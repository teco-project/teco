...
extension Monitor {
    ...
    public struct DescribeAccidentEventListRequest: TCPaginatedRequest {
        /// 接口模块名，当前接口取值monitor
        ...
        public func makeNextRequest(with response: DescribeAccidentEventListResponse) -> DescribeAccidentEventListRequest? {
    ...
    public struct DescribeAccidentEventListResponse: TCPaginatedResponse {
        /// 平台事件列表
        ...
        /// Extract the returned ``DescribeAccidentEventListAlarms`` list from the paginated response.
        public func getItems() -> [DescribeAccidentEventListAlarms] {
            self.alarms ?? []
        }
