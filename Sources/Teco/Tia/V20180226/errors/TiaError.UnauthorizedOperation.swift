...
extension TCTiaError.UnauthorizedOperation: Equatable {
    public static func == (lhs: TCTiaError.UnauthorizedOperation, rhs: TCTiaError.UnauthorizedOperation) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCTiaError.UnauthorizedOperation: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCTiaError.UnauthorizedOperation {
