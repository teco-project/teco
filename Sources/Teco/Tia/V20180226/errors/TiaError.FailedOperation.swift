...
extension TCTiaError.FailedOperation: Equatable {
    public static func == (lhs: TCTiaError.FailedOperation, rhs: TCTiaError.FailedOperation) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCTiaError.FailedOperation: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCTiaError.FailedOperation {
