...
extension Ecm {
    ...
    /// 每个子网只能分配一个IPv6网段。
    @inlinable
    public func assignIpv6SubnetCidrBlock(vpcId: String, ipv6SubnetCidrBlocks: [Ipv6SubnetCidrBlock], ecmRegion: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<AssignIpv6SubnetCidrBlockResponse> {
        self.assignIpv6SubnetCidrBlock(.init(vpcId: vpcId, ipv6SubnetCidrBlocks: ipv6SubnetCidrBlocks, ecmRegion: ecmRegion), region: region, logger: logger, on: eventLoop)
    }
    ...
    /// 每个子网只能分配一个IPv6网段。
    @inlinable
    public func assignIpv6SubnetCidrBlock(vpcId: String, ipv6SubnetCidrBlocks: [Ipv6SubnetCidrBlock], ecmRegion: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> AssignIpv6SubnetCidrBlockResponse {
        try await self.assignIpv6SubnetCidrBlock(.init(vpcId: vpcId, ipv6SubnetCidrBlocks: ipv6SubnetCidrBlocks, ecmRegion: ecmRegion), region: region, logger: logger, on: eventLoop)
    }
}
