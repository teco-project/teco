...
extension TCEcmError.ResourceNotFound: Equatable {
    public static func == (lhs: TCEcmError.ResourceNotFound, rhs: TCEcmError.ResourceNotFound) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCEcmError.ResourceNotFound: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCEcmError.ResourceNotFound {
