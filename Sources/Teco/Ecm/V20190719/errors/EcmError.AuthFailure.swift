...
extension TCEcmError.AuthFailure: Equatable {
    public static func == (lhs: TCEcmError.AuthFailure, rhs: TCEcmError.AuthFailure) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCEcmError.AuthFailure: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCEcmError.AuthFailure {
