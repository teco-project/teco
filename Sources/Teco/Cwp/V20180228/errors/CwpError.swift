public struct TCCwpError: TCErrorType {
    enum Code: String {
...
extension TCCwpError {
    public static var domains: [TCErrorType.Type] {
        return [FailedOperation.self, InternalError.self, InvalidParameter.self, InvalidParameterValue.self, LimitExceeded.self]
    }
}

extension TCCwpError: Equatable {
    public static func == (lhs: TCCwpError, rhs: TCCwpError) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCCwpError: CustomStringConvertible {
