...
extension Cwp {
    ...
    public struct DescribeLicenseListRequest: TCPaginatedRequest {
        ...
        public func getNextPaginatedRequest(with response: DescribeLicenseListResponse) -> DescribeLicenseListRequest? {
            guard !response.getItems().isEmpty else {
                return nil
            }
            return DescribeLicenseListRequest(filters: self.filters, limit: self.limit, offset: (self.offset ?? 0) + .init(response.getItems().count), tags: self.tags)
        }
    }
