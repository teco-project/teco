...
extension Iotcloud {
    ...
    public struct CreateDeviceRequest: TCRequestModel {
        ...
        public init (productId: String, deviceName: String, attribute: Attribute, definedPsk: String?, isp: UInt64?, imei: String?, loraDevEui: String?, loraMoteType: UInt64?, skey: String?, loraAppKey: String?) {
