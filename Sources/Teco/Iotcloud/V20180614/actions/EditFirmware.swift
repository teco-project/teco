...
extension Iotcloud {
    /// EditFirmware请求参数结构体
    public struct EditFirmwareRequest: TCRequest {
        /// 产品ID。
    ...
    /// EditFirmware返回参数结构体
    public struct EditFirmwareResponse: TCResponse {
    ...
    public func editFirmware(productID: String, firmwareVersion: String, firmwareName: String, firmwareDescription: String? = nil, fwType: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<EditFirmwareResponse> {
        self.editFirmware(.init(productID: productID, firmwareVersion: firmwareVersion, firmwareName: firmwareName, firmwareDescription: firmwareDescription, fwType: fwType), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func editFirmware(productID: String, firmwareVersion: String, firmwareName: String, firmwareDescription: String? = nil, fwType: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> EditFirmwareResponse {
        try await self.editFirmware(.init(productID: productID, firmwareVersion: firmwareVersion, firmwareName: firmwareName, firmwareDescription: firmwareDescription, fwType: fwType), region: region, logger: logger, on: eventLoop)
    }
}
