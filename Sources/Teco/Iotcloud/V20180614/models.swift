...
extension Iotcloud {
    ...
    /// 批量发消息请求
    public struct BatchPublishMessage: TCInputModel {
    ...
    /// 批量更新设备影子任务
    public struct BatchUpdateShadow: TCInputModel {
        /// 设备影子的期望状态，格式为 Json 对象序列化之后的字符串
        public let desired: String

        public init(desired: String) {
    ...
    /// 设备资源信息。
    public struct DeviceProperty: TCOutputModel {
        /// 产品ID。
        /// 注意：此字段可能返回 null，表示取不到有效值。
        public let productId: String?
    ...
    /// 创建设备时返回的设备信息
    public struct MultiDevicesInfo: TCOutputModel {
        /// 设备名
        public let deviceName: String
    ...
    public struct PayloadLogItem: TCOutputModel {
        ...
        /// 内容格式类型
        public let payloadFmtType: String
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case topic = "Topic"
            case payloadFmtType = "PayloadFmtType"
            case payload = "Payload"
            case requestID = "RequestID"
    ...
    public struct Task: TCInputModel {
        ...
        enum CodingKeys: String, CodingKey {
            case updateShadowTask = "UpdateShadowTask"
            case publishMessageTask = "PublishMessageTask"
        }
    }
