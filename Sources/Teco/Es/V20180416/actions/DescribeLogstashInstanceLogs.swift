...
extension Es {
    ...
    public struct DescribeLogstashInstanceLogsRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribeLogstashInstanceLogsResponse) -> DescribeLogstashInstanceLogsRequest? {
    ...
    /// 查询用户该地域下符合条件的Logstash实例的日志
    ///
    /// - Returns: `AsyncSequence`s of ``InstanceLog`` and ``DescribeLogstashInstanceLogsResponse`` that can be iterated over asynchronously on demand.
    @inlinable
