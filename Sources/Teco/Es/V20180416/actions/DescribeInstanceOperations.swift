...
extension Es {
    ...
    public struct DescribeInstanceOperationsRequest: TCPaginatedRequest {
        ...
        public func getNextPaginatedRequest(with response: DescribeInstanceOperationsResponse) -> DescribeInstanceOperationsRequest? {
    ...
    /// 查询实例指定条件下的操作记录
    @inlinable
    public func describeInstanceOperationsPaginator(_ input: DescribeInstanceOperationsRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> (results: TCClient.Paginator<DescribeInstanceOperationsRequest, DescribeInstanceOperationsResponse>.ResultSequence, responses: TCClient.Paginator<DescribeInstanceOperationsRequest, DescribeInstanceOperationsResponse>.ResponseSequence) {
        let results = TCClient.Paginator<DescribeInstanceOperationsRequest, DescribeInstanceOperationsResponse>.ResultSequence(input: input, region: region, command: self.describeInstanceOperations, logger: logger, on: eventLoop)
        let responses = TCClient.Paginator<DescribeInstanceOperationsRequest, DescribeInstanceOperationsResponse>.ResponseSequence(input: input, region: region, command: self.describeInstanceOperations, logger: logger, on: eventLoop)
