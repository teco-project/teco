...
extension Sqlserver {
    ...
    /// 本接口（CreateBusinessDBInstances）用于创建商业智能服务实例。
    @inlinable
    public func createBusinessDBInstances(zone: String, memory: Int64, storage: Int64, cpu: Int64, machineType: String, projectId: Int64? = nil, goodsNum: Int64? = nil, subnetId: String? = nil, vpcId: String? = nil, dbVersion: String? = nil, securityGroupList: [String]? = nil, weekly: [Int64]? = nil, startTime: String? = nil, span: Int64? = nil, resourceTags: [ResourceTag]? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateBusinessDBInstancesResponse> {
        self.createBusinessDBInstances(CreateBusinessDBInstancesRequest(zone: zone, memory: memory, storage: storage, cpu: cpu, machineType: machineType, projectId: projectId, goodsNum: goodsNum, subnetId: subnetId, vpcId: vpcId, dbVersion: dbVersion, securityGroupList: securityGroupList, weekly: weekly, startTime: startTime, span: span, resourceTags: resourceTags), logger: logger, on: eventLoop)
    }
    ...
    /// 本接口（CreateBusinessDBInstances）用于创建商业智能服务实例。
    @inlinable
    public func createBusinessDBInstances(zone: String, memory: Int64, storage: Int64, cpu: Int64, machineType: String, projectId: Int64? = nil, goodsNum: Int64? = nil, subnetId: String? = nil, vpcId: String? = nil, dbVersion: String? = nil, securityGroupList: [String]? = nil, weekly: [Int64]? = nil, startTime: String? = nil, span: Int64? = nil, resourceTags: [ResourceTag]? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateBusinessDBInstancesResponse {
        try await self.createBusinessDBInstances(CreateBusinessDBInstancesRequest(zone: zone, memory: memory, storage: storage, cpu: cpu, machineType: machineType, projectId: projectId, goodsNum: goodsNum, subnetId: subnetId, vpcId: vpcId, dbVersion: dbVersion, securityGroupList: securityGroupList, weekly: weekly, startTime: startTime, span: span, resourceTags: resourceTags), logger: logger, on: eventLoop)
    }
}
