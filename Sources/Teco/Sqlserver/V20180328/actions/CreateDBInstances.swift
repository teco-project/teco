...
extension Sqlserver {
    ...
    /// 本接口（CreateDBInstances）用于创建实例。
    @inlinable
    public func createDBInstances(zone: String, memory: Int64, storage: Int64, instanceChargeType: String? = nil, projectId: Int64? = nil, goodsNum: Int64? = nil, subnetId: String? = nil, vpcId: String? = nil, period: Int64? = nil, autoVoucher: Int64? = nil, voucherIds: [String]? = nil, dbVersion: String? = nil, autoRenewFlag: Int64? = nil, securityGroupList: [String]? = nil, weekly: [Int64]? = nil, startTime: String? = nil, span: Int64? = nil, haType: String? = nil, multiZones: Bool? = nil, resourceTags: [ResourceTag]? = nil, collation: String? = nil, timeZone: String? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture < CreateDBInstancesResponse > {
        self.createDBInstances(CreateDBInstancesRequest(zone: zone, memory: memory, storage: storage, instanceChargeType: instanceChargeType, projectId: projectId, goodsNum: goodsNum, subnetId: subnetId, vpcId: vpcId, period: period, autoVoucher: autoVoucher, voucherIds: voucherIds, dbVersion: dbVersion, autoRenewFlag: autoRenewFlag, securityGroupList: securityGroupList, weekly: weekly, startTime: startTime, span: span, haType: haType, multiZones: multiZones, resourceTags: resourceTags, collation: collation, timeZone: timeZone), logger: logger, on: eventLoop)
    }
    ...
    /// 本接口（CreateDBInstances）用于创建实例。
    @inlinable
    public func createDBInstances(zone: String, memory: Int64, storage: Int64, instanceChargeType: String? = nil, projectId: Int64? = nil, goodsNum: Int64? = nil, subnetId: String? = nil, vpcId: String? = nil, period: Int64? = nil, autoVoucher: Int64? = nil, voucherIds: [String]? = nil, dbVersion: String? = nil, autoRenewFlag: Int64? = nil, securityGroupList: [String]? = nil, weekly: [Int64]? = nil, startTime: String? = nil, span: Int64? = nil, haType: String? = nil, multiZones: Bool? = nil, resourceTags: [ResourceTag]? = nil, collation: String? = nil, timeZone: String? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateDBInstancesResponse {
        try await self.createDBInstances(CreateDBInstancesRequest(zone: zone, memory: memory, storage: storage, instanceChargeType: instanceChargeType, projectId: projectId, goodsNum: goodsNum, subnetId: subnetId, vpcId: vpcId, period: period, autoVoucher: autoVoucher, voucherIds: voucherIds, dbVersion: dbVersion, autoRenewFlag: autoRenewFlag, securityGroupList: securityGroupList, weekly: weekly, startTime: startTime, span: span, haType: haType, multiZones: multiZones, resourceTags: resourceTags, collation: collation, timeZone: timeZone), logger: logger, on: eventLoop)
    }
}
