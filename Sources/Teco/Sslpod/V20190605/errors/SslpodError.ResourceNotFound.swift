...
extension TCSslpodError.ResourceNotFound: Equatable {
    public static func == (lhs: TCSslpodError.ResourceNotFound, rhs: TCSslpodError.ResourceNotFound) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCSslpodError.ResourceNotFound: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCSslpodError.ResourceNotFound {
