...
extension Mariadb {
    ...
    public struct ModifyAccountPrivilegesRequest: TCRequestModel {
        ...
        /// 注意，不传该参数表示保留现有权限，如需清除，请在复杂类型Privileges字段传空数组。
        public let functionPrivileges: [FunctionPrivilege]?

        /// 数据库存储过程的权限。Privileges 权限的可选值为："ALTER ROUTINE"，"EXECUTE"。
        /// 注意，不传该参数表示保留现有权限，如需清除，请在复杂类型Privileges字段传空数组。
        public let procedurePrivileges: [ProcedurePrivilege]?

        public init(instanceId: String, accounts: [Account], globalPrivileges: [String]? = nil, databasePrivileges: [DatabasePrivilege]? = nil, tablePrivileges: [TablePrivilege]? = nil, columnPrivileges: [ColumnPrivilege]? = nil, viewPrivileges: [ViewPrivileges]? = nil, functionPrivileges: [FunctionPrivilege]? = nil, procedurePrivileges: [ProcedurePrivilege]? = nil) {
            ...
            self.functionPrivileges = functionPrivileges
            self.procedurePrivileges = procedurePrivileges
        }
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case functionPrivileges = "FunctionPrivileges"
            case procedurePrivileges = "ProcedurePrivileges"
        }
    }
    ...
    /// - 不传该参数表示保留现有权限，如需清除，请在复杂类型Privileges字段传空数组
    @inlinable
    public func modifyAccountPrivileges(instanceId: String, accounts: [Account], globalPrivileges: [String]? = nil, databasePrivileges: [DatabasePrivilege]? = nil, tablePrivileges: [TablePrivilege]? = nil, columnPrivileges: [ColumnPrivilege]? = nil, viewPrivileges: [ViewPrivileges]? = nil, functionPrivileges: [FunctionPrivilege]? = nil, procedurePrivileges: [ProcedurePrivilege]? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ModifyAccountPrivilegesResponse> {
    ...
    /// - 不传该参数表示保留现有权限，如需清除，请在复杂类型Privileges字段传空数组
    @inlinable
    public func modifyAccountPrivileges(instanceId: String, accounts: [Account], globalPrivileges: [String]? = nil, databasePrivileges: [DatabasePrivilege]? = nil, tablePrivileges: [TablePrivilege]? = nil, columnPrivileges: [ColumnPrivilege]? = nil, viewPrivileges: [ViewPrivileges]? = nil, functionPrivileges: [FunctionPrivilege]? = nil, procedurePrivileges: [ProcedurePrivilege]? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ModifyAccountPrivilegesResponse {
