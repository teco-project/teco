...
extension Mariadb {
    ...
    public struct DescribeBackupFilesRequest: TCPaginatedRequest {
        ...
        public init(instanceId: String? = nil, backupType: String? = nil, startTime: String? = nil, endTime: String? = nil, limit: Int64? = nil, offset: Int64? = nil, orderBy: String? = nil, orderType: String? = nil) {
        ...
        public func makeNextRequest(with response: DescribeBackupFilesResponse) -> DescribeBackupFilesRequest? {
            ...
            return DescribeBackupFilesRequest(instanceId: self.instanceId, backupType: self.backupType, startTime: self.startTime, endTime: self.endTime, limit: self.limit, offset: (self.offset ?? 0) + .init(response.getItems().count), orderBy: self.orderBy, orderType: self.orderType)
        }
    }
    ...
    /// 本接口(DescribeBackupFiles)用于查看备份文件列表。
    @inlinable
    public func describeBackupFiles(instanceId: String? = nil, backupType: String? = nil, startTime: String? = nil, endTime: String? = nil, limit: Int64? = nil, offset: Int64? = nil, orderBy: String? = nil, orderType: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeBackupFilesResponse> {
        self.describeBackupFiles(.init(instanceId: instanceId, backupType: backupType, startTime: startTime, endTime: endTime, limit: limit, offset: offset, orderBy: orderBy, orderType: orderType), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func describeBackupFiles(instanceId: String? = nil, backupType: String? = nil, startTime: String? = nil, endTime: String? = nil, limit: Int64? = nil, offset: Int64? = nil, orderBy: String? = nil, orderType: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeBackupFilesResponse {
        try await self.describeBackupFiles(.init(instanceId: instanceId, backupType: backupType, startTime: startTime, endTime: endTime, limit: limit, offset: offset, orderBy: orderBy, orderType: orderType), region: region, logger: logger, on: eventLoop)
    }
