...
extension Mps {
    ...
    /// 删除雪碧图模板。
    @inlinable
    public func deleteImageSpriteTemplate(definition: UInt64, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture < DeleteImageSpriteTemplateResponse > {
        self.deleteImageSpriteTemplate(DeleteImageSpriteTemplateRequest(definition: definition), logger: logger, on: eventLoop)
    }
    ...
    /// 删除雪碧图模板。
    @inlinable
    public func deleteImageSpriteTemplate(definition: UInt64, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteImageSpriteTemplateResponse {
        try await self.deleteImageSpriteTemplate(DeleteImageSpriteTemplateRequest(definition: definition), logger: logger, on: eventLoop)
    }
}
