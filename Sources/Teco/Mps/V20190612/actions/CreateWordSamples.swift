...
extension Mps {
    ...
    /// 该接口用于批量创建关键词样本，样本用于通过OCR、ASR技术，进行不适宜内容识别、内容识别等视频处理。
    @inlinable
    public func createWordSamples(usages: [String], words: [AiSampleWordInfo], logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateWordSamplesResponse {
        try await self.createWordSamples(CreateWordSamplesRequest(usages: usages, words: words), logger: logger, on: eventLoop)
    }
}
