...
extension Mps {
    ...
    public struct ModifyPersonSampleRequest: TCRequestModel {
        ...
        public init (personId: String, name: String?, description: String?, usages: [String]?, faceOperationInfo: AiSampleFaceOperation, tagOperationInfo: AiSampleTagOperation) {
