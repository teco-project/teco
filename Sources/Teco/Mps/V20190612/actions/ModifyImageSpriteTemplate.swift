...
extension Mps {
    ...
    public struct ModifyImageSpriteTemplateRequest: TCRequestModel {
        ...
        public init (definition: UInt64, name: String?, width: UInt64?, height: UInt64?, resolutionAdaptive: String?, sampleType: String?, sampleInterval: UInt64?, rowCount: UInt64?, columnCount: UInt64?, fillType: String?, comment: String?, format: String?) {
