...
extension Mps {
    ...
    public struct ProcessLiveStreamRequest: TCRequestModel {
        ...
        public init (url: String, taskNotifyConfig: LiveStreamTaskNotifyConfig, outputStorage: TaskOutputStorage, outputDir: String?, aiContentReviewTask: AiContentReviewTaskInput, aiRecognitionTask: AiRecognitionTaskInput, sessionId: String?, sessionContext: String?) {
            self.url = url
