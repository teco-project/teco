...
extension Mps {
    ...
    public struct DescribeStreamLinkFlowStatisticsRequest: TCRequestModel {
        /// 传输流ID。
    ...
    public struct DescribeStreamLinkFlowStatisticsResponse: TCResponseModel {
        /// 传输流的媒体数据列表。
        public let infos: [FlowStatisticsArray]
