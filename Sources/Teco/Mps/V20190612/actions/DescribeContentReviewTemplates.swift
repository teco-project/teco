...
extension Mps {
    ...
    public struct DescribeContentReviewTemplatesRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribeContentReviewTemplatesResponse) -> DescribeContentReviewTemplatesRequest? {
    ...
    public struct DescribeContentReviewTemplatesResponse: TCPaginatedResponse {
        ...
        /// Extract the returned ``ContentReviewTemplateItem`` list from the paginated response.
    ...
    public func describeContentReviewTemplates(definitions: [Int64]? = nil, offset: UInt64? = nil, limit: UInt64? = nil, type: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeContentReviewTemplatesResponse> {
        self.describeContentReviewTemplates(.init(definitions: definitions, offset: offset, limit: limit, type: type), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func describeContentReviewTemplates(definitions: [Int64]? = nil, offset: UInt64? = nil, limit: UInt64? = nil, type: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeContentReviewTemplatesResponse {
        try await self.describeContentReviewTemplates(.init(definitions: definitions, offset: offset, limit: limit, type: type), region: region, logger: logger, on: eventLoop)
    }
