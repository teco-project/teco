...
extension Mps {
    ...
    public func createSampleSnapshotTemplate(sampleType: String, sampleInterval: UInt64, name: String? = nil, width: UInt64? = nil, height: UInt64? = nil, resolutionAdaptive: String? = nil, format: String? = nil, comment: String? = nil, fillType: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateSampleSnapshotTemplateResponse> {
        let input = CreateSampleSnapshotTemplateRequest(sampleType: sampleType, sampleInterval: sampleInterval, name: name, width: width, height: height, resolutionAdaptive: resolutionAdaptive, format: format, comment: comment, fillType: fillType)
