...
extension Mps {
    ...
    public struct CreateSampleSnapshotTemplateRequest: TCRequestModel {
        ...
        public init (sampleType: String, sampleInterval: UInt64, name: String?, width: UInt64?, height: UInt64?, resolutionAdaptive: String?, format: String?, comment: String?, fillType: String?) {
