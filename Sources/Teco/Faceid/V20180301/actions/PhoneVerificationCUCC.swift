...
extension Faceid {
    ...
    public struct PhoneVerificationCUCCRequest: TCRequest {
        /// 身份证号
    ...
    public struct PhoneVerificationCUCCResponse: TCResponse {
        /// 认证结果码，收费情况如下。
        /// 收费结果码：
        /// 0: 认证通过
    ...
    /// 手机号三要素核验（联通）
    ///
    /// 本接口用于校验中国联通手机号、姓名和身份证号的真实性和一致性。中国联通支持的手机号段详情请查阅[运营商类](https://cloud.tencent.com/document/product/1007/46063)文档。
    @inlinable
