...
extension Lighthouse {
    ...
    public func stopInstances(instanceIds: [String], region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<StopInstancesResponse> {
        self.stopInstances(StopInstancesRequest(instanceIds: instanceIds), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func stopInstances(instanceIds: [String], region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> StopInstancesResponse {
        try await self.stopInstances(StopInstancesRequest(instanceIds: instanceIds), region: region, logger: logger, on: eventLoop)
    }
}
