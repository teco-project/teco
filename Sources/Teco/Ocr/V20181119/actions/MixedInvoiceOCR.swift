...
extension Ocr {
    ...
    public struct MixedInvoiceOCRRequest: TCRequest {
        /// 图片的 Base64 值。
    ...
    public struct MixedInvoiceOCRResponse: TCResponse {
        /// 混贴票据识别结果，具体内容请点击左侧链接。
        public let mixedInvoiceItems: [MixedInvoiceItem]
