...
extension Iai {
    ...
    public struct SearchPersonsReturnsByGroupRequest: TCRequestModel {
        ...
        public init (groupIds: [String], image: String?, url: String?, maxFaceNum: UInt64?, minFaceSize: UInt64?, maxPersonNumPerGroup: UInt64?, qualityControl: UInt64?, faceMatchThreshold: Float?, needPersonInfo: Int64?, needRotateDetection: UInt64?) {
