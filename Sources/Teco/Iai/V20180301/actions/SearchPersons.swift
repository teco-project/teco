...
extension Iai {
    ...
    public struct SearchPersonsRequest: TCRequestModel {
        ...
        public init (groupIds: [String], image: String?, url: String?, maxFaceNum: UInt64?, minFaceSize: UInt64?, maxPersonNum: UInt64?, qualityControl: UInt64?, faceMatchThreshold: Float?, needPersonInfo: Int64?, needRotateDetection: UInt64?) {
