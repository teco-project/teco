...
public protocol TCEiamErrorType: TCServiceErrorType {
    ...
    func asEiamError() -> TCEiamError
}

public struct TCEiamError: TCEiamErrorType {
    enum Code: String {
    ...
    /// Error domains affliated to ``TCEiamError``.
    public static var domains: [TCErrorType.Type] {
        [FailedOperation.self, InvalidParameter.self, InvalidParameterValue.self, LimitExceeded.self, OperationDenied.self]
    }
