public struct TCTbaasError: TCErrorType {
    enum Code: String {
...
extension TCTbaasError {
    public static var domains: [TCErrorType.Type] {
        return [AuthFailure.self, FailedOperation.self, InternalError.self, InvalidParameter.self, InvalidParameterValue.self, MissingParameter.self, OperationDenied.self, ResourceNotFound.self]
    }
}

extension TCTbaasError: Equatable {
    public static func == (lhs: TCTbaasError, rhs: TCTbaasError) -> Bool {
        lhs.error == rhs.error
    }
}
