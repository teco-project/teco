...
extension TCTbaasError.AuthFailure: Equatable {
    public static func == (lhs: TCTbaasError.AuthFailure, rhs: TCTbaasError.AuthFailure) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCTbaasError.AuthFailure: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCTbaasError.AuthFailure {
