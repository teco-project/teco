...
extension Iotvideo {
    /// WakeUpDevice请求参数结构体
    public struct WakeUpDeviceRequest: TCRequest {
        /// 产品ID
    ...
    /// WakeUpDevice返回参数结构体
    public struct WakeUpDeviceResponse: TCResponse {
    ...
    public func wakeUpDevice(productId: String, deviceName: String, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<WakeUpDeviceResponse> {
        self.wakeUpDevice(.init(productId: productId, deviceName: deviceName), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func wakeUpDevice(productId: String, deviceName: String, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> WakeUpDeviceResponse {
        try await self.wakeUpDevice(.init(productId: productId, deviceName: deviceName), region: region, logger: logger, on: eventLoop)
    }
}
