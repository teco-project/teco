...
extension Iotvideo {
    ...
    /// 获取设备在指定时间范围内上报的历史数据。
    @inlinable
    public func describeDeviceDataHistory(minTime: UInt64, maxTime: UInt64, productId: String, deviceName: String, fieldName: String, limit: [UInt64]? = nil, context: String? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDeviceDataHistoryResponse> {
    ...
    /// 获取设备在指定时间范围内上报的历史数据。
    @inlinable
    public func describeDeviceDataHistory(minTime: UInt64, maxTime: UInt64, productId: String, deviceName: String, fieldName: String, limit: [UInt64]? = nil, context: String? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeDeviceDataHistoryResponse {
