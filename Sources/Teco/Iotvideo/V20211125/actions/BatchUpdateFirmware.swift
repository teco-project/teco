...
extension Iotvideo {
    ...
    public struct BatchUpdateFirmwareRequest: TCRequestModel {
        ...
        public let timeoutInterval: Int64?

        public init(productID: String, firmwareVersion: String, firmwareOriVersion: String? = nil, upgradeMethod: UInt64? = nil, fileName: String? = nil, fileMd5: String? = nil, fileSize: UInt64? = nil, deviceNames: [String]? = nil, timeoutInterval: Int64? = nil) {
    ...
    /// 本接口（BatchUpdateFirmware）用于批量更新设备固件
    @inlinable
    public func batchUpdateFirmware(productID: String, firmwareVersion: String, firmwareOriVersion: String? = nil, upgradeMethod: UInt64? = nil, fileName: String? = nil, fileMd5: String? = nil, fileSize: UInt64? = nil, deviceNames: [String]? = nil, timeoutInterval: Int64? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<BatchUpdateFirmwareResponse> {
    ...
    /// 本接口（BatchUpdateFirmware）用于批量更新设备固件
    @inlinable
    public func batchUpdateFirmware(productID: String, firmwareVersion: String, firmwareOriVersion: String? = nil, upgradeMethod: UInt64? = nil, fileName: String? = nil, fileMd5: String? = nil, fileSize: UInt64? = nil, deviceNames: [String]? = nil, timeoutInterval: Int64? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> BatchUpdateFirmwareResponse {
