...
extension Chdfs {
    ...
    /// 查看文件系统列表。
    @inlinable
    public func describeFileSystems(offset: UInt64? = nil, limit: UInt64? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeFileSystemsResponse {
        try await self.describeFileSystems(DescribeFileSystemsRequest(offset: offset, limit: limit), logger: logger, on: eventLoop)
    }
}
