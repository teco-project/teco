...
extension TCGaapError.LimitExceeded: Equatable {
    public static func == (lhs: TCGaapError.LimitExceeded, rhs: TCGaapError.LimitExceeded) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCGaapError.LimitExceeded: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCGaapError.LimitExceeded {
