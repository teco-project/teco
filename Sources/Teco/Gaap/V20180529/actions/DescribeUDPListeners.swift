...
extension Gaap {
    ...
    public struct DescribeUDPListenersRequest: TCPaginatedRequest {
        ...
        public func getNextPaginatedRequest(with response: DescribeUDPListenersResponse) -> DescribeUDPListenersRequest? {
    ...
    public func describeUDPListeners(proxyId: String? = nil, listenerId: String? = nil, listenerName: String? = nil, port: UInt64? = nil, offset: UInt64? = nil, limit: UInt64? = nil, groupId: String? = nil, searchValue: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeUDPListenersResponse> {
        let input = DescribeUDPListenersRequest(proxyId: proxyId, listenerId: listenerId, listenerName: listenerName, port: port, offset: offset, limit: limit, groupId: groupId, searchValue: searchValue)
        return self.client.execute(action: "DescribeUDPListeners", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeUDPListeners(proxyId: String? = nil, listenerId: String? = nil, listenerName: String? = nil, port: UInt64? = nil, offset: UInt64? = nil, limit: UInt64? = nil, groupId: String? = nil, searchValue: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeUDPListenersResponse {
        let input = DescribeUDPListenersRequest(proxyId: proxyId, listenerId: listenerId, listenerName: listenerName, port: port, offset: offset, limit: limit, groupId: groupId, searchValue: searchValue)
        return try await self.client.execute(action: "DescribeUDPListeners", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop).get()
    }
    ...
    public func describeUDPListenersPaginator(_ input: DescribeUDPListenersRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> (results: TCClient.Paginator<DescribeUDPListenersRequest, DescribeUDPListenersResponse>.ResultSequence, responses: TCClient.Paginator<DescribeUDPListenersRequest, DescribeUDPListenersResponse>.ResponseSequence) {
        let results = TCClient.Paginator<DescribeUDPListenersRequest, DescribeUDPListenersResponse>.ResultSequence(input: input, region: region, command: self.describeUDPListeners, logger: logger, on: eventLoop)
        let responses = TCClient.Paginator<DescribeUDPListenersRequest, DescribeUDPListenersResponse>.ResponseSequence(input: input, region: region, command: self.describeUDPListeners, logger: logger, on: eventLoop)
