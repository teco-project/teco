...
extension Gaap {
    ...
    public struct DescribeTCPListenersRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribeTCPListenersResponse) -> DescribeTCPListenersRequest? {
            ...
            return DescribeTCPListenersRequest(proxyId: self.proxyId, listenerId: self.listenerId, listenerName: self.listenerName, port: self.port, offset: (self.offset ?? 0) + .init(response.getItems().count), limit: self.limit, groupId: self.groupId, searchValue: self.searchValue)
        }
    }

    /// DescribeTCPListeners返回参数结构体
    public struct DescribeTCPListenersResponse: TCPaginatedResponse {
        /// 满足条件的监听器总个数
        ...
        /// Extract the returned ``TCPListener`` list from the paginated response.
        public func getItems() -> [TCPListener] {
            self.listenerSet
        }
    ...
    public func describeTCPListeners(proxyId: String? = nil, listenerId: String? = nil, listenerName: String? = nil, port: UInt64? = nil, offset: UInt64? = nil, limit: UInt64? = nil, groupId: String? = nil, searchValue: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeTCPListenersResponse> {
        self.describeTCPListeners(.init(proxyId: proxyId, listenerId: listenerId, listenerName: listenerName, port: port, offset: offset, limit: limit, groupId: groupId, searchValue: searchValue), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func describeTCPListeners(proxyId: String? = nil, listenerId: String? = nil, listenerName: String? = nil, port: UInt64? = nil, offset: UInt64? = nil, limit: UInt64? = nil, groupId: String? = nil, searchValue: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeTCPListenersResponse {
        try await self.describeTCPListeners(.init(proxyId: proxyId, listenerId: listenerId, listenerName: listenerName, port: port, offset: offset, limit: limit, groupId: groupId, searchValue: searchValue), region: region, logger: logger, on: eventLoop)
    }
