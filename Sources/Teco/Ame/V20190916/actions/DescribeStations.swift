...
extension Ame {
    ...
    public struct DescribeStationsRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribeStationsResponse) -> DescribeStationsRequest? {
    ...
    public struct DescribeStationsResponse: TCPaginatedResponse {
        ...
        /// Extract the returned ``Station`` list from the paginated response.
