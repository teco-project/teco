...
extension Tione {
    ...
    /// 导入模型
    @inlinable
    public func createTrainingModel(importMethod: String, trainingModelCosPath: CosPathInfo, reasoningEnvironmentSource: String, trainingModelName: String? = nil, tags: [Tag]? = nil, trainingJobName: String? = nil, algorithmFramework: String? = nil, reasoningEnvironment: String? = nil, trainingModelIndex: String? = nil, trainingModelVersion: String? = nil, reasoningImageInfo: ImageInfo? = nil, modelMoveMode: String? = nil, trainingJobId: String? = nil, trainingModelId: String? = nil, modelOutputPath: CosPathInfo? = nil, trainingModelSource: String? = nil, trainingPreference: String? = nil, autoMLTaskId: String? = nil, trainingJobVersion: String? = nil, modelVersionType: String? = nil, modelFormat: String? = nil, reasoningEnvironmentId: String? = nil, autoClean: String? = nil, maxReservedModels: UInt64? = nil, modelCleanPeriod: UInt64? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateTrainingModelResponse> {
        self.createTrainingModel(CreateTrainingModelRequest(importMethod: importMethod, trainingModelCosPath: trainingModelCosPath, reasoningEnvironmentSource: reasoningEnvironmentSource, trainingModelName: trainingModelName, tags: tags, trainingJobName: trainingJobName, algorithmFramework: algorithmFramework, reasoningEnvironment: reasoningEnvironment, trainingModelIndex: trainingModelIndex, trainingModelVersion: trainingModelVersion, reasoningImageInfo: reasoningImageInfo, modelMoveMode: modelMoveMode, trainingJobId: trainingJobId, trainingModelId: trainingModelId, modelOutputPath: modelOutputPath, trainingModelSource: trainingModelSource, trainingPreference: trainingPreference, autoMLTaskId: autoMLTaskId, trainingJobVersion: trainingJobVersion, modelVersionType: modelVersionType, modelFormat: modelFormat, reasoningEnvironmentId: reasoningEnvironmentId, autoClean: autoClean, maxReservedModels: maxReservedModels, modelCleanPeriod: modelCleanPeriod), logger: logger, on: eventLoop)
    }

    /// 导入模型
    @inlinable
    public func createTrainingModel(importMethod: String, trainingModelCosPath: CosPathInfo, reasoningEnvironmentSource: String, trainingModelName: String? = nil, tags: [Tag]? = nil, trainingJobName: String? = nil, algorithmFramework: String? = nil, reasoningEnvironment: String? = nil, trainingModelIndex: String? = nil, trainingModelVersion: String? = nil, reasoningImageInfo: ImageInfo? = nil, modelMoveMode: String? = nil, trainingJobId: String? = nil, trainingModelId: String? = nil, modelOutputPath: CosPathInfo? = nil, trainingModelSource: String? = nil, trainingPreference: String? = nil, autoMLTaskId: String? = nil, trainingJobVersion: String? = nil, modelVersionType: String? = nil, modelFormat: String? = nil, reasoningEnvironmentId: String? = nil, autoClean: String? = nil, maxReservedModels: UInt64? = nil, modelCleanPeriod: UInt64? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateTrainingModelResponse {
