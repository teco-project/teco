...
extension Essbasic {
    ...
    public struct CreateSignUrlsRequest: TCRequestModel {
        ...
        public init (agent: Agent, flowIds: [String]?, flowGroupId: String?, endpoint: String?, generateType: String?, organizationName: String?, name: String?, mobile: String?, organizationOpenId: String?, openId: String?, autoJumpBack: Bool?, jumpUrl: String?, `operator`: UserInfo) {
            self.agent = agent
