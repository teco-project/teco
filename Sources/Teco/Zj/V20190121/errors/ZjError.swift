...
public protocol TCZjErrorType: TCPlatformErrorType {
    ...
    func asZjError() -> TCZjError
}

public struct TCZjError: TCZjErrorType {
    enum Code: String {
    ...
    /// Error domains affliated to ``TCZjError``.
    public static var domains: [TCErrorType.Type] {
        [FailedOperation.self, InvalidParameter.self, InvalidParameterValue.self, UnauthorizedOperation.self]
    }
