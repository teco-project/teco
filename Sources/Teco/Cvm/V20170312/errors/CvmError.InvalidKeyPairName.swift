...
extension TCCvmError {
    public struct InvalidKeyPairName: TCErrorType {
        enum Code: String {
...
extension TCCvmError.InvalidKeyPairName: Equatable {
    public static func == (lhs: TCCvmError.InvalidKeyPairName, rhs: TCCvmError.InvalidKeyPairName) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCCvmError.InvalidKeyPairName: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCCvmError.InvalidKeyPairName {
