...
extension TCCvmError {
    public struct InvalidAccountIs: TCErrorType {
        enum Code: String {
...
extension TCCvmError.InvalidAccountIs: Equatable {
    public static func == (lhs: TCCvmError.InvalidAccountIs, rhs: TCCvmError.InvalidAccountIs) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCCvmError.InvalidAccountIs: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCCvmError.InvalidAccountIs {
