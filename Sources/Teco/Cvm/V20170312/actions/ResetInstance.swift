...
extension Cvm {
    ...
    public struct ResetInstanceRequest: TCRequestModel {
        ...
        public init (instanceId: String, imageId: String?, systemDisk: SystemDisk, loginSettings: LoginSettings, enhancedService: EnhancedService, hostName: String?, userData: String?) {
