...
extension Cvm {
    ...
    /// * 实例操作结果可以通过调用 [DescribeInstances](https://cloud.tencent.com/document/api/213/15728#.E7.A4.BA.E4.BE.8B3-.E6.9F.A5.E8.AF.A2.E5.AE.9E.E4.BE.8B.E7.9A.84.E6.9C.80.E6.96.B0.E6.93.8D.E4.BD.9C.E6.83.85.E5.86.B5) 接口查询，如果实例的最新操作状态(LatestOperationState)为“SUCCESS”，则代表操作成功。
    @inlinable
    public func modifyInstancesVpcAttribute(instanceIds: [String], virtualPrivateCloud: VirtualPrivateCloud, forceStop: Bool? = nil, reserveHostName: Bool? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ModifyInstancesVpcAttributeResponse {
        try await self.modifyInstancesVpcAttribute(ModifyInstancesVpcAttributeRequest(instanceIds: instanceIds, virtualPrivateCloud: virtualPrivateCloud, forceStop: forceStop, reserveHostName: reserveHostName), logger: logger, on: eventLoop)
    }
}
