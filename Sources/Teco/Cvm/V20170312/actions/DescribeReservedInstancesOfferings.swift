...
extension Cvm {
    ...
    public struct DescribeReservedInstancesOfferingsRequest: TCPaginatedRequest {
        ...
        /// - **instance-type**
        /// <p style="padding-left: 30px;">按照【**预留实例计费类型**】进行过滤。形如：S3.MEDIUM4。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p><p style="padding-left: 30px;">可选项：[预留实例计费类型列表](https://cloud.tencent.com/document/product/213/11518)</p>
        /// - **offering-type**
