...
extension Cvm {
    ...
    public struct DescribeReservedInstancesOfferingsRequest: TCPaginatedRequest {
        ...
        /// <li>**instance-type**</li>
        /// <p style="padding-left: 30px;">按照【**预留实例计费类型**】进行过滤。形如：S3.MEDIUM4。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p><p style="padding-left: 30px;">可选项：<a href="https://cloud.tencent.com/document/product/213/11518">预留实例计费类型列表</a></p>
        /// <li>**offering-type**</li>
        /// <p style="padding-left: 30px;">按照【**付款类型**】进行过滤。形如：All Upfront (预付全部费用)。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p><p style="padding-left: 30px;">可选项：All Upfront (预付全部费用)</p>
        ...
        /// <li>**reserved-instances-offering-id**</li>
        /// <p style="padding-left: 30px;">按照【**预留实例计费配置ID**】进行过滤。形如：650c138f-ae7e-4750-952a-96841d6e9fc1。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p>
        ...
        public func makeNextRequest(with response: DescribeReservedInstancesOfferingsResponse) -> DescribeReservedInstancesOfferingsRequest? {
