...
extension Cvm {
    ...
    public struct DescribeReservedInstancesOfferingsRequest: TCPaginatedRequest {
        ...
        /// 必选：否
        ///
        /// 可选项：[预留实例计费类型列表](https://cloud.tencent.com/document/product/213/11518)
        ///
        /// - **offering-type**
        ///
        ...
        public func makeNextRequest(with response: DescribeReservedInstancesOfferingsResponse) -> DescribeReservedInstancesOfferingsRequest? {
            ...
            return .init(dryRun: self.dryRun, offset: (self.offset ?? 0) + .init(response.getItems().count), limit: self.limit, maxDuration: self.maxDuration, minDuration: self.minDuration, filters: self.filters)
        }
    }
