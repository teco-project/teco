...
extension Cvm {
    ...
    public struct ModifyInstancesAttributeRequest: TCRequestModel {
        ...
        public init (instanceIds: [String], instanceName: String?, securityGroups: [String]?, camRoleName: String?, hostName: String?, disableApiTermination: Bool?, camRoleType: String?) {
