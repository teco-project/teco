...
extension Cvm {
    ...
    public struct DescribeHostsRequest: TCPaginatedRequest {
        ...
        /// <li>**project-id**</li>
        /// <p style="padding-left: 30px;">按照【**项目ID**】进行过滤，可通过调用[DescribeProject](https://cloud.tencent.com/document/api/378/4400)查询已创建的项目列表或登录[控制台](https://console.cloud.tencent.com/cvm/index)进行查看；也可以调用[AddProject](https://cloud.tencent.com/document/api/378/4398)创建新的项目。项目ID形如：1002189。</p><p style="padding-left: 30px;">类型：Integer</p><p style="padding-left: 30px;">必选：否</p>
        /// <li>**host-id**</li>
        /// <p style="padding-left: 30px;">按照【**[CDH](https://cloud.tencent.com/document/product/416) ID**】进行过滤。[CDH](https://cloud.tencent.com/document/product/416) ID形如：host-xxxxxxxx。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p>
        /// <li>**host-name**</li>
        /// <p style="padding-left: 30px;">按照【**CDH实例名称**】进行过滤。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p>
        /// <li>**host-state**</li>
        /// <p style="padding-left: 30px;">按照【**CDH实例状态**】进行过滤。（PENDING：创建中 | LAUNCH_FAILURE：创建失败 | RUNNING：运行中 | EXPIRED：已过期）</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p>
        ...
        public func makeNextRequest(with response: DescribeHostsResponse) -> DescribeHostsRequest? {
    ...
    public func describeHosts(filters: [Filter]? = nil, offset: UInt64? = nil, limit: UInt64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeHostsResponse> {
        self.describeHosts(.init(filters: filters, offset: offset, limit: limit), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func describeHosts(filters: [Filter]? = nil, offset: UInt64? = nil, limit: UInt64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeHostsResponse {
        try await self.describeHosts(.init(filters: filters, offset: offset, limit: limit), region: region, logger: logger, on: eventLoop)
    }
