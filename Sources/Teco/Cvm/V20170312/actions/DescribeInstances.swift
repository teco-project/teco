...
extension Cvm {
    ...
    public struct DescribeInstancesRequest: TCPaginatedRequest {
        ...
        /// <li>**zone**</li> <p style="padding-left: 30px;">按照【**可用区**】进行过滤。可用区例如：ap-guangzhou-1。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p><p style="padding-left: 30px;">可选项：<a href="https://cloud.tencent.com/document/product/213/6091">可用区列表</a></p> <li>**project-id**</li> <p style="padding-left: 30px;">按照【**项目ID**】进行过滤，可通过调用[DescribeProjects](https://cloud.tencent.com/document/api/651/78725)查询已创建的项目列表或登录[控制台](https://console.cloud.tencent.com/cvm/index)进行查看；也可以调用[AddProject](https://cloud.tencent.com/document/api/651/81952)创建新的项目。项目ID例如：1002189。</p><p style="padding-left: 30px;">类型：Integer</p><p style="padding-left: 30px;">必选：否</p> <li>**host-id**</li> <p style="padding-left: 30px;">按照【**[CDH](https://cloud.tencent.com/document/product/416) ID**】进行过滤。[CDH](https://cloud.tencent.com/document/product/416) ID例如：host-xxxxxxxx。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p> <li>**dedicated-cluster-id**</li> <p style="padding-left: 30px;">按照【**[CDC](https://cloud.tencent.com/document/product/1346) ID**】进行过滤。[CDC](https://cloud.tencent.com/document/product/1346) ID例如：cluster-xxxxxxx。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p> <li>**vpc-id**</li> <p style="padding-left: 30px;">按照【**VPC ID**】进行过滤。VPC ID例如：vpc-xxxxxxxx。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p> <li>**subnet-id**</li> <p style="padding-left: 30px;">按照【**子网ID**】进行过滤。子网ID例如：subnet-xxxxxxxx。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p> <li>**instance-id**</li> <p style="padding-left: 30px;">按照【**实例ID**】进行过滤。实例ID例如：ins-xxxxxxxx。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p> <li>**uuid**</li> <p style="padding-left: 30px;">按照【**实例UUID**】进行过滤。实例UUID例如：xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p> <li>**security-group-id**</li> <p style="padding-left: 30px;">按照【**安全组ID**】进行过滤。安全组ID例如: sg-8jlk3f3r。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p> <li>**instance-name**</li> <p style="padding-left: 30px;">按照【**实例名称**】进行过滤。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p> <li>**instance-charge-type**</li> <p style="padding-left: 30px;">按照【**实例计费模式**】进行过滤。(PREPAID：表示预付费，即包年包月 | POSTPAID_BY_HOUR：表示后付费，即按量计费 | CDHPAID：表示[CDH](https://cloud.tencent.com/document/product/416)付费，即只对[CDH](https://cloud.tencent.com/document/product/416)计费，不对[CDH](https://cloud.tencent.com/document/product/416)上的实例计费。)</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p> <li>**instance-state**</li> <p style="padding-left: 30px;">按照【**实例状态**】进行过滤。状态类型详见[实例状态表](https://cloud.tencent.com/document/api/213/15753#InstanceStatus)</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p> <li>**private-ip-address**</li> <p style="padding-left: 30px;">按照【**实例主网卡的内网IP**】进行过滤。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p> <li>**public-ip-address**</li> <p style="padding-left: 30px;">按照【**实例主网卡的公网IP**】进行过滤，包含实例创建时自动分配的IP和实例创建后手动绑定的弹性IP。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p> <li>**ipv6-address**</li> <p style="padding-left: 30px;">按照【**实例的IPv6地址**】进行过滤。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p> <li>**tag-key**</li> <p style="padding-left: 30px;">按照【**标签键**】进行过滤。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p> <li>**tag-value**</li> <p style="padding-left: 30px;">按照【**标签值**】进行过滤。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p> <li>**tag:tag-key**</li> <p style="padding-left: 30px;">按照【**标签键值对**】进行过滤。tag-key使用具体的标签键进行替换。使用请参考示例2。</p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p><li>**creation-start-time**</li> <p style="padding-left: 30px;">按照【**实例创建起始时间**】进行过滤。例如：2023-06-01 00:00:00。
        /// </p><p style="padding-left: 30px;">类型：String</p><p style="padding-left: 30px;">必选：否</p>
        /// <li>**creation-end-time**</li> <p style="padding-left: 30px;">按照【**实例创建截止时间**】进行过滤。例如：2023-06-01 00:00:00。
