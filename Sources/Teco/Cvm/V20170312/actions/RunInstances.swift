...
extension Cvm {
    ...
    public func runInstances(instanceChargeType: String? = nil, instanceChargePrepaid: InstanceChargePrepaid? = nil, placement: Placement? = nil, instanceType: String? = nil, imageId: String? = nil, systemDisk: SystemDisk? = nil, dataDisks: [DataDisk]? = nil, virtualPrivateCloud: VirtualPrivateCloud? = nil, internetAccessible: InternetAccessible? = nil, instanceCount: Int64? = nil, instanceName: String? = nil, loginSettings: LoginSettings? = nil, securityGroupIds: [String]? = nil, enhancedService: EnhancedService? = nil, clientToken: String? = nil, hostName: String? = nil, actionTimer: ActionTimer? = nil, disasterRecoverGroupIds: [String]? = nil, tagSpecification: [TagSpecification]? = nil, instanceMarketOptions: InstanceMarketOptionsRequest? = nil, userData: String? = nil, dryRun: Bool? = nil, camRoleName: String? = nil, hpcClusterId: String? = nil, launchTemplate: LaunchTemplate? = nil, dedicatedClusterId: String? = nil, chcIds: [String]? = nil, disableApiTermination: Bool? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> RunInstancesResponse {
        try await self.runInstances(RunInstancesRequest(instanceChargeType: instanceChargeType, instanceChargePrepaid: instanceChargePrepaid, placement: placement, instanceType: instanceType, imageId: imageId, systemDisk: systemDisk, dataDisks: dataDisks, virtualPrivateCloud: virtualPrivateCloud, internetAccessible: internetAccessible, instanceCount: instanceCount, instanceName: instanceName, loginSettings: loginSettings, securityGroupIds: securityGroupIds, enhancedService: enhancedService, clientToken: clientToken, hostName: hostName, actionTimer: actionTimer, disasterRecoverGroupIds: disasterRecoverGroupIds, tagSpecification: tagSpecification, instanceMarketOptions: instanceMarketOptions, userData: userData, dryRun: dryRun, camRoleName: camRoleName, hpcClusterId: hpcClusterId, launchTemplate: launchTemplate, dedicatedClusterId: dedicatedClusterId, chcIds: chcIds, disableApiTermination: disableApiTermination), region: region, logger: logger, on: eventLoop)
    }
}
