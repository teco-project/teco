...
extension Cvm {
    ...
    public struct InquiryPriceRunInstancesRequest: TCRequestModel {
        ...
        ///
        /// <li>其他类型（Linux 等）实例：主机名字符长度为[2, 30]，允许支持多个点号，点之间为一段，每段允许字母（不限制大小写）、数字和短横线（-）组成。
    ...
    @inlinable
    public func inquiryPriceRunInstances(_ input: InquiryPriceRunInstancesRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<InquiryPriceRunInstancesResponse> {
        self.client.execute(action: "InquiryPriceRunInstances", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    /// 本接口(InquiryPriceRunInstances)用于创建实例询价。本接口仅允许针对购买限制范围内的实例配置进行询价, 详见：[创建实例](https://cloud.tencent.com/document/api/213/15730)。
    @inlinable
    public func inquiryPriceRunInstances(_ input: InquiryPriceRunInstancesRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> InquiryPriceRunInstancesResponse {
        try await self.client.execute(action: "InquiryPriceRunInstances", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop).get()
    }
    ...
    /// 本接口(InquiryPriceRunInstances)用于创建实例询价。本接口仅允许针对购买限制范围内的实例配置进行询价, 详见：[创建实例](https://cloud.tencent.com/document/api/213/15730)。
    @inlinable
    public func inquiryPriceRunInstances(placement: Placement, imageId: String, instanceChargeType: String? = nil, instanceChargePrepaid: InstanceChargePrepaid? = nil, instanceType: String? = nil, systemDisk: SystemDisk? = nil, dataDisks: [DataDisk]? = nil, virtualPrivateCloud: VirtualPrivateCloud? = nil, internetAccessible: InternetAccessible? = nil, instanceCount: Int64? = nil, instanceName: String? = nil, loginSettings: LoginSettings? = nil, securityGroupIds: [String]? = nil, enhancedService: EnhancedService? = nil, clientToken: String? = nil, hostName: String? = nil, tagSpecification: [TagSpecification]? = nil, instanceMarketOptions: InstanceMarketOptionsRequest? = nil, hpcClusterId: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<InquiryPriceRunInstancesResponse> {
        self.inquiryPriceRunInstances(.init(placement: placement, imageId: imageId, instanceChargeType: instanceChargeType, instanceChargePrepaid: instanceChargePrepaid, instanceType: instanceType, systemDisk: systemDisk, dataDisks: dataDisks, virtualPrivateCloud: virtualPrivateCloud, internetAccessible: internetAccessible, instanceCount: instanceCount, instanceName: instanceName, loginSettings: loginSettings, securityGroupIds: securityGroupIds, enhancedService: enhancedService, clientToken: clientToken, hostName: hostName, tagSpecification: tagSpecification, instanceMarketOptions: instanceMarketOptions, hpcClusterId: hpcClusterId), region: region, logger: logger, on: eventLoop)
    }
    ...
    /// 本接口(InquiryPriceRunInstances)用于创建实例询价。本接口仅允许针对购买限制范围内的实例配置进行询价, 详见：[创建实例](https://cloud.tencent.com/document/api/213/15730)。
    @inlinable
    public func inquiryPriceRunInstances(placement: Placement, imageId: String, instanceChargeType: String? = nil, instanceChargePrepaid: InstanceChargePrepaid? = nil, instanceType: String? = nil, systemDisk: SystemDisk? = nil, dataDisks: [DataDisk]? = nil, virtualPrivateCloud: VirtualPrivateCloud? = nil, internetAccessible: InternetAccessible? = nil, instanceCount: Int64? = nil, instanceName: String? = nil, loginSettings: LoginSettings? = nil, securityGroupIds: [String]? = nil, enhancedService: EnhancedService? = nil, clientToken: String? = nil, hostName: String? = nil, tagSpecification: [TagSpecification]? = nil, instanceMarketOptions: InstanceMarketOptionsRequest? = nil, hpcClusterId: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> InquiryPriceRunInstancesResponse {
        try await self.inquiryPriceRunInstances(.init(placement: placement, imageId: imageId, instanceChargeType: instanceChargeType, instanceChargePrepaid: instanceChargePrepaid, instanceType: instanceType, systemDisk: systemDisk, dataDisks: dataDisks, virtualPrivateCloud: virtualPrivateCloud, internetAccessible: internetAccessible, instanceCount: instanceCount, instanceName: instanceName, loginSettings: loginSettings, securityGroupIds: securityGroupIds, enhancedService: enhancedService, clientToken: clientToken, hostName: hostName, tagSpecification: tagSpecification, instanceMarketOptions: instanceMarketOptions, hpcClusterId: hpcClusterId), region: region, logger: logger, on: eventLoop)
    }
}
