...
extension Cynosdb {
    ...
    public struct DescribeBackupConfigResponse: TCResponse {
        ...
        /// 跨地域逻辑备份配置修改时间
        /// 注意：此字段可能返回 null，表示取不到有效值。
        public let logicCrossRegionsConfigUpdateTime: String?
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case logicCrossRegionsConfigUpdateTime = "LogicCrossRegionsConfigUpdateTime"
    ...
    public func describeBackupConfig(clusterId: String, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeBackupConfigResponse> {
        self.describeBackupConfig(.init(clusterId: clusterId), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func describeBackupConfig(clusterId: String, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeBackupConfigResponse {
        try await self.describeBackupConfig(.init(clusterId: clusterId), region: region, logger: logger, on: eventLoop)
    }
}
