...
extension Cynosdb {
    ...
    public struct OpenClusterReadOnlyInstanceGroupAccessRequest: TCRequestModel {
        public init() {
        }
    }

    /// OpenClusterReadOnlyInstanceGroupAccess返回参数结构体
    public struct OpenClusterReadOnlyInstanceGroupAccessResponse: TCResponseModel {
