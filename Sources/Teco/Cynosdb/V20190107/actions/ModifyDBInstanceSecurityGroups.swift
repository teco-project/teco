...
extension Cynosdb {
    ...
    /// 本接口(ModifyDBInstanceSecurityGroups)用于修改实例绑定的安全组。
    @inlinable
    public func modifyDBInstanceSecurityGroups(instanceId: String, securityGroupIds: [String], zone: String, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ModifyDBInstanceSecurityGroupsResponse> {
        self.modifyDBInstanceSecurityGroups(ModifyDBInstanceSecurityGroupsRequest(instanceId: instanceId, securityGroupIds: securityGroupIds, zone: zone), logger: logger, on: eventLoop)
    }
    ...
    /// 本接口(ModifyDBInstanceSecurityGroups)用于修改实例绑定的安全组。
    @inlinable
    public func modifyDBInstanceSecurityGroups(instanceId: String, securityGroupIds: [String], zone: String, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ModifyDBInstanceSecurityGroupsResponse {
        try await self.modifyDBInstanceSecurityGroups(ModifyDBInstanceSecurityGroupsRequest(instanceId: instanceId, securityGroupIds: securityGroupIds, zone: zone), logger: logger, on: eventLoop)
    }
}
