...
extension Wedata {
    ...
    public struct DescribeRuleHistoryByPageRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribeRuleHistoryByPageResponse) -> DescribeRuleHistoryByPageRequest? {
            ...
            return .init(projectId: self.projectId, pageNumber: (self.pageNumber ?? 0) + 1, pageSize: self.pageSize, filters: self.filters)
        }
    }
    ...
    public struct DescribeRuleHistoryByPageResponse: TCPaginatedResponse {
        ...
        /// Extract the returned ``RuleHistory`` list from the paginated response.
