...
extension Wedata {
    ...
    /// 实例强制成功
    @inlinable
    public func forceSucScheduleInstances(_ input: ForceSucScheduleInstancesRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ForceSucScheduleInstancesResponse> {
        self.client.execute(action: "ForceSucScheduleInstances", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// 实例强制成功
    @inlinable
    public func forceSucScheduleInstances(_ input: ForceSucScheduleInstancesRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ForceSucScheduleInstancesResponse {
        try await self.client.execute(action: "ForceSucScheduleInstances", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop).get()
    }

    /// 实例强制成功
    @inlinable
    public func forceSucScheduleInstances(instances: [InstanceOpsDto]? = nil, checkFather: Bool? = nil, rerunType: String? = nil, dependentWay: String? = nil, skipEventListening: Bool? = nil, sonInstanceType: String? = nil, searchCondition: InstanceApiOpsRequest? = nil, optType: String? = nil, operatorName: String? = nil, operatorId: String? = nil, projectId: String? = nil, projectIdent: String? = nil, projectName: String? = nil, pageIndex: Int64? = nil, pageSize: Int64? = nil, count: Int64? = nil, requestBaseInfo: ProjectBaseInfoOpsRequest? = nil, isCount: Bool? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ForceSucScheduleInstancesResponse> {
        self.forceSucScheduleInstances(.init(instances: instances, checkFather: checkFather, rerunType: rerunType, dependentWay: dependentWay, skipEventListening: skipEventListening, sonInstanceType: sonInstanceType, searchCondition: searchCondition, optType: optType, operatorName: operatorName, operatorId: operatorId, projectId: projectId, projectIdent: projectIdent, projectName: projectName, pageIndex: pageIndex, pageSize: pageSize, count: count, requestBaseInfo: requestBaseInfo, isCount: isCount), region: region, logger: logger, on: eventLoop)
    }

    /// 实例强制成功
    @inlinable
    public func forceSucScheduleInstances(instances: [InstanceOpsDto]? = nil, checkFather: Bool? = nil, rerunType: String? = nil, dependentWay: String? = nil, skipEventListening: Bool? = nil, sonInstanceType: String? = nil, searchCondition: InstanceApiOpsRequest? = nil, optType: String? = nil, operatorName: String? = nil, operatorId: String? = nil, projectId: String? = nil, projectIdent: String? = nil, projectName: String? = nil, pageIndex: Int64? = nil, pageSize: Int64? = nil, count: Int64? = nil, requestBaseInfo: ProjectBaseInfoOpsRequest? = nil, isCount: Bool? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ForceSucScheduleInstancesResponse {
        try await self.forceSucScheduleInstances(.init(instances: instances, checkFather: checkFather, rerunType: rerunType, dependentWay: dependentWay, skipEventListening: skipEventListening, sonInstanceType: sonInstanceType, searchCondition: searchCondition, optType: optType, operatorName: operatorName, operatorId: operatorId, projectId: projectId, projectIdent: projectIdent, projectName: projectName, pageIndex: pageIndex, pageSize: pageSize, count: count, requestBaseInfo: requestBaseInfo, isCount: isCount), region: region, logger: logger, on: eventLoop)
    }
}
