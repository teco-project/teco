...
extension Wedata {
    ...
    /// 查询规则执行结果详情
    @inlinable
    public func describeRuleExecDetail(projectId: String? = nil, ruleExecId: UInt64? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeRuleExecDetailResponse> {
        self.describeRuleExecDetail(DescribeRuleExecDetailRequest(projectId: projectId, ruleExecId: ruleExecId), logger: logger, on: eventLoop)
    }

    /// 查询规则执行结果详情
    @inlinable
    public func describeRuleExecDetail(projectId: String? = nil, ruleExecId: UInt64? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeRuleExecDetailResponse {
        try await self.describeRuleExecDetail(DescribeRuleExecDetailRequest(projectId: projectId, ruleExecId: ruleExecId), logger: logger, on: eventLoop)
    }
}
