...
extension Wedata {
    ...
    public struct DescribeTaskAlarmRegulationsRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribeTaskAlarmRegulationsResponse) -> DescribeTaskAlarmRegulationsRequest? {
            ...
            return .init(projectId: self.projectId, pageNumber: self.pageNumber + 1, pageSize: self.pageSize, filters: self.filters, orderFields: self.orderFields, taskId: self.taskId, taskType: self.taskType)
        }
    }
