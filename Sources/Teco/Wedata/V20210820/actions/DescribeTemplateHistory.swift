...
extension Wedata {
    ...
    public func describeTemplateHistoryPaginator(_ input: DescribeTemplateHistoryRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> (results: TCClient.Paginator<DescribeTemplateHistoryRequest, DescribeTemplateHistoryResponse>.ResultSequence, responses: TCClient.Paginator<DescribeTemplateHistoryRequest, DescribeTemplateHistoryResponse>.ResponseSequence) {
        let results = TCClient.Paginator<DescribeTemplateHistoryRequest, DescribeTemplateHistoryResponse>.ResultSequence(input: input, region: region, command: self.describeTemplateHistory, logger: logger, on: eventLoop)
        let responses = TCClient.Paginator<DescribeTemplateHistoryRequest, DescribeTemplateHistoryResponse>.ResponseSequence(input: input, region: region, command: self.describeTemplateHistory, logger: logger, on: eventLoop)
