...
extension Wedata {
    ...
    public struct DescribeTemplateHistoryRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribeTemplateHistoryResponse) -> DescribeTemplateHistoryRequest? {
    ...
    public struct DescribeTemplateHistoryResponse: TCPaginatedResponse {
        ...
        /// Extract the returned ``RuleTemplateHistory`` list from the paginated response.
