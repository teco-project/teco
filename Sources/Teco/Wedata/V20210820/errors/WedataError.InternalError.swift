...
extension TCWedataError.InternalError: Equatable {
    public static func == (lhs: TCWedataError.InternalError, rhs: TCWedataError.InternalError) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCWedataError.InternalError: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCWedataError.InternalError {
