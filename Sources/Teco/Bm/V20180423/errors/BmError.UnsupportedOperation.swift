...
extension TCBmError.UnsupportedOperation: Equatable {
    public static func == (lhs: TCBmError.UnsupportedOperation, rhs: TCBmError.UnsupportedOperation) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCBmError.UnsupportedOperation: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCBmError.UnsupportedOperation {
