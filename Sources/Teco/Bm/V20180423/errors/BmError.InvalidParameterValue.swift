...
extension TCBmError.InvalidParameterValue: Equatable {
    public static func == (lhs: TCBmError.InvalidParameterValue, rhs: TCBmError.InvalidParameterValue) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCBmError.InvalidParameterValue: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCBmError.InvalidParameterValue {
