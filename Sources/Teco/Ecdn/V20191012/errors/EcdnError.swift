public struct TCEcdnError: TCErrorType {
    enum Code: String {
...
extension TCEcdnError {
    public static var domains: [TCErrorType.Type] {
        return [FailedOperation.self, InternalError.self, InvalidParameter.self, LimitExceeded.self, ResourceInUse.self, ResourceNotFound.self, ResourceUnavailable.self, UnauthorizedOperation.self]
    }
}

extension TCEcdnError: Equatable {
    public static func == (lhs: TCEcdnError, rhs: TCEcdnError) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCEcdnError: CustomStringConvertible {
