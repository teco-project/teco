...
extension Ecdn {
    ...
    public struct DescribeEcdnDomainLogsRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribeEcdnDomainLogsResponse) -> DescribeEcdnDomainLogsRequest? {
    ...
    public struct DescribeEcdnDomainLogsResponse: TCPaginatedResponse {
        ...
        /// Extract the returned ``DomainLogs`` list from the paginated response.
