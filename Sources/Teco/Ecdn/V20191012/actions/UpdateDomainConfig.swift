...
extension Ecdn {
    ...
    public struct UpdateDomainConfigRequest: TCRequestModel {
        ...
        public init (domain: String, origin: Origin, projectId: Int64?, ipFilter: IpFilter, ipFreqLimit: IpFreqLimit, responseHeader: ResponseHeader, cacheKey: CacheKey, cache: Cache, https: Https, forceRedirect: ForceRedirect, area: String?, webSocket: WebSocket) {
            self.domain = domain
            self.origin = origin
