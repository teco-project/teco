...
extension TCTmsError.InternalError: Equatable {
    public static func == (lhs: TCTmsError.InternalError, rhs: TCTmsError.InternalError) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCTmsError.InternalError: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCTmsError.InternalError {
