...
extension TCTmsError.UnauthorizedOperation: Equatable {
    public static func == (lhs: TCTmsError.UnauthorizedOperation, rhs: TCTmsError.UnauthorizedOperation) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCTmsError.UnauthorizedOperation: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCTmsError.UnauthorizedOperation {
