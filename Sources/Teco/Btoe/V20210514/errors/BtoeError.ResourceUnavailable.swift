...
extension TCBtoeError.ResourceUnavailable: Equatable {
    public static func == (lhs: TCBtoeError.ResourceUnavailable, rhs: TCBtoeError.ResourceUnavailable) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCBtoeError.ResourceUnavailable: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCBtoeError.ResourceUnavailable {
