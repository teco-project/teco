public struct TCBtoeError: TCErrorType {
    enum Code: String {
...
extension TCBtoeError {
    public static var domains: [TCErrorType.Type] {
        return [FailedOperation.self, InvalidParameter.self, InvalidParameterValue.self, LimitExceeded.self, ResourceInsufficient.self, ResourceNotFound.self, ResourceUnavailable.self]
    }
}

extension TCBtoeError: Equatable {
    public static func == (lhs: TCBtoeError, rhs: TCBtoeError) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCBtoeError: CustomStringConvertible {
