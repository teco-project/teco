...
extension As {
    ...
    public struct DescribeLaunchConfigurationsRequest: TCPaginatedRequest {
        ...
        public func getNextPaginatedRequest(with response: DescribeLaunchConfigurationsResponse) -> DescribeLaunchConfigurationsRequest? {
    ...
    public func describeLaunchConfigurationsPaginator(_ input: DescribeLaunchConfigurationsRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> (results: TCClient.Paginator<DescribeLaunchConfigurationsRequest, DescribeLaunchConfigurationsResponse>.ResultSequence, responses: TCClient.Paginator<DescribeLaunchConfigurationsRequest, DescribeLaunchConfigurationsResponse>.ResponseSequence) {
        let results = TCClient.Paginator<DescribeLaunchConfigurationsRequest, DescribeLaunchConfigurationsResponse>.ResultSequence(input: input, region: region, command: self.describeLaunchConfigurations, logger: logger, on: eventLoop)
        let responses = TCClient.Paginator<DescribeLaunchConfigurationsRequest, DescribeLaunchConfigurationsResponse>.ResponseSequence(input: input, region: region, command: self.describeLaunchConfigurations, logger: logger, on: eventLoop)
