...
extension Organization {
    ...
    /// 批量删除企业组织成员
    @inlinable
    public func deleteOrganizationMembers(memberUin: [Int64], logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteOrganizationMembersResponse> {
        self.deleteOrganizationMembers(DeleteOrganizationMembersRequest(memberUin: memberUin), logger: logger, on: eventLoop)
    }

    /// 批量删除企业组织成员
    @inlinable
    public func deleteOrganizationMembers(memberUin: [Int64], logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteOrganizationMembersResponse {
        try await self.deleteOrganizationMembers(DeleteOrganizationMembersRequest(memberUin: memberUin), logger: logger, on: eventLoop)
    }
}
