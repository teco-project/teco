public struct TCOrganizationError: TCErrorType {
    enum Code: String {
...
extension TCOrganizationError {
    public static var domains: [TCErrorType.Type] {
        return [FailedOperation.self, LimitExceeded.self, ResourceNotFound.self, UnsupportedOperation.self]
    }
}

extension TCOrganizationError: Equatable {
    public static func == (lhs: TCOrganizationError, rhs: TCOrganizationError) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCOrganizationError: CustomStringConvertible {
