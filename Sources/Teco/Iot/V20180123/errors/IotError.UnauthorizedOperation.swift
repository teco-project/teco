...
extension TCIotError.UnauthorizedOperation: Equatable {
    public static func == (lhs: TCIotError.UnauthorizedOperation, rhs: TCIotError.UnauthorizedOperation) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCIotError.UnauthorizedOperation: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCIotError.UnauthorizedOperation {
