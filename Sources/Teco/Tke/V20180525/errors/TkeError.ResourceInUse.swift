...
extension TCTkeError.ResourceInUse: Equatable {
    public static func == (lhs: TCTkeError.ResourceInUse, rhs: TCTkeError.ResourceInUse) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCTkeError.ResourceInUse: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCTkeError.ResourceInUse {
