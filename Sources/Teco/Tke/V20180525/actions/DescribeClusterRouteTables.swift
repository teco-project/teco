...
extension Tke {
    ...
    public func describeClusterRouteTables(region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeClusterRouteTablesResponse> {
        let input = DescribeClusterRouteTablesRequest()
        return self.client.execute(action: "DescribeClusterRouteTables", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeClusterRouteTables(region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeClusterRouteTablesResponse {
        let input = DescribeClusterRouteTablesRequest()
        return try await self.client.execute(action: "DescribeClusterRouteTables", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop).get()
    }
}
