...
extension Tke {
    ...
    /// 获取边缘计算外部访问的kubeconfig
    @inlinable
    public func describeTKEEdgeExternalKubeconfig(clusterId: String, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture < DescribeTKEEdgeExternalKubeconfigResponse > {
        self.describeTKEEdgeExternalKubeconfig(DescribeTKEEdgeExternalKubeconfigRequest(clusterId: clusterId), logger: logger, on: eventLoop)
    }
    
    /// 获取边缘计算外部访问的kubeconfig
    @inlinable
    public func describeTKEEdgeExternalKubeconfig(clusterId: String, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeTKEEdgeExternalKubeconfigResponse {
        try await self.describeTKEEdgeExternalKubeconfig(DescribeTKEEdgeExternalKubeconfigRequest(clusterId: clusterId), logger: logger, on: eventLoop)
    }
}
