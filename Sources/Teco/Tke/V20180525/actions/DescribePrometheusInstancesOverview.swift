...
extension Tke {
    ...
    public struct DescribePrometheusInstancesOverviewRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribePrometheusInstancesOverviewResponse) -> DescribePrometheusInstancesOverviewRequest? {
    ...
    public struct DescribePrometheusInstancesOverviewResponse: TCPaginatedResponse {
        ...
        /// Extract the returned ``PrometheusInstancesOverview`` list from the paginated response.
