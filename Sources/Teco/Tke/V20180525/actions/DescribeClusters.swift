...
extension Tke {
    ...
    public struct DescribeClustersRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribeClustersResponse) -> DescribeClustersRequest? {
            ...
            return .init(clusterIds: self.clusterIds, offset: (self.offset ?? 0) + .init(response.getItems().count), limit: self.limit, filters: self.filters, clusterType: self.clusterType)
        }
    }
