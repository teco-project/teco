public struct TCEccError: TCErrorType {
    enum Code: String {
...
extension TCEccError {
    public static var domains: [TCErrorType.Type] {
        return [InternalError.self, InvalidParameter.self, InvalidParameterValue.self, LimitExceeded.self, ResourceNotFound.self, ResourceUnavailable.self, UnauthorizedOperation.self]
    }
}

extension TCEccError: Equatable {
    public static func == (lhs: TCEccError, rhs: TCEccError) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCEccError: CustomStringConvertible {
