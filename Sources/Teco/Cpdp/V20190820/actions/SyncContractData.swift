...
extension Cpdp {
    ...
    public struct SyncContractDataRequest: TCRequest {
        /// 聚鑫分配的支付主MidasAppId
    ...
    public struct SyncContractDataResponse: TCResponse {
        /// 请求处理信息
    ...
    public func syncContractData(midasAppId: String, userId: String, channel: String, outContractCode: String, contractStatus: String, contractSyncInfo: ContractSyncInfo, midasSignature: String, midasSecretId: String, subAppId: String? = nil, userType: String? = nil, sceneInfo: SceneInfo? = nil, midasEnvironment: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SyncContractDataResponse> {
        self.syncContractData(.init(midasAppId: midasAppId, userId: userId, channel: channel, outContractCode: outContractCode, contractStatus: contractStatus, contractSyncInfo: contractSyncInfo, midasSignature: midasSignature, midasSecretId: midasSecretId, subAppId: subAppId, userType: userType, sceneInfo: sceneInfo, midasEnvironment: midasEnvironment), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func syncContractData(midasAppId: String, userId: String, channel: String, outContractCode: String, contractStatus: String, contractSyncInfo: ContractSyncInfo, midasSignature: String, midasSecretId: String, subAppId: String? = nil, userType: String? = nil, sceneInfo: SceneInfo? = nil, midasEnvironment: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> SyncContractDataResponse {
        try await self.syncContractData(.init(midasAppId: midasAppId, userId: userId, channel: channel, outContractCode: outContractCode, contractStatus: contractStatus, contractSyncInfo: contractSyncInfo, midasSignature: midasSignature, midasSecretId: midasSecretId, subAppId: subAppId, userType: userType, sceneInfo: sceneInfo, midasEnvironment: midasEnvironment), region: region, logger: logger, on: eventLoop)
    }
}
