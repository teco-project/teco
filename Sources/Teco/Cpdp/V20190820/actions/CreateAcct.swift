...
extension Cpdp {
    /// CreateAcct请求参数结构体
    public struct CreateAcctRequest: TCRequest {
        /// 聚鑫平台分配的支付MidasAppId
    ...
    /// CreateAcct返回参数结构体
    public struct CreateAcctResponse: TCResponse {
        /// 聚鑫计费SubAppId，代表子商户
