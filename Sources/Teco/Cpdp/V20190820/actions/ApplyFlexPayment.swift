...
extension Cpdp {
    ...
    public struct ApplyFlexPaymentRequest: TCRequestModel {
        ...
        public init (payeeId: String, incomeType: String, amountBeforeTax: String, outOrderId: String, fundingAccountInfo: FlexFundingAccountInfo, remark: String?, environment: String?, notifyUrl: String?) {
