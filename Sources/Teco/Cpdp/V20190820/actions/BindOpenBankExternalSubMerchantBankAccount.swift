...
extension Cpdp {
    ...
    public struct BindOpenBankExternalSubMerchantBankAccountRequest: TCRequestModel {
        /// 渠道商户ID。
        ...
        public init (channelMerchantId: String, channelSubMerchantId: String, channelName: String, paymentMethod: String, externalSubMerchantBindBankAccountData: String, outApplyId: String, notifyUrl: String?, environment: String?) {
    ...
    public struct BindOpenBankExternalSubMerchantBankAccountResponse: TCResponseModel {
        /// 错误码。
        /// __SUCCESS__: 成功
        /// __其他__: 见附录-错误码表
