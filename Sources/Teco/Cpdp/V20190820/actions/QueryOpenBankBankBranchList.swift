...
extension Cpdp {
    ...
    public struct QueryOpenBankBankBranchListRequest: TCRequestModel {
        ...
        public init (channelMerchantId: String, channelName: String, paymentMethod: String, bankBranchName: String, bankAbbreviation: String, pageNumber: Paging, environment: String?) {
