...
extension Cpdp {
    ...
    public struct CreateOpenBankExternalSubMerchantAccountBookRequest: TCRequest {
        /// 外部账本ID
    ...
    public struct CreateOpenBankExternalSubMerchantAccountBookResponse: TCResponse {
        /// 错误码。
        /// __SUCCESS__: 成功
        /// __其他__: 见附录-错误码表
