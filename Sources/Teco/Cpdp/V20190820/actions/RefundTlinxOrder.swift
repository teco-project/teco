...
extension Cpdp {
    ...
    public struct RefundTlinxOrderRequest: TCRequestModel {
        ...
        public init (openId: String, openKey: String, developerNo: String, refundOutNo: String, refundOrderName: String, refundAmount: String, shopPassword: String, remark: String?, profile: String?) {
            self.openId = openId
