...
extension Cpdp {
    ...
    /// 智慧零售-发票开具V2
    @inlinable
    public func createInvoiceV2(_ input: CreateInvoiceV2Request, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateInvoiceV2Response> {
        self.client.execute(action: "CreateInvoiceV2", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// 智慧零售-发票开具V2
    @inlinable
    public func createInvoiceV2(_ input: CreateInvoiceV2Request, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateInvoiceV2Response {
        try await self.client.execute(action: "CreateInvoiceV2", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop).get()
    }

    /// 智慧零售-发票开具V2
    @inlinable
    public func createInvoiceV2(invoicePlatformId: Int64, titleType: Int64, buyerTitle: String, orderId: String, amountHasTax: Int64, taxAmount: Int64, amountWithoutTax: Int64, sellerTaxpayerNum: String, sellerName: String? = nil, sellerAddress: String? = nil, sellerPhone: String? = nil, sellerBankName: String? = nil, sellerBankAccount: String? = nil, buyerTaxpayerNum: String? = nil, buyerAddress: String? = nil, buyerBankName: String? = nil, buyerBankAccount: String? = nil, buyerPhone: String? = nil, buyerEmail: String? = nil, takerPhone: String? = nil, invoiceType: Int64? = nil, callbackUrl: String? = nil, drawer: String? = nil, payee: String? = nil, checker: String? = nil, terminalCode: String? = nil, levyMethod: String? = nil, deduction: Int64? = nil, remark: String? = nil, items: [CreateInvoiceItem]? = nil, profile: String? = nil, undoPart: Int64? = nil, orderDate: String? = nil, discount: Int64? = nil, storeNo: String? = nil, invoiceChannel: Int64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateInvoiceV2Response> {
        let input = CreateInvoiceV2Request(invoicePlatformId: invoicePlatformId, titleType: titleType, buyerTitle: buyerTitle, orderId: orderId, amountHasTax: amountHasTax, taxAmount: taxAmount, amountWithoutTax: amountWithoutTax, sellerTaxpayerNum: sellerTaxpayerNum, sellerName: sellerName, sellerAddress: sellerAddress, sellerPhone: sellerPhone, sellerBankName: sellerBankName, sellerBankAccount: sellerBankAccount, buyerTaxpayerNum: buyerTaxpayerNum, buyerAddress: buyerAddress, buyerBankName: buyerBankName, buyerBankAccount: buyerBankAccount, buyerPhone: buyerPhone, buyerEmail: buyerEmail, takerPhone: takerPhone, invoiceType: invoiceType, callbackUrl: callbackUrl, drawer: drawer, payee: payee, checker: checker, terminalCode: terminalCode, levyMethod: levyMethod, deduction: deduction, remark: remark, items: items, profile: profile, undoPart: undoPart, orderDate: orderDate, discount: discount, storeNo: storeNo, invoiceChannel: invoiceChannel)
        return self.client.execute(action: "CreateInvoiceV2", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// 智慧零售-发票开具V2
    @inlinable
    public func createInvoiceV2(invoicePlatformId: Int64, titleType: Int64, buyerTitle: String, orderId: String, amountHasTax: Int64, taxAmount: Int64, amountWithoutTax: Int64, sellerTaxpayerNum: String, sellerName: String? = nil, sellerAddress: String? = nil, sellerPhone: String? = nil, sellerBankName: String? = nil, sellerBankAccount: String? = nil, buyerTaxpayerNum: String? = nil, buyerAddress: String? = nil, buyerBankName: String? = nil, buyerBankAccount: String? = nil, buyerPhone: String? = nil, buyerEmail: String? = nil, takerPhone: String? = nil, invoiceType: Int64? = nil, callbackUrl: String? = nil, drawer: String? = nil, payee: String? = nil, checker: String? = nil, terminalCode: String? = nil, levyMethod: String? = nil, deduction: Int64? = nil, remark: String? = nil, items: [CreateInvoiceItem]? = nil, profile: String? = nil, undoPart: Int64? = nil, orderDate: String? = nil, discount: Int64? = nil, storeNo: String? = nil, invoiceChannel: Int64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateInvoiceV2Response {
        let input = CreateInvoiceV2Request(invoicePlatformId: invoicePlatformId, titleType: titleType, buyerTitle: buyerTitle, orderId: orderId, amountHasTax: amountHasTax, taxAmount: taxAmount, amountWithoutTax: amountWithoutTax, sellerTaxpayerNum: sellerTaxpayerNum, sellerName: sellerName, sellerAddress: sellerAddress, sellerPhone: sellerPhone, sellerBankName: sellerBankName, sellerBankAccount: sellerBankAccount, buyerTaxpayerNum: buyerTaxpayerNum, buyerAddress: buyerAddress, buyerBankName: buyerBankName, buyerBankAccount: buyerBankAccount, buyerPhone: buyerPhone, buyerEmail: buyerEmail, takerPhone: takerPhone, invoiceType: invoiceType, callbackUrl: callbackUrl, drawer: drawer, payee: payee, checker: checker, terminalCode: terminalCode, levyMethod: levyMethod, deduction: deduction, remark: remark, items: items, profile: profile, undoPart: undoPart, orderDate: orderDate, discount: discount, storeNo: storeNo, invoiceChannel: invoiceChannel)
        return try await self.client.execute(action: "CreateInvoiceV2", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop).get()
    }
}
