...
extension Cpdp {
    ...
    public struct QueryOpenBankExternalSubMerchantRegistrationRequest: TCRequest {
        /// 渠道商户号。
    ...
    public struct QueryOpenBankExternalSubMerchantRegistrationResponse: TCResponse {
        /// 错误码。
        /// __SUCCESS__: 成功
        /// __其他__: 见附录-错误码表
