...
extension Cpdp {
    ...
    public struct GetPayRollAuthListRequest: TCPaginatedRequest {
        ...
        public func getNextPaginatedRequest(with response: GetPayRollAuthListResponse) -> GetPayRollAuthListRequest? {
            ...
            return GetPayRollAuthListRequest(openId: self.openId, subMerchantId: self.subMerchantId, authDate: self.authDate, offset: self.offset + response.offset, limit: self.limit, wechatAppId: self.wechatAppId, wechatSubAppId: self.wechatSubAppId, authStatus: self.authStatus)
        }
    }
