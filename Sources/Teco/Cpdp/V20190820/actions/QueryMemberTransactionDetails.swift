...
extension Cpdp {
    ...
    public struct QueryMemberTransactionDetailsRequest: TCRequestModel {
        /// 查询的交易发生时间类型。
        /// __1__：当日
        /// __2__：历史
        ...
        public init (queryDateType: String, queryTranType: String, bankAccountNumber: String, subAccountNumber: String, pageOffSet: String, queryStartDate: String?, queryEndDate: String?, midasEnvironment: String?) {
    ...
    public struct QueryMemberTransactionDetailsResponse: TCResponseModel {
        /// 错误码。
        /// __SUCCESS__: 成功
        /// __其他__: 见附录-错误码表
        ...
        public let result: QueryMemberTransactionDetailsResult
