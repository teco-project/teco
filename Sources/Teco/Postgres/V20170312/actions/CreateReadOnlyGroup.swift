...
extension Postgres {
    ...
    public struct CreateReadOnlyGroupRequest: TCRequest {
        /// 主实例ID
    ...
    public struct CreateReadOnlyGroupResponse: TCResponse {
        /// 只读组ID
