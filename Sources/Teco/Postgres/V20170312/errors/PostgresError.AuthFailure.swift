...
extension TCPostgresError.AuthFailure: Equatable {
    public static func == (lhs: TCPostgresError.AuthFailure, rhs: TCPostgresError.AuthFailure) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCPostgresError.AuthFailure: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCPostgresError.AuthFailure {
