...
extension Postgres {
    ...
    /// 备份下载限制信息
    public struct BackupDownloadRestriction: TCInputModel {
        ...
        public init(restrictionType: String? = nil, vpcRestrictionEffect: String? = nil, vpcIdSet: [String]? = nil, ipRestrictionEffect: String? = nil, ipSet: [String]? = nil) {
    ...
    public struct DBInstance: TCOutputModel {
        ...
        ///
        /// While the wrapped date value is immutable just like other fields, you can customize the underlying
        /// string value (through `$isolatedTime`) in case the synthesized encoding is incorrect.
