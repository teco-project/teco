...
extension Billing {
    ...
    public struct DescribeCostSummaryByProjectRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribeCostSummaryByProjectResponse) -> DescribeCostSummaryByProjectRequest? {
            ...
            return .init(beginTime: self.beginTime, endTime: self.endTime, limit: self.limit, offset: self.offset + .init(response.getItems().count), payerUin: self.payerUin, needRecordNum: self.needRecordNum)
        }
    }
    ...
    public struct DescribeCostSummaryByProjectResponse: TCPaginatedResponse {
        ...
        /// Extract the returned ``ConsumptionProjectSummaryDataItem`` list from the paginated response.
