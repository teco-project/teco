...
extension Billing {
    ...
    public struct DescribeCostSummaryByResourceResponse: TCPaginatedResponse {
        ...
        /// Extract the returned ``ConsumptionResourceSummaryDataItem`` list from the paginated response.
    ...
    public func describeCostSummaryByResource(beginTime: String, endTime: String, limit: UInt64, offset: UInt64, payerUin: String? = nil, needRecordNum: UInt64? = nil, needConditionValue: UInt64? = nil, conditions: Conditions? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeCostSummaryByResourceResponse> {
        self.describeCostSummaryByResource(.init(beginTime: beginTime, endTime: endTime, limit: limit, offset: offset, payerUin: payerUin, needRecordNum: needRecordNum, needConditionValue: needConditionValue, conditions: conditions), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func describeCostSummaryByResource(beginTime: String, endTime: String, limit: UInt64, offset: UInt64, payerUin: String? = nil, needRecordNum: UInt64? = nil, needConditionValue: UInt64? = nil, conditions: Conditions? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeCostSummaryByResourceResponse {
        try await self.describeCostSummaryByResource(.init(beginTime: beginTime, endTime: endTime, limit: limit, offset: offset, payerUin: payerUin, needRecordNum: needRecordNum, needConditionValue: needConditionValue, conditions: conditions), region: region, logger: logger, on: eventLoop)
    }
