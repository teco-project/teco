...
extension TCRedisError.AuthFailure: Equatable {
    public static func == (lhs: TCRedisError.AuthFailure, rhs: TCRedisError.AuthFailure) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCRedisError.AuthFailure: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCRedisError.AuthFailure {
