...
extension Tsf {
    ...
    public func describeMicroservicesPaginator(_ input: DescribeMicroservicesRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> (results: TCClient.Paginator<DescribeMicroservicesRequest, DescribeMicroservicesResponse>.ResultSequence, responses: TCClient.Paginator<DescribeMicroservicesRequest, DescribeMicroservicesResponse>.ResponseSequence) {
        let results = TCClient.Paginator<DescribeMicroservicesRequest, DescribeMicroservicesResponse>.ResultSequence(input: input, region: region, command: self.describeMicroservices, logger: logger, on: eventLoop)
        let responses = TCClient.Paginator<DescribeMicroservicesRequest, DescribeMicroservicesResponse>.ResponseSequence(input: input, region: region, command: self.describeMicroservices, logger: logger, on: eventLoop)
