...
extension Tsf {
    ...
    public struct DescribeUnitNamespacesRequest: TCPaginatedRequest {
        ...
        public func getNextPaginatedRequest(with response: DescribeUnitNamespacesResponse) -> DescribeUnitNamespacesRequest? {
    ...
    public func describeUnitNamespaces(gatewayInstanceId: String, searchWord: String? = nil, offset: Int64? = nil, limit: Int64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeUnitNamespacesResponse> {
        let input = DescribeUnitNamespacesRequest(gatewayInstanceId: gatewayInstanceId, searchWord: searchWord, offset: offset, limit: limit)
        return self.client.execute(action: "DescribeUnitNamespaces", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeUnitNamespaces(gatewayInstanceId: String, searchWord: String? = nil, offset: Int64? = nil, limit: Int64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeUnitNamespacesResponse {
        let input = DescribeUnitNamespacesRequest(gatewayInstanceId: gatewayInstanceId, searchWord: searchWord, offset: offset, limit: limit)
        return try await self.client.execute(action: "DescribeUnitNamespaces", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop).get()
    }
    ...
    /// 查询单元化命名空间列表
    @inlinable
    public func describeUnitNamespacesPaginator(_ input: DescribeUnitNamespacesRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> (results: TCClient.Paginator<DescribeUnitNamespacesRequest, DescribeUnitNamespacesResponse>.ResultSequence, responses: TCClient.Paginator<DescribeUnitNamespacesRequest, DescribeUnitNamespacesResponse>.ResponseSequence) {
        let results = TCClient.Paginator<DescribeUnitNamespacesRequest, DescribeUnitNamespacesResponse>.ResultSequence(input: input, region: region, command: self.describeUnitNamespaces, logger: logger, on: eventLoop)
        let responses = TCClient.Paginator<DescribeUnitNamespacesRequest, DescribeUnitNamespacesResponse>.ResponseSequence(input: input, region: region, command: self.describeUnitNamespaces, logger: logger, on: eventLoop)
