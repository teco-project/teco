...
extension Tsf {
    ...
    public struct AddClusterInstancesRequest: TCRequestModel {
        ...
        public init (clusterId: String, instanceIdList: [String], osName: String?, imageId: String?, password: String?, keyId: String?, sgId: String?, instanceImportMode: String?, osCustomizeType: String?, featureIdList: [String]?, instanceAdvancedSettings: InstanceAdvancedSettings, securityGroupIds: [String]?) {
