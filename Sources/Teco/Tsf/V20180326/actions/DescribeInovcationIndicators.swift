...
extension Tsf {
    ...
    public struct DescribeInovcationIndicatorsRequest: TCRequestModel {
        ...
        public init (dimension: String, startTime: Date, endTime: Date, namespaceId: String?, serviceId: String?, callerServiceName: String?, calleeServiceName: String?, callerInterfaceName: String?, calleeInterfaceName: String?, applicationId: String?, groupId: String?, instanceId: String?) {
