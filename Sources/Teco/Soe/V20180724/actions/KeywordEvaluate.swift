...
extension Soe {
    ...
    public struct KeywordEvaluateRequest: TCRequestModel {
        ...
        public init (seqId: UInt64, isEnd: UInt64, voiceFileType: UInt64, voiceEncodeType: UInt64, userVoiceData: String, sessionId: String, keywords: [Keyword], soeAppId: String?, isQuery: UInt64?) {
            self.seqId = seqId
            self.isEnd = isEnd
