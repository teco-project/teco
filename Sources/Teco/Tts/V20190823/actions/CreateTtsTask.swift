...
extension Tts {
    ...
    public struct CreateTtsTaskRequest: TCRequestModel {
        ...
        public init (text: String, modelType: Int64, volume: Float?, speed: Float?, projectId: Int64?, voiceType: Int64?, primaryLanguage: Int64?, sampleRate: UInt64?, codec: String?, callbackUrl: String?, voiceoverDialogueSplit: Bool?) {
            self.text = text
