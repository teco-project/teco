...
/// Service error type returned by `Tts`.
public protocol TCTtsErrorType: TCPlatformErrorType {
    /// Get the service error as ``TCTtsError``.
    ///
    /// - Returns: ``TCTtsError`` that holds the same error code and context.
    func asTtsError() -> TCTtsError
}

public struct TCTtsError: TCTtsErrorType {
    enum Code: String {
