...
extension Sms {
    ...
    public struct ModifySmsSignRequest: TCRequestModel {
        ...
        public init(signId: UInt64, signName: String, signType: UInt64, documentType: UInt64, international: UInt64, usedMethod: UInt64, proofImage: String, commissionImage: String? = nil, remark: String? = nil) {
            self.signId = signId
