...
extension Sms {
    ...
    public struct AddSmsSignRequest: TCRequestModel {
        ...
        public init (signName: String, signType: UInt64, documentType: UInt64, international: UInt64, usedMethod: UInt64, proofImage: String, commissionImage: String?, remark: String?) {
