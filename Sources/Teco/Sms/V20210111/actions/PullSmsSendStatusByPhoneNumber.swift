...
extension Sms {
    ...
    public struct PullSmsSendStatusByPhoneNumberRequest: TCPaginatedRequest {
        ...
        public func getNextPaginatedRequest(with response: PullSmsSendStatusByPhoneNumberResponse) -> PullSmsSendStatusByPhoneNumberRequest? {
            ...
            return PullSmsSendStatusByPhoneNumberRequest(beginTime: self.beginTime, offset: self.offset + .init(response.getItems().count), limit: self.limit, phoneNumber: self.phoneNumber, smsSdkAppId: self.smsSdkAppId, endTime: self.endTime)
        }
    }
    ...
    /// >- 您可以在 [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sms&Version=2021-01-11&Action=SendSms) 中直接运行该接口，可以先免去签名计算步骤。运行成功后，API Explorer可以**自动生成**SDK代码示例。
    @inlinable
    public func pullSmsSendStatusByPhoneNumber(beginTime: UInt64, offset: UInt64, limit: UInt64, phoneNumber: String, smsSdkAppId: String, endTime: UInt64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<PullSmsSendStatusByPhoneNumberResponse> {
        let input = PullSmsSendStatusByPhoneNumberRequest(beginTime: beginTime, offset: offset, limit: limit, phoneNumber: phoneNumber, smsSdkAppId: smsSdkAppId, endTime: endTime)
    ...
    /// >- 您可以在 [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sms&Version=2021-01-11&Action=SendSms) 中直接运行该接口，可以先免去签名计算步骤。运行成功后，API Explorer可以**自动生成**SDK代码示例。
    @inlinable
    public func pullSmsSendStatusByPhoneNumber(beginTime: UInt64, offset: UInt64, limit: UInt64, phoneNumber: String, smsSdkAppId: String, endTime: UInt64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> PullSmsSendStatusByPhoneNumberResponse {
        let input = PullSmsSendStatusByPhoneNumberRequest(beginTime: beginTime, offset: offset, limit: limit, phoneNumber: phoneNumber, smsSdkAppId: smsSdkAppId, endTime: endTime)
    ...
    /// >- 您可以在 [API 3.0 Explorer](https://console.cloud.tencent.com/api/explorer?Product=sms&Version=2021-01-11&Action=SendSms) 中直接运行该接口，可以先免去签名计算步骤。运行成功后，API Explorer可以**自动生成**SDK代码示例。
    @inlinable
    public func pullSmsSendStatusByPhoneNumberPaginator(_ input: PullSmsSendStatusByPhoneNumberRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> (results: TCClient.Paginator<PullSmsSendStatusByPhoneNumberRequest, PullSmsSendStatusByPhoneNumberResponse>.ResultSequence, responses: TCClient.Paginator<PullSmsSendStatusByPhoneNumberRequest, PullSmsSendStatusByPhoneNumberResponse>.ResponseSequence) {
        let results = TCClient.Paginator<PullSmsSendStatusByPhoneNumberRequest, PullSmsSendStatusByPhoneNumberResponse>.ResultSequence(input: input, region: region, command: self.pullSmsSendStatusByPhoneNumber, logger: logger, on: eventLoop)
        let responses = TCClient.Paginator<PullSmsSendStatusByPhoneNumberRequest, PullSmsSendStatusByPhoneNumberResponse>.ResponseSequence(input: input, region: region, command: self.pullSmsSendStatusByPhoneNumber, logger: logger, on: eventLoop)
