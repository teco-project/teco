...
extension Sms {
    ...
    public struct PullSmsSendStatusByPhoneNumberRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: PullSmsSendStatusByPhoneNumberResponse) -> PullSmsSendStatusByPhoneNumberRequest? {
            ...
            return .init(beginTime: self.beginTime, offset: self.offset + .init(response.getItems().count), limit: self.limit, phoneNumber: self.phoneNumber, smsSdkAppId: self.smsSdkAppId, endTime: self.endTime)
        }
    }
