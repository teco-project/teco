...
extension Yunjing {
    ...
    public func describeWeeklyReportBruteAttacks(beginDate: Date, limit: UInt64? = nil, offset: UInt64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeWeeklyReportBruteAttacksResponse> {
        self.describeWeeklyReportBruteAttacks(.init(beginDate: beginDate, limit: limit, offset: offset), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func describeWeeklyReportBruteAttacks(beginDate: Date, limit: UInt64? = nil, offset: UInt64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeWeeklyReportBruteAttacksResponse {
        try await self.describeWeeklyReportBruteAttacks(.init(beginDate: beginDate, limit: limit, offset: offset), region: region, logger: logger, on: eventLoop)
    }
    ...
    /// 本接口 (DescribeWeeklyReportBruteAttacks) 用于获取专业周报密码破解数据。
    @inlinable
    public func describeWeeklyReportBruteAttacksPaginated(_ input: DescribeWeeklyReportBruteAttacksRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<(UInt64?, [WeeklyReportBruteAttack])> {
        self.client.paginate(input: input, region: region, command: self.describeWeeklyReportBruteAttacks, logger: logger, on: eventLoop)
    }
