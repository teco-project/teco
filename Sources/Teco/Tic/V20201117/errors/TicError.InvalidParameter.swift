...
extension TCTicError.InvalidParameter: Equatable {
    public static func == (lhs: TCTicError.InvalidParameter, rhs: TCTicError.InvalidParameter) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCTicError.InvalidParameter: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCTicError.InvalidParameter {
