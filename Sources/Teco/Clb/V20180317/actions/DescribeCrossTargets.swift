...
extension Clb {
    ...
    /// 查询跨域2.0版本云联网后端子机和网卡信息。
    @inlinable
    public func describeCrossTargets(limit: UInt64? = nil, offset: UInt64? = nil, filters: [Filter]? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeCrossTargetsResponse> {
        self.describeCrossTargets(DescribeCrossTargetsRequest(limit: limit, offset: offset, filters: filters), logger: logger, on: eventLoop)
    }
    ...
    /// 查询跨域2.0版本云联网后端子机和网卡信息。
    @inlinable
    public func describeCrossTargets(limit: UInt64? = nil, offset: UInt64? = nil, filters: [Filter]? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeCrossTargetsResponse {
        try await self.describeCrossTargets(DescribeCrossTargetsRequest(limit: limit, offset: offset, filters: filters), logger: logger, on: eventLoop)
    }
}
