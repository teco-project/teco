...
extension Clb {
    ...
    public func describeLoadBalancers(loadBalancerIds: [String]? = nil, loadBalancerType: String? = nil, forward: Int64? = nil, loadBalancerName: String? = nil, domain: String? = nil, loadBalancerVips: [String]? = nil, backendPublicIps: [String]? = nil, backendPrivateIps: [String]? = nil, offset: Int64? = nil, limit: Int64? = nil, orderBy: String? = nil, orderType: Int64? = nil, searchKey: String? = nil, projectId: Int64? = nil, withRs: Int64? = nil, vpcId: String? = nil, securityGroup: String? = nil, masterZone: String? = nil, filters: [Filter]? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeLoadBalancersResponse> {
        let input = DescribeLoadBalancersRequest(loadBalancerIds: loadBalancerIds, loadBalancerType: loadBalancerType, forward: forward, loadBalancerName: loadBalancerName, domain: domain, loadBalancerVips: loadBalancerVips, backendPublicIps: backendPublicIps, backendPrivateIps: backendPrivateIps, offset: offset, limit: limit, orderBy: orderBy, orderType: orderType, searchKey: searchKey, projectId: projectId, withRs: withRs, vpcId: vpcId, securityGroup: securityGroup, masterZone: masterZone, filters: filters)
    ...
    public func describeLoadBalancersPaginator(_ input: DescribeLoadBalancersRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> (results: TCClient.Paginator<DescribeLoadBalancersRequest, DescribeLoadBalancersResponse>.ResultSequence, responses: TCClient.Paginator<DescribeLoadBalancersRequest, DescribeLoadBalancersResponse>.ResponseSequence) {
        let results = TCClient.Paginator<DescribeLoadBalancersRequest, DescribeLoadBalancersResponse>.ResultSequence(input: input, region: region, command: self.describeLoadBalancers, logger: logger, on: eventLoop)
        let responses = TCClient.Paginator<DescribeLoadBalancersRequest, DescribeLoadBalancersResponse>.ResponseSequence(input: input, region: region, command: self.describeLoadBalancers, logger: logger, on: eventLoop)
