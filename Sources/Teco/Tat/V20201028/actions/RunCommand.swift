...
extension Tat {
    ...
    public struct RunCommandRequest: TCRequestModel {
        ...
        public init (content: String, instanceIds: [String], commandName: String?, description: String?, commandType: String?, workingDirectory: String?, timeout: UInt64?, saveCommand: Bool?, enableParameter: Bool?, defaultParameters: String?, parameters: String?, tags: [Tag]?, username: String?, outputCOSBucketUrl: String?, outputCOSKeyPrefix: String?) {
