...
extension Live {
    ...
    /// 支持查询某天或某段时间的转码详细信息。
    @inlinable
    public func describeLiveTranscodeDetailInfo(pushDomain: String? = nil, streamName: String? = nil, dayTime: String? = nil, pageNum: UInt64? = nil, pageSize: UInt64? = nil, startDayTime: String? = nil, endDayTime: String? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeLiveTranscodeDetailInfoResponse> {
        self.describeLiveTranscodeDetailInfo(DescribeLiveTranscodeDetailInfoRequest(pushDomain: pushDomain, streamName: streamName, dayTime: dayTime, pageNum: pageNum, pageSize: pageSize, startDayTime: startDayTime, endDayTime: endDayTime), logger: logger, on: eventLoop)
    }
    ...
    /// 支持查询某天或某段时间的转码详细信息。
    @inlinable
    public func describeLiveTranscodeDetailInfo(pushDomain: String? = nil, streamName: String? = nil, dayTime: String? = nil, pageNum: UInt64? = nil, pageSize: UInt64? = nil, startDayTime: String? = nil, endDayTime: String? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeLiveTranscodeDetailInfoResponse {
        try await self.describeLiveTranscodeDetailInfo(DescribeLiveTranscodeDetailInfoRequest(pushDomain: pushDomain, streamName: streamName, dayTime: dayTime, pageNum: pageNum, pageSize: pageSize, startDayTime: startDayTime, endDayTime: endDayTime), logger: logger, on: eventLoop)
    }
}
