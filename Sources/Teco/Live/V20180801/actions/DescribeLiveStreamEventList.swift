...
extension Live {
    ...
    public struct DescribeLiveStreamEventListRequest: TCPaginatedRequest {
        /// 起始时间。
        ...
        public func makeNextRequest(with response: DescribeLiveStreamEventListResponse) -> DescribeLiveStreamEventListRequest? {
    ...
    public struct DescribeLiveStreamEventListResponse: TCPaginatedResponse {
        /// 推断流事件列表。
    ...
    public func describeLiveStreamEventList(startTime: String, endTime: String, appName: String? = nil, domainName: String? = nil, streamName: String? = nil, pageNum: UInt64? = nil, pageSize: UInt64? = nil, isFilter: Int64? = nil, isStrict: Int64? = nil, isAsc: Int64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeLiveStreamEventListResponse> {
        self.describeLiveStreamEventList(.init(startTime: startTime, endTime: endTime, appName: appName, domainName: domainName, streamName: streamName, pageNum: pageNum, pageSize: pageSize, isFilter: isFilter, isStrict: isStrict, isAsc: isAsc), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func describeLiveStreamEventList(startTime: String, endTime: String, appName: String? = nil, domainName: String? = nil, streamName: String? = nil, pageNum: UInt64? = nil, pageSize: UInt64? = nil, isFilter: Int64? = nil, isStrict: Int64? = nil, isAsc: Int64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeLiveStreamEventListResponse {
        try await self.describeLiveStreamEventList(.init(startTime: startTime, endTime: endTime, appName: appName, domainName: domainName, streamName: streamName, pageNum: pageNum, pageSize: pageSize, isFilter: isFilter, isStrict: isStrict, isAsc: isAsc), region: region, logger: logger, on: eventLoop)
    }
