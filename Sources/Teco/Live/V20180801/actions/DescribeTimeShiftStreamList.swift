...
extension Live {
    ...
    public struct DescribeTimeShiftStreamListRequest: TCRequestModel {
        /// 查询范围起始时间，Unix 时间戳。
    ...
    public struct DescribeTimeShiftStreamListResponse: TCResponseModel {
        /// 时间段内所有的数据量。
    ...
    public func describeTimeShiftStreamList(startTime: Int64, endTime: Int64, streamName: String? = nil, domain: String? = nil, domainGroup: String? = nil, pageSize: Int64? = nil, pageNum: Int64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeTimeShiftStreamListResponse> {
        self.describeTimeShiftStreamList(DescribeTimeShiftStreamListRequest(startTime: startTime, endTime: endTime, streamName: streamName, domain: domain, domainGroup: domainGroup, pageSize: pageSize, pageNum: pageNum), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func describeTimeShiftStreamList(startTime: Int64, endTime: Int64, streamName: String? = nil, domain: String? = nil, domainGroup: String? = nil, pageSize: Int64? = nil, pageNum: Int64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeTimeShiftStreamListResponse {
        try await self.describeTimeShiftStreamList(DescribeTimeShiftStreamListRequest(startTime: startTime, endTime: endTime, streamName: streamName, domain: domain, domainGroup: domainGroup, pageSize: pageSize, pageNum: pageNum), region: region, logger: logger, on: eventLoop)
    }
}
