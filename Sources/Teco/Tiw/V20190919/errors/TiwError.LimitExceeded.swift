...
extension TCTiwError.LimitExceeded: Equatable {
    public static func == (lhs: TCTiwError.LimitExceeded, rhs: TCTiwError.LimitExceeded) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCTiwError.LimitExceeded: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCTiwError.LimitExceeded {
