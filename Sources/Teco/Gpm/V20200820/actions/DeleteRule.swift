...
extension Gpm {
    ...
    /// 删除规则
    @inlinable
    public func deleteRule(ruleCode: String, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture < DeleteRuleResponse > {
        self.deleteRule(DeleteRuleRequest(ruleCode: ruleCode), logger: logger, on: eventLoop)
    }
    ...
    /// 删除规则
    @inlinable
    public func deleteRule(ruleCode: String, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteRuleResponse {
        try await self.deleteRule(DeleteRuleRequest(ruleCode: ruleCode), logger: logger, on: eventLoop)
    }
}
