...
extension Tiems {
    ...
    public struct CreateJobRequest: TCRequestModel {
        ...
        public init (name: String, resourceGroupId: String, cpu: UInt64, memory: UInt64, cluster: String?, predictInput: PredictInput, description: String?, workerCount: UInt64?, configId: String?, gpu: UInt64?, gpuMemory: UInt64?, gpuType: String?, quantizationInput: QuantizationInput, logTopicId: String?) {
            self.name = name
