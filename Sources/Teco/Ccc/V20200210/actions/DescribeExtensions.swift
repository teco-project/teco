...
extension Ccc {
    ...
    public struct DescribeExtensionsRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribeExtensionsResponse) -> DescribeExtensionsRequest? {
            ...
            return .init(sdkAppId: self.sdkAppId, pageNumber: self.pageNumber + 1, extensionIds: self.extensionIds, pageSize: self.pageSize, fuzzingKeyWord: self.fuzzingKeyWord, isNeedStatus: self.isNeedStatus)
        }
    }
    ...
    public struct DescribeExtensionsResponse: TCPaginatedResponse {
        ...
        /// Extract the returned ``ExtensionInfo`` list from the paginated response.
