...
extension Bma {
    ...
    public struct CreateCRRightRequest: TCRequestModel {
        ...
        public init(workId: Int64, tortUrl: String, tortTitle: String? = nil, tortPlat: String? = nil, rightUrl: String? = nil, fileUrl: String? = nil, validStartDate: String? = nil, validEndDate: String? = nil, commFileUrl: String? = nil, commValidStartDate: String? = nil, commValidEndDate: String? = nil, homeFileUrl: String? = nil, homeValidStartDate: String? = nil, homeValidEndDate: String? = nil, isProducer: String? = nil, evidenceFileUrl: String? = nil, evidenceValidStartDate: String? = nil, evidenceValidEndDate: String? = nil) {
            ...
            self.homeFileUrl = homeFileUrl
            self.homeValidStartDate = homeValidStartDate
            self.homeValidEndDate = homeValidEndDate
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case homeFileUrl = "HomeFileUrl"
            case homeValidStartDate = "HomeValidStartDate"
            case homeValidEndDate = "HomeValidEndDate"
    ...
    public func createCRRight(workId: Int64, tortUrl: String, tortTitle: String? = nil, tortPlat: String? = nil, rightUrl: String? = nil, fileUrl: String? = nil, validStartDate: String? = nil, validEndDate: String? = nil, commFileUrl: String? = nil, commValidStartDate: String? = nil, commValidEndDate: String? = nil, homeFileUrl: String? = nil, homeValidStartDate: String? = nil, homeValidEndDate: String? = nil, isProducer: String? = nil, evidenceFileUrl: String? = nil, evidenceValidStartDate: String? = nil, evidenceValidEndDate: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateCRRightResponse> {
        let input = CreateCRRightRequest(workId: workId, tortUrl: tortUrl, tortTitle: tortTitle, tortPlat: tortPlat, rightUrl: rightUrl, fileUrl: fileUrl, validStartDate: validStartDate, validEndDate: validEndDate, commFileUrl: commFileUrl, commValidStartDate: commValidStartDate, commValidEndDate: commValidEndDate, homeFileUrl: homeFileUrl, homeValidStartDate: homeValidStartDate, homeValidEndDate: homeValidEndDate, isProducer: isProducer, evidenceFileUrl: evidenceFileUrl, evidenceValidStartDate: evidenceValidStartDate, evidenceValidEndDate: evidenceValidEndDate)
        return self.client.execute(action: "CreateCRRight", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func createCRRight(workId: Int64, tortUrl: String, tortTitle: String? = nil, tortPlat: String? = nil, rightUrl: String? = nil, fileUrl: String? = nil, validStartDate: String? = nil, validEndDate: String? = nil, commFileUrl: String? = nil, commValidStartDate: String? = nil, commValidEndDate: String? = nil, homeFileUrl: String? = nil, homeValidStartDate: String? = nil, homeValidEndDate: String? = nil, isProducer: String? = nil, evidenceFileUrl: String? = nil, evidenceValidStartDate: String? = nil, evidenceValidEndDate: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateCRRightResponse {
        let input = CreateCRRightRequest(workId: workId, tortUrl: tortUrl, tortTitle: tortTitle, tortPlat: tortPlat, rightUrl: rightUrl, fileUrl: fileUrl, validStartDate: validStartDate, validEndDate: validEndDate, commFileUrl: commFileUrl, commValidStartDate: commValidStartDate, commValidEndDate: commValidEndDate, homeFileUrl: homeFileUrl, homeValidStartDate: homeValidStartDate, homeValidEndDate: homeValidEndDate, isProducer: isProducer, evidenceFileUrl: evidenceFileUrl, evidenceValidStartDate: evidenceValidStartDate, evidenceValidEndDate: evidenceValidEndDate)
        return try await self.client.execute(action: "CreateCRRight", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop).get()
    }
}
