...
extension Tse {
    ...
    public struct ModifyCloudNativeAPIGatewayRouteRateLimitRequest: TCRequestModel {
        /// 网关ID
    ...
    public struct ModifyCloudNativeAPIGatewayRouteRateLimitResponse: TCResponseModel {
