...
extension Tse {
    ...
    public struct DeleteCloudNativeAPIGatewayServiceRateLimitRequest: TCRequest {
        /// 网关Id
    ...
    public struct DeleteCloudNativeAPIGatewayServiceRateLimitResponse: TCResponse {
