...
public protocol TCTcssErrorType: TCServiceErrorType {
    ...
    func asTcssError() -> TCTcssError
}

public struct TCTcssError: TCTcssErrorType {
    enum Code: String {
    ...
    /// Error domains affliated to ``TCTcssError``.
    public static var domains: [TCErrorType.Type] {
        [FailedOperation.self, InternalError.self, InvalidParameter.self, InvalidParameterValue.self]
    }
