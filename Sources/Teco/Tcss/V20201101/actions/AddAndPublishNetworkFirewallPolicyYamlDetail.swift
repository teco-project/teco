...
extension Tcss {
    ...
    public struct AddAndPublishNetworkFirewallPolicyYamlDetailRequest: TCRequest {
        /// 集群Id
    ...
    public struct AddAndPublishNetworkFirewallPolicyYamlDetailResponse: TCResponse {
        /// 返回创建的任务的ID，为0表示创建失败。
