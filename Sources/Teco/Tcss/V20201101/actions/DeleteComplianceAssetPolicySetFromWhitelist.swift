...
extension Tcss {
    ...
    public struct DeleteComplianceAssetPolicySetFromWhitelistRequest: TCRequest {
        /// 资产ID
    ...
    public struct DeleteComplianceAssetPolicySetFromWhitelistResponse: TCResponse {
