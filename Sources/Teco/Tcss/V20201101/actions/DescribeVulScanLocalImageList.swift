...
extension Tcss {
    ...
    public struct DescribeVulScanLocalImageListRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribeVulScanLocalImageListResponse) -> DescribeVulScanLocalImageListRequest? {
            ...
            return DescribeVulScanLocalImageListRequest(taskID: self.taskID, filters: self.filters, limit: self.limit, offset: (self.offset ?? 0) + .init(response.getItems().count), order: self.order, by: self.by)
        }
    }
