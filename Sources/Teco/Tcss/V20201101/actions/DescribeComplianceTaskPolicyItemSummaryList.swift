...
extension Tcss {
    ...
    public struct DescribeComplianceTaskPolicyItemSummaryListRequest: TCPaginatedRequest {
        ...
        public func getNextPaginatedRequest(with response: DescribeComplianceTaskPolicyItemSummaryListResponse) -> DescribeComplianceTaskPolicyItemSummaryListRequest? {
