...
extension Tcss {
    ...
    public struct DescribeAssetComponentListRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribeAssetComponentListResponse) -> DescribeAssetComponentListRequest? {
    ...
    public struct DescribeAssetComponentListResponse: TCPaginatedResponse {
        ...
        /// Extract the returned ``ComponentInfo`` list from the paginated response.
