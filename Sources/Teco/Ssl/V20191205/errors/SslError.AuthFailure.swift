...
extension TCSslError.AuthFailure: Equatable {
    public static func == (lhs: TCSslError.AuthFailure, rhs: TCSslError.AuthFailure) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCSslError.AuthFailure: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCSslError.AuthFailure {
