...
extension Asw {
    ...
    public struct DescribeFlowServicesRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribeFlowServicesResponse) -> DescribeFlowServicesRequest? {
    ...
    public struct DescribeFlowServicesResponse: TCPaginatedResponse {
        ...
        /// Extract the returned ``StateMachine`` list from the paginated response.
