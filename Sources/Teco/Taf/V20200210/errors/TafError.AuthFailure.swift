...
extension TCTafError.AuthFailure: Equatable {
    public static func == (lhs: TCTafError.AuthFailure, rhs: TCTafError.AuthFailure) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCTafError.AuthFailure: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCTafError.AuthFailure {
