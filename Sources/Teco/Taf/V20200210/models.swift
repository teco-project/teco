...
extension Taf {
    ...
    public struct InputRecognizeTargetAudience: TCInputModel {
        ...
        public init (modelIdList: [Int64], uid: String?, accountType: Int64?, ip: String?, os: String?, osv: String?, lat: String?, lon: String?, deviceModel: String?, bidFloor: Int64?, age: Int64?, gender: Int64?, location: String?, deliveryMode: Int64?, advertisingType: Int64?, mac: String?, phone: String?, ua: String?, app: String?, package: String?, maker: String?, deviceType: String?, accessMode: String?, sp: Int64?, deviceW: Int64?, deviceH: Int64?, fullScreen: Int64?, impBannerW: Int64?, impBannerH: Int64?, url: String?, context: String?, channel: String?, reqId: String?, reqMd5: String?, adType: Int64?, appName: String?, appVer: String?, reqType: Int64?, isAuthorized: UInt64?, deviceList: [Device]?) {
