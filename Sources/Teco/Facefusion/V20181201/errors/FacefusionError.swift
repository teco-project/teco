...
public protocol TCFacefusionErrorType: TCPlatformErrorType {
...
public struct TCFacefusionError: TCFacefusionErrorType {
    ...
    public static var domains: [TCErrorType.Type] {
        [AuthFailure.self, FailedOperation.self, InvalidParameterValue.self, ResourceUnavailable.self, ResourcesSoldOut.self]
    }
