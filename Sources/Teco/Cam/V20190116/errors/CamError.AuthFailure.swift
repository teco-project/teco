...
extension TCCamError.AuthFailure: Equatable {
    public static func == (lhs: TCCamError.AuthFailure, rhs: TCCamError.AuthFailure) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCCamError.AuthFailure: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCCamError.AuthFailure {
