...
extension TCCamError.InternalError: Equatable {
    public static func == (lhs: TCCamError.InternalError, rhs: TCCamError.InternalError) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCCamError.InternalError: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCCamError.InternalError {
