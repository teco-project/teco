public struct TCCamError: TCErrorType {
    enum Code: String {
...
extension TCCamError {
    public static var domains: [TCErrorType.Type] {
        return [AuthFailure.self, FailedOperation.self, InternalError.self, InvalidParameter.self, InvalidParameterValue.self, LimitExceeded.self, OperationDenied.self, RequestLimitExceeded.self, ResourceNotFound.self, UnauthorizedOperation.self]
    }
}

extension TCCamError: Equatable {
    public static func == (lhs: TCCamError, rhs: TCCamError) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCCamError: CustomStringConvertible {
