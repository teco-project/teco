...
extension Cam {
    ...
    public struct ListCollaboratorsRequest: TCPaginatedRequest {
        /// 分页条数，缺省为20
        ...
        public func makeNextRequest(with response: ListCollaboratorsResponse) -> ListCollaboratorsRequest? {
    ...
    public struct ListCollaboratorsResponse: TCPaginatedResponse {
        /// 总数
        ...
        /// Extract the returned ``SubAccountInfo`` list from the paginated response.
        public func getItems() -> [SubAccountInfo] {
            self.data
        }
