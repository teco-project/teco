...
extension Cdb {
    ...
    /// 本接口(DescribeDBInstances)用于查询云数据库实例列表，支持通过项目 ID、实例 ID、访问地址、实例状态等过滤条件来筛选实例。支持查询主实例、灾备实例和只读实例信息列表。
    @inlinable
    public func describeDBInstances(projectId: Int64? = nil, instanceTypes: [UInt64]? = nil, vips: [String]? = nil, status: [UInt64]? = nil, offset: UInt64? = nil, limit: UInt64? = nil, securityGroupId: String? = nil, payTypes: [UInt64]? = nil, instanceNames: [String]? = nil, taskStatus: [UInt64]? = nil, engineVersions: [String]? = nil, vpcIds: [UInt64]? = nil, zoneIds: [UInt64]? = nil, subnetIds: [UInt64]? = nil, cdbErrors: [Int64]? = nil, orderBy: String? = nil, orderDirection: String? = nil, withSecurityGroup: Int64? = nil, withExCluster: Int64? = nil, exClusterId: String? = nil, instanceIds: [String]? = nil, initFlag: Int64? = nil, withDr: Int64? = nil, withRo: Int64? = nil, withMaster: Int64? = nil, deployGroupIds: [String]? = nil, tagKeysForSearch: [String]? = nil, cageIds: [String]? = nil, tagValues: [String]? = nil, uniqueVpcIds: [String]? = nil, uniqSubnetIds: [String]? = nil, tags: [Tag]? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDBInstancesResponse> {
        self.describeDBInstances(DescribeDBInstancesRequest(projectId: projectId, instanceTypes: instanceTypes, vips: vips, status: status, offset: offset, limit: limit, securityGroupId: securityGroupId, payTypes: payTypes, instanceNames: instanceNames, taskStatus: taskStatus, engineVersions: engineVersions, vpcIds: vpcIds, zoneIds: zoneIds, subnetIds: subnetIds, cdbErrors: cdbErrors, orderBy: orderBy, orderDirection: orderDirection, withSecurityGroup: withSecurityGroup, withExCluster: withExCluster, exClusterId: exClusterId, instanceIds: instanceIds, initFlag: initFlag, withDr: withDr, withRo: withRo, withMaster: withMaster, deployGroupIds: deployGroupIds, tagKeysForSearch: tagKeysForSearch, cageIds: cageIds, tagValues: tagValues, uniqueVpcIds: uniqueVpcIds, uniqSubnetIds: uniqSubnetIds, tags: tags), region: region, logger: logger, on: eventLoop)
    }
    ...
    /// 本接口(DescribeDBInstances)用于查询云数据库实例列表，支持通过项目 ID、实例 ID、访问地址、实例状态等过滤条件来筛选实例。支持查询主实例、灾备实例和只读实例信息列表。
    @inlinable
    public func describeDBInstances(projectId: Int64? = nil, instanceTypes: [UInt64]? = nil, vips: [String]? = nil, status: [UInt64]? = nil, offset: UInt64? = nil, limit: UInt64? = nil, securityGroupId: String? = nil, payTypes: [UInt64]? = nil, instanceNames: [String]? = nil, taskStatus: [UInt64]? = nil, engineVersions: [String]? = nil, vpcIds: [UInt64]? = nil, zoneIds: [UInt64]? = nil, subnetIds: [UInt64]? = nil, cdbErrors: [Int64]? = nil, orderBy: String? = nil, orderDirection: String? = nil, withSecurityGroup: Int64? = nil, withExCluster: Int64? = nil, exClusterId: String? = nil, instanceIds: [String]? = nil, initFlag: Int64? = nil, withDr: Int64? = nil, withRo: Int64? = nil, withMaster: Int64? = nil, deployGroupIds: [String]? = nil, tagKeysForSearch: [String]? = nil, cageIds: [String]? = nil, tagValues: [String]? = nil, uniqueVpcIds: [String]? = nil, uniqSubnetIds: [String]? = nil, tags: [Tag]? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeDBInstancesResponse {
        try await self.describeDBInstances(DescribeDBInstancesRequest(projectId: projectId, instanceTypes: instanceTypes, vips: vips, status: status, offset: offset, limit: limit, securityGroupId: securityGroupId, payTypes: payTypes, instanceNames: instanceNames, taskStatus: taskStatus, engineVersions: engineVersions, vpcIds: vpcIds, zoneIds: zoneIds, subnetIds: subnetIds, cdbErrors: cdbErrors, orderBy: orderBy, orderDirection: orderDirection, withSecurityGroup: withSecurityGroup, withExCluster: withExCluster, exClusterId: exClusterId, instanceIds: instanceIds, initFlag: initFlag, withDr: withDr, withRo: withRo, withMaster: withMaster, deployGroupIds: deployGroupIds, tagKeysForSearch: tagKeysForSearch, cageIds: cageIds, tagValues: tagValues, uniqueVpcIds: uniqueVpcIds, uniqSubnetIds: uniqSubnetIds, tags: tags), region: region, logger: logger, on: eventLoop)
    }
}
