...
extension TCTcaplusdbError.AuthFailure: Equatable {
    public static func == (lhs: TCTcaplusdbError.AuthFailure, rhs: TCTcaplusdbError.AuthFailure) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCTcaplusdbError.AuthFailure: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCTcaplusdbError.AuthFailure {
