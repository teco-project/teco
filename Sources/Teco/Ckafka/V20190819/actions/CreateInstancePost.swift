...
extension Ckafka {
    ...
    public struct CreateInstancePostRequest: TCRequestModel {
        ...
        public init(instanceName: String, bandWidth: Int64, vpcId: String? = nil, subnetId: String? = nil, instanceType: Int64? = nil, msgRetentionTime: Int64? = nil, clusterId: Int64? = nil, kafkaVersion: String? = nil, specificationsType: String? = nil, diskType: String? = nil, diskSize: Int64? = nil, partition: Int64? = nil, topicNum: Int64? = nil, zoneId: Int64? = nil, multiZoneFlag: Bool? = nil, zoneIds: [Int64]? = nil, instanceNum: Int64? = nil, publicNetworkMonthly: Int64? = nil) {
    ...
    /// 由于出参需要更新，当前接口将会在未来版本中废弃，建议用户迁移使用 CreatePostPaidInstance 接口。创建按量计费实例。通常用于 SDK 或云 API 控制台调用接口，创建后付费 CKafka 实例。调用接口与在 CKafka 控制台购买按量付费实例效果相同。
    @inlinable
    public func createInstancePost(instanceName: String, bandWidth: Int64, vpcId: String? = nil, subnetId: String? = nil, instanceType: Int64? = nil, msgRetentionTime: Int64? = nil, clusterId: Int64? = nil, kafkaVersion: String? = nil, specificationsType: String? = nil, diskType: String? = nil, diskSize: Int64? = nil, partition: Int64? = nil, topicNum: Int64? = nil, zoneId: Int64? = nil, multiZoneFlag: Bool? = nil, zoneIds: [Int64]? = nil, instanceNum: Int64? = nil, publicNetworkMonthly: Int64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateInstancePostResponse> {
        self.createInstancePost(.init(instanceName: instanceName, bandWidth: bandWidth, vpcId: vpcId, subnetId: subnetId, instanceType: instanceType, msgRetentionTime: msgRetentionTime, clusterId: clusterId, kafkaVersion: kafkaVersion, specificationsType: specificationsType, diskType: diskType, diskSize: diskSize, partition: partition, topicNum: topicNum, zoneId: zoneId, multiZoneFlag: multiZoneFlag, zoneIds: zoneIds, instanceNum: instanceNum, publicNetworkMonthly: publicNetworkMonthly), region: region, logger: logger, on: eventLoop)
    }
    ...
    /// 由于出参需要更新，当前接口将会在未来版本中废弃，建议用户迁移使用 CreatePostPaidInstance 接口。创建按量计费实例。通常用于 SDK 或云 API 控制台调用接口，创建后付费 CKafka 实例。调用接口与在 CKafka 控制台购买按量付费实例效果相同。
    @inlinable
    public func createInstancePost(instanceName: String, bandWidth: Int64, vpcId: String? = nil, subnetId: String? = nil, instanceType: Int64? = nil, msgRetentionTime: Int64? = nil, clusterId: Int64? = nil, kafkaVersion: String? = nil, specificationsType: String? = nil, diskType: String? = nil, diskSize: Int64? = nil, partition: Int64? = nil, topicNum: Int64? = nil, zoneId: Int64? = nil, multiZoneFlag: Bool? = nil, zoneIds: [Int64]? = nil, instanceNum: Int64? = nil, publicNetworkMonthly: Int64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateInstancePostResponse {
        try await self.createInstancePost(.init(instanceName: instanceName, bandWidth: bandWidth, vpcId: vpcId, subnetId: subnetId, instanceType: instanceType, msgRetentionTime: msgRetentionTime, clusterId: clusterId, kafkaVersion: kafkaVersion, specificationsType: specificationsType, diskType: diskType, diskSize: diskSize, partition: partition, topicNum: topicNum, zoneId: zoneId, multiZoneFlag: multiZoneFlag, zoneIds: zoneIds, instanceNum: instanceNum, publicNetworkMonthly: publicNetworkMonthly), region: region, logger: logger, on: eventLoop)
    }
}
