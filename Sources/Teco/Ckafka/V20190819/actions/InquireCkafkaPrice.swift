...
extension Ckafka {
    ...
    public struct InquireCkafkaPriceRequest: TCRequestModel {
        ...
        public init (instanceType: String, instanceChargeParam: InstanceChargeParam, instanceNum: Int64?, bandwidth: Int64?, inquiryDiskParam: InquiryDiskParam, messageRetention: Int64?, topic: Int64?, partition: Int64?, zoneIds: [Int64]?, categoryAction: String?, billType: String?, publicNetworkParam: InquiryPublicNetworkParam, instanceId: String?) {
