...
extension Ckafka {
    ...
    public struct CreateCdcClusterRequest: TCRequest {
        /// cdc的id
    ...
    public struct CreateCdcClusterResponse: TCResponse {
    ...
    public func createCdcCluster(cdcId: String, cdcVpcId: String, cdcSubnetId: String, zoneId: Int64, bandwidth: Int64, diskSize: Int64, diskType: String, systemDiskType: String, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateCdcClusterResponse> {
        self.createCdcCluster(.init(cdcId: cdcId, cdcVpcId: cdcVpcId, cdcSubnetId: cdcSubnetId, zoneId: zoneId, bandwidth: bandwidth, diskSize: diskSize, diskType: diskType, systemDiskType: systemDiskType), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func createCdcCluster(cdcId: String, cdcVpcId: String, cdcSubnetId: String, zoneId: Int64, bandwidth: Int64, diskSize: Int64, diskType: String, systemDiskType: String, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateCdcClusterResponse {
        try await self.createCdcCluster(.init(cdcId: cdcId, cdcVpcId: cdcVpcId, cdcSubnetId: cdcSubnetId, zoneId: zoneId, bandwidth: bandwidth, diskSize: diskSize, diskType: diskType, systemDiskType: systemDiskType), region: region, logger: logger, on: eventLoop)
    }
}
