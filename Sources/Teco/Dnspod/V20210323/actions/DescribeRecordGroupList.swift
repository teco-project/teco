...
extension Dnspod {
    ...
    public struct DescribeRecordGroupListRequest: TCPaginatedRequest {
        /// 域名
        ...
        public func makeNextRequest(with response: DescribeRecordGroupListResponse) -> DescribeRecordGroupListRequest? {
    ...
    public struct DescribeRecordGroupListResponse: TCPaginatedResponse {
        /// 分组列表
        ...
        /// Extract the returned ``RecordGroupInfo`` list from the paginated response.
        public func getItems() -> [RecordGroupInfo] {
            self.groupList
        }
    }
    ...
    /// 查询解析记录分组列表
    ///
    /// - Returns: `AsyncSequence`s of ``RecordGroupInfo`` and ``DescribeRecordGroupListResponse`` that can be iterated over asynchronously on demand.
    @inlinable
