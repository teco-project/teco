...
extension Tdmq {
    ...
    public struct DescribeNamespaceBundlesOptRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribeNamespaceBundlesOptResponse) -> DescribeNamespaceBundlesOptRequest? {
    ...
    public struct DescribeNamespaceBundlesOptResponse: TCPaginatedResponse {
        ...
        /// Extract the returned ``BundleSetOpt`` list from the paginated response.
