...
extension Tdmq {
    ...
    public struct ReceiveMessageRequest: TCRequestModel {
        ...
        public init (topic: String, subscriptionName: String, receiverQueueSize: Int64?, subInitialPosition: String?, maxNumMessages: Int64?, maxNumBytes: Int64?, timeout: Int64?) {
            self.topic = topic
