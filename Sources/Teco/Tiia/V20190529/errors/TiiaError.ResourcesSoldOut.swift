...
extension TCTiiaError.ResourcesSoldOut: Equatable {
    public static func == (lhs: TCTiiaError.ResourcesSoldOut, rhs: TCTiiaError.ResourcesSoldOut) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCTiiaError.ResourcesSoldOut: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCTiiaError.ResourcesSoldOut {
