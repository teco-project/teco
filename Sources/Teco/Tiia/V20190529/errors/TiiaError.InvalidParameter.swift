...
extension TCTiiaError.InvalidParameter: Equatable {
    public static func == (lhs: TCTiiaError.InvalidParameter, rhs: TCTiiaError.InvalidParameter) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCTiiaError.InvalidParameter: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCTiiaError.InvalidParameter {
