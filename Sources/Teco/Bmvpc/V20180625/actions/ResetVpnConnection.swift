...
extension Bmvpc {
    ...
    /// 本接口(ResetVpnConnection)用于重置VPN通道。
    @inlinable
    public func resetVpnConnection(vpcId: String, vpnConnectionId: String, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<ResetVpnConnectionResponse> {
        self.resetVpnConnection(ResetVpnConnectionRequest(vpcId: vpcId, vpnConnectionId: vpnConnectionId), logger: logger, on: eventLoop)
    }
    ...
    /// 本接口(ResetVpnConnection)用于重置VPN通道。
    @inlinable
    public func resetVpnConnection(vpcId: String, vpnConnectionId: String, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> ResetVpnConnectionResponse {
        try await self.resetVpnConnection(ResetVpnConnectionRequest(vpcId: vpcId, vpnConnectionId: vpnConnectionId), logger: logger, on: eventLoop)
    }
}
