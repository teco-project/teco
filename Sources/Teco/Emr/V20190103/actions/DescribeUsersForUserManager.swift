...
extension Emr {
    ...
    public struct DescribeUsersForUserManagerRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribeUsersForUserManagerResponse) -> DescribeUsersForUserManagerRequest? {
    ...
    public struct DescribeUsersForUserManagerResponse: TCPaginatedResponse {
        ...
        /// Extract the returned ``UserManagerUserBriefInfo`` list from the paginated response.
