...
extension Emr {
    ...
    public struct ScaleOutInstanceRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: ScaleOutInstanceResponse) -> ScaleOutInstanceRequest? {
            ...
            return ScaleOutInstanceRequest(timeUnit: self.timeUnit, timeSpan: self.timeSpan, instanceId: self.instanceId, payMode: self.payMode, clientToken: response.clientToken, preExecutedFileSettings: self.preExecutedFileSettings, taskCount: self.taskCount, coreCount: self.coreCount, unNecessaryNodeList: self.unNecessaryNodeList, routerCount: self.routerCount, softDeployInfo: self.softDeployInfo, serviceNodeInfo: self.serviceNodeInfo, disasterRecoverGroupIds: self.disasterRecoverGroupIds, tags: self.tags, hardwareResourceType: self.hardwareResourceType, podSpec: self.podSpec, clickHouseClusterName: self.clickHouseClusterName, clickHouseClusterType: self.clickHouseClusterType, yarnNodeLabel: self.yarnNodeLabel, podParameter: self.podParameter, masterCount: self.masterCount, startServiceAfterScaleOut: self.startServiceAfterScaleOut, zoneId: self.zoneId, subnetId: self.subnetId, scaleOutServiceConfAssign: self.scaleOutServiceConfAssign, autoRenew: self.autoRenew)
        }
    }

    /// ScaleOutInstance返回参数结构体
    public struct ScaleOutInstanceResponse: TCPaginatedResponse {
        /// 实例ID。
        public let instanceId: String
