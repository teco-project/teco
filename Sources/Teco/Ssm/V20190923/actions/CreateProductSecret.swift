...
extension Ssm {
    ...
    public struct CreateProductSecretRequest: TCRequest {
    ...
    public struct CreateProductSecretResponse: TCResponse {
        /// 创建的凭据名称。
        public let secretName: String
    ...
    public func createProductSecret(secretName: String, userNamePrefix: String, productName: String, instanceID: String, domains: [String], privilegesList: [ProductPrivilegeUnit], description: String? = nil, kmsKeyId: String? = nil, tags: [Tag]? = nil, rotationBeginTime: String? = nil, enableRotation: Bool? = nil, rotationFrequency: Int64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateProductSecretResponse> {
        self.createProductSecret(.init(secretName: secretName, userNamePrefix: userNamePrefix, productName: productName, instanceID: instanceID, domains: domains, privilegesList: privilegesList, description: description, kmsKeyId: kmsKeyId, tags: tags, rotationBeginTime: rotationBeginTime, enableRotation: enableRotation, rotationFrequency: rotationFrequency), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func createProductSecret(secretName: String, userNamePrefix: String, productName: String, instanceID: String, domains: [String], privilegesList: [ProductPrivilegeUnit], description: String? = nil, kmsKeyId: String? = nil, tags: [Tag]? = nil, rotationBeginTime: String? = nil, enableRotation: Bool? = nil, rotationFrequency: Int64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateProductSecretResponse {
        try await self.createProductSecret(.init(secretName: secretName, userNamePrefix: userNamePrefix, productName: productName, instanceID: instanceID, domains: domains, privilegesList: privilegesList, description: description, kmsKeyId: kmsKeyId, tags: tags, rotationBeginTime: rotationBeginTime, enableRotation: enableRotation, rotationFrequency: rotationFrequency), region: region, logger: logger, on: eventLoop)
    }
}
