...
extension Wav {
    ...
    public struct QueryCrmStatisticsRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: QueryCrmStatisticsResponse) -> QueryCrmStatisticsRequest? {
            ...
            return .init(beginTime: self.beginTime, endTime: self.endTime, cursor: response.nextCursor, limit: self.limit, salesId: self.salesId, orgId: self.orgId)
        }
    }
    ...
    public struct QueryCrmStatisticsResponse: TCPaginatedResponse {
        ...
        /// Extract the returned ``CrmStatisticsData`` list from the paginated response.
