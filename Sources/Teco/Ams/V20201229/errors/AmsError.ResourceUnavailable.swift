...
extension TCAmsError.ResourceUnavailable: Equatable {
    public static func == (lhs: TCAmsError.ResourceUnavailable, rhs: TCAmsError.ResourceUnavailable) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCAmsError.ResourceUnavailable: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCAmsError.ResourceUnavailable {
