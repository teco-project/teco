...
extension Cme {
    ...
    public struct HandleStreamConnectProjectRequest: TCRequestModel {
        ...
        public init (platform: String, projectId: String, operation: String, inputInfo: StreamInputInfo, inputEndpoint: String?, outputInfo: StreamConnectOutput, currentStopTime: String?, `operator`: String?) {
