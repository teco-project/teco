public struct TCCmeError: TCErrorType {
    enum Code: String {
...
extension TCCmeError {
    public static var domains: [TCErrorType.Type] {
        return [FailedOperation.self, InternalError.self, InvalidParameter.self, InvalidParameterValue.self, LimitExceeded.self, OperationDenied.self, ResourceNotFound.self]
    }
}

extension TCCmeError: Equatable {
    public static func == (lhs: TCCmeError, rhs: TCCmeError) -> Bool {
        lhs.error == rhs.error
    }
}
