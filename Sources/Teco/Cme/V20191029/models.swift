...
extension Cme {
    ...
    public struct EventContent: TCOutputModel {
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case storageNewFileCreatedEvent = "StorageNewFileCreatedEvent"
            case projectStreamConnectStatusChangedEvent = "ProjectStreamConnectStatusChangedEvent"
            case projectSwitcherStatusChangedEvent = "ProjectSwitcherStatusChangedEvent"
            case materialImportedEvent = "MaterialImportedEvent"
            case materialAddedEvent = "MaterialAddedEvent"
            case materialMovedEvent = "MaterialMovedEvent"
            case materialModifiedEvent = "MaterialModifiedEvent"
            case materialDeletedEvent = "MaterialDeletedEvent"
            case classCreatedEvent = "ClassCreatedEvent"
            case classMovedEvent = "ClassMovedEvent"
            case classDeletedEvent = "ClassDeletedEvent"
            case videoExportCompletedEvent = "VideoExportCompletedEvent"
    ...
    public struct LinkMaterial: TCOutputModel {
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case linkMaterialInfo = "LinkMaterialInfo"
    ...
    public struct LinkMaterialInfo: TCOutputModel {
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case audioMaterial = "AudioMaterial"
    ...
    public struct MaterialBasicInfo: TCOutputModel {
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case classPath = "ClassPath"
            case presetTagSet = "PresetTagSet"
            case tagSet = "TagSet"
    ...
    public struct MaterialInfo: TCOutputModel {
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case audioMaterial = "AudioMaterial"
            case imageMaterial = "ImageMaterial"
            case linkMaterial = "LinkMaterial"
            case videoEditTemplateMaterial = "VideoEditTemplateMaterial"
    ...
    public struct MaterialModifiedEvent: TCOutputModel {
        ...
        enum CodingKeys: String, CodingKey {
            case materialId = "MaterialId"
            case name = "Name"
            case presetTagIdSet = "PresetTagIdSet"
            case tagSet = "TagSet"
        }
    }
    ...
    public struct MediaMetaData: TCOutputModel {
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case duration = "Duration"
            case rotate = "Rotate"
            case videoStreamInfoSet = "VideoStreamInfoSet"
    ...
    public struct ProjectInfo: TCOutputModel {
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case owner = "Owner"
            case coverUrl = "CoverUrl"
            case streamConnectProjectInfo = "StreamConnectProjectInfo"
            case mediaCastProjectInfo = "MediaCastProjectInfo"
            case updateTime = "UpdateTime"
            case createTime = "CreateTime"
        }
    }
    ...
    public struct ProjectMediaCastStatusChangedEvent: TCOutputModel {
        ...
        enum CodingKeys: String, CodingKey {
            case projectId = "ProjectId"
            case status = "Status"
            case sourceInterruptInfo = "SourceInterruptInfo"
    ...
    public struct ProjectStreamConnectStatusChangedEvent: TCOutputModel {
        ...
        enum CodingKeys: String, CodingKey {
            case projectId = "ProjectId"
            case status = "Status"
            case inputInterruptInfo = "InputInterruptInfo"
    ...
    public struct RecordReplayProjectInput: TCInputModel {
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case materialClassPath = "MaterialClassPath"
    ...
    public struct SlotInfo: TCOutputModel {
        ...
        enum CodingKeys: String, CodingKey {
            case id = "Id"
            case type = "Type"
            case defaultMaterialId = "DefaultMaterialId"
            case defaultTextSlotInfo = "DefaultTextSlotInfo"
            case duration = "Duration"
        }
    }
    ...
    public struct SlotReplacementInfo: TCInputModel {
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case mediaReplacementInfo = "MediaReplacementInfo"
    ...
    public struct StreamInputInfo: TCInputModel, TCOutputModel {
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case livePullInputInfo = "LivePullInputInfo"
    ...
    public struct ThirdPartyPublishInfo: TCInputModel {
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case weiboPublishInfo = "WeiboPublishInfo"
            case kuaishouPublishInfo = "KuaishouPublishInfo"
