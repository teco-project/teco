...
extension Gme {
    ...
    public struct DeleteScanUserRequest: TCRequest {
        ...
        public init(bizId: UInt64, userId: UInt64? = nil, userIdString: String? = nil) {
            self.bizId = bizId
            self.userId = userId
    ...
    public struct DeleteScanUserResponse: TCResponse {
        /// 返回结果码
    ...
    /// 删除自定义送检用户。**接口使用前提**：目前 DeleteScanUser 接口通过白名单开放，如需使用，需要 [提交工单申请](https://console.cloud.tencent.com/workorder/category?level1_id=438&level2_id=445&source=0&data_title=%E6%B8%B8%E6%88%8F%E5%A4%9A%E5%AA%92%E4%BD%93%E5%BC%95%E6%93%8EGME&step=1)。
    @inlinable
    public func deleteScanUser(bizId: UInt64, userId: UInt64? = nil, userIdString: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeleteScanUserResponse> {
        self.deleteScanUser(.init(bizId: bizId, userId: userId, userIdString: userIdString), region: region, logger: logger, on: eventLoop)
    }
    ...
    /// 删除自定义送检用户。**接口使用前提**：目前 DeleteScanUser 接口通过白名单开放，如需使用，需要 [提交工单申请](https://console.cloud.tencent.com/workorder/category?level1_id=438&level2_id=445&source=0&data_title=%E6%B8%B8%E6%88%8F%E5%A4%9A%E5%AA%92%E4%BD%93%E5%BC%95%E6%93%8EGME&step=1)。
    @inlinable
    public func deleteScanUser(bizId: UInt64, userId: UInt64? = nil, userIdString: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeleteScanUserResponse {
        try await self.deleteScanUser(.init(bizId: bizId, userId: userId, userIdString: userIdString), region: region, logger: logger, on: eventLoop)
    }
}
