...
extension Gme {
    ...
    /// #### **功能试用说明：**
    ///
    /// - 打开前往[控制台 - 产品试用](https://console.cloud.tencent.com/gamegme/tryout)免费试用语音内容安全服务。
    ///
    /// #### **接口功能说明：**
    ///
    ...
    /// | 场景 | 描述 | Label |
    /// |---|---|---|
    /// | 语音检测 | 语音检测的检测类型 | normal:正常文本<br>porn:色情<br>abuse:谩骂<br>ad :广告<br>illegal :违法<br>moan :呻吟<br>customized:自定义词库 |
    ///
    /// #### **回调相关说明：**
    ///
