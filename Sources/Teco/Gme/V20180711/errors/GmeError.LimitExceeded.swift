...
extension TCGmeError.LimitExceeded: Equatable {
    public static func == (lhs: TCGmeError.LimitExceeded, rhs: TCGmeError.LimitExceeded) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCGmeError.LimitExceeded: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCGmeError.LimitExceeded {
