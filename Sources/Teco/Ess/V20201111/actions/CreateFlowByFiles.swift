...
extension Ess {
    ...
    public struct CreateFlowByFilesRequest: TCRequestModel {
        ...
        public init (`operator`: UserInfo, flowName: String, approvers: [ApproverInfo], fileIds: [String], flowType: String?, components: [Component]?, ccInfos: [CcInfo]?, needPreview: Bool?, previewType: Int64?, deadline: Int64?, unordered: Bool?, customShowMap: String?, needSignReview: Bool?, userData: String?, agent: Agent, approverVerifyType: String?, flowDescription: String?, signBeanTag: Int64?) {
