...
extension TCTdcpgError.ResourceUnavailable: Equatable {
    public static func == (lhs: TCTdcpgError.ResourceUnavailable, rhs: TCTdcpgError.ResourceUnavailable) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCTdcpgError.ResourceUnavailable: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCTdcpgError.ResourceUnavailable {
