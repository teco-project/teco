...
extension Vod {
    ...
    public struct LiveRealTimeClipRequest: TCRequestModel {
        ...
        public init (streamId: String, startTime: String, endTime: String, subAppId: UInt64?, isPersistence: Int64?, expireTime: String?, procedure: String?, classId: Int64?, sourceContext: String?, sessionContext: String?, metaDataRequired: UInt64?, host: String?, streamInfo: LiveRealTimeClipStreamInfo, extInfo: String?) {
