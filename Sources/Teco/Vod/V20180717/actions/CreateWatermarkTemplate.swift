...
extension Vod {
    ...
    public struct CreateWatermarkTemplateRequest: TCRequestModel {
        ...
        public init (type: String, subAppId: UInt64?, name: String?, comment: String?, coordinateOrigin: String?, xPos: String?, yPos: String?, imageTemplate: ImageWatermarkInput, textTemplate: TextWatermarkTemplateInput, svgTemplate: SvgWatermarkInput) {
            self.type = type
