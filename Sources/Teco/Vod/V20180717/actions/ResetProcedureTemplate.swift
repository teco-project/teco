...
extension Vod {
    ...
    public struct ResetProcedureTemplateRequest: TCRequestModel {
        ...
        public init (name: String, comment: String?, mediaProcessTask: MediaProcessTaskInput, aiContentReviewTask: AiContentReviewTaskInput, aiAnalysisTask: AiAnalysisTaskInput, aiRecognitionTask: AiRecognitionTaskInput, subAppId: UInt64?) {
            self.name = name
