...
extension Vod {
    ...
    public func createAnimatedGraphicsTemplate(fps: UInt64, subAppId: UInt64? = nil, width: UInt64? = nil, height: UInt64? = nil, resolutionAdaptive: String? = nil, format: String? = nil, quality: Float? = nil, name: String? = nil, comment: String? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture < CreateAnimatedGraphicsTemplateResponse > {
        self.createAnimatedGraphicsTemplate(CreateAnimatedGraphicsTemplateRequest(fps: fps, subAppId: subAppId, width: width, height: height, resolutionAdaptive: resolutionAdaptive, format: format, quality: quality, name: name, comment: comment), logger: logger, on: eventLoop)
    }
    ...
    public func createAnimatedGraphicsTemplate(fps: UInt64, subAppId: UInt64? = nil, width: UInt64? = nil, height: UInt64? = nil, resolutionAdaptive: String? = nil, format: String? = nil, quality: Float? = nil, name: String? = nil, comment: String? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateAnimatedGraphicsTemplateResponse {
        try await self.createAnimatedGraphicsTemplate(CreateAnimatedGraphicsTemplateRequest(fps: fps, subAppId: subAppId, width: width, height: height, resolutionAdaptive: resolutionAdaptive, format: format, quality: quality, name: name, comment: comment), logger: logger, on: eventLoop)
    }
}
