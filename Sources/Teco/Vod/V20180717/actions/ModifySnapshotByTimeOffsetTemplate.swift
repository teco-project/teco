...
extension Vod {
    ...
    public struct ModifySnapshotByTimeOffsetTemplateRequest: TCRequestModel {
        ...
        public init (definition: UInt64, subAppId: UInt64?, name: String?, width: UInt64?, height: UInt64?, resolutionAdaptive: String?, format: String?, comment: String?, fillType: String?) {
