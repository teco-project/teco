...
extension Vod {
    ...
    public struct SimpleHlsClipRequest: TCRequestModel {
        ...
        public init (url: String, subAppId: UInt64?, startTimeOffset: Float?, endTimeOffset: Float?, isPersistence: Int64?, expireTime: String?, procedure: String?, classId: Int64?, sourceContext: String?, sessionContext: String?) {
            self.url = url
