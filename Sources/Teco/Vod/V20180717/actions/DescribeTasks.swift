...
extension Vod {
    ...
    /// * 只能查询到最近三天（72 小时）内的任务。
    @inlinable
    public func describeTasks(subAppId: UInt64? = nil, status: String? = nil, fileId: String? = nil, createTime: TimeRange? = nil, finishTime: TimeRange? = nil, sort: SortBy? = nil, limit: UInt64? = nil, scrollToken: String? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeTasksResponse> {
        self.describeTasks(DescribeTasksRequest(subAppId: subAppId, status: status, fileId: fileId, createTime: createTime, finishTime: finishTime, sort: sort, limit: limit, scrollToken: scrollToken), logger: logger, on: eventLoop)
    }
    ...
    /// * 只能查询到最近三天（72 小时）内的任务。
    @inlinable
    public func describeTasks(subAppId: UInt64? = nil, status: String? = nil, fileId: String? = nil, createTime: TimeRange? = nil, finishTime: TimeRange? = nil, sort: SortBy? = nil, limit: UInt64? = nil, scrollToken: String? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeTasksResponse {
        try await self.describeTasks(DescribeTasksRequest(subAppId: subAppId, status: status, fileId: fileId, createTime: createTime, finishTime: finishTime, sort: sort, limit: limit, scrollToken: scrollToken), logger: logger, on: eventLoop)
    }
}
