...
extension Vod {
    ...
    public func describeHeadTailTemplates(subAppId: UInt64? = nil, definitions: [Int64]? = nil, offset: UInt64? = nil, limit: UInt64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeHeadTailTemplatesResponse> {
        ...
        return self.client.execute(action: "DescribeHeadTailTemplates", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    /// 获取片头片尾模板列表。
    @inlinable
    public func describeHeadTailTemplatesPaginator(_ input: DescribeHeadTailTemplatesRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> (results: TCClient.Paginator<DescribeHeadTailTemplatesRequest, DescribeHeadTailTemplatesResponse>.ResultSequence, responses: TCClient.Paginator<DescribeHeadTailTemplatesRequest, DescribeHeadTailTemplatesResponse>.ResponseSequence) {
        let results = TCClient.Paginator<DescribeHeadTailTemplatesRequest, DescribeHeadTailTemplatesResponse>.ResultSequence(input: input, region: region, command: self.describeHeadTailTemplates, logger: logger, on: eventLoop)
        let responses = TCClient.Paginator<DescribeHeadTailTemplatesRequest, DescribeHeadTailTemplatesResponse>.ResponseSequence(input: input, region: region, command: self.describeHeadTailTemplates, logger: logger, on: eventLoop)
