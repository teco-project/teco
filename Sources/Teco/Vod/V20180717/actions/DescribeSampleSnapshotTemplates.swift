...
extension Vod {
    ...
    public struct DescribeSampleSnapshotTemplatesRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribeSampleSnapshotTemplatesResponse) -> DescribeSampleSnapshotTemplatesRequest? {
            ...
            return DescribeSampleSnapshotTemplatesRequest(subAppId: self.subAppId, definitions: self.definitions, offset: (self.offset ?? 0) + .init(response.getItems().count), limit: self.limit, type: self.type)
        }
    }
