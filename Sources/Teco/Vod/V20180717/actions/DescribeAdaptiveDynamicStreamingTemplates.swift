...
extension Vod {
    ...
    public struct DescribeAdaptiveDynamicStreamingTemplatesResponse: TCResponseModel {
        /// 符合过滤条件的记录总数。
    ...
    /// 查询转自适应码流模板，支持根据条件，分页查询。
    @inlinable
    public func describeAdaptiveDynamicStreamingTemplates(subAppId: UInt64? = nil, definitions: [UInt64]? = nil, offset: UInt64? = nil, limit: UInt64? = nil, type: String? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeAdaptiveDynamicStreamingTemplatesResponse> {
        self.describeAdaptiveDynamicStreamingTemplates(DescribeAdaptiveDynamicStreamingTemplatesRequest(subAppId: subAppId, definitions: definitions, offset: offset, limit: limit, type: type), logger: logger, on: eventLoop)
    }
    ...
    /// 查询转自适应码流模板，支持根据条件，分页查询。
    @inlinable
    public func describeAdaptiveDynamicStreamingTemplates(subAppId: UInt64? = nil, definitions: [UInt64]? = nil, offset: UInt64? = nil, limit: UInt64? = nil, type: String? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeAdaptiveDynamicStreamingTemplatesResponse {
        try await self.describeAdaptiveDynamicStreamingTemplates(DescribeAdaptiveDynamicStreamingTemplatesRequest(subAppId: subAppId, definitions: definitions, offset: offset, limit: limit, type: type), logger: logger, on: eventLoop)
    }
}
