...
extension Vod {
    ...
    public struct ModifyAnimatedGraphicsTemplateRequest: TCRequestModel {
        ...
        public init (definition: UInt64, subAppId: UInt64?, name: String?, width: UInt64?, height: UInt64?, resolutionAdaptive: String?, format: String?, fps: UInt64?, quality: Float?, comment: String?) {
