...
extension TCSesError.LimitExceeded: Equatable {
    public static func == (lhs: TCSesError.LimitExceeded, rhs: TCSesError.LimitExceeded) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCSesError.LimitExceeded: CustomStringConvertible {
