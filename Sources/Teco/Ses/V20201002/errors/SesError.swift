public struct TCSesError: TCErrorType {
    enum Code: String {
...
extension TCSesError {
    public static var domains: [TCErrorType.Type] {
        return [FailedOperation.self, InvalidParameterValue.self, LimitExceeded.self, MissingParameter.self, OperationDenied.self]
    }
}

extension TCSesError: Equatable {
    public static func == (lhs: TCSesError, rhs: TCSesError) -> Bool {
        lhs.error == rhs.error
    }
}
