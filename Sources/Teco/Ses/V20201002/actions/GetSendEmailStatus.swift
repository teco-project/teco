...
extension Ses {
    ...
    public func getSendEmailStatusPaginator(_ input: GetSendEmailStatusRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> (results: TCClient.Paginator<GetSendEmailStatusRequest, GetSendEmailStatusResponse>.ResultSequence, responses: TCClient.Paginator<GetSendEmailStatusRequest, GetSendEmailStatusResponse>.ResponseSequence) {
        let results = TCClient.Paginator<GetSendEmailStatusRequest, GetSendEmailStatusResponse>.ResultSequence(input: input, region: region, command: self.getSendEmailStatus, logger: logger, on: eventLoop)
        let responses = TCClient.Paginator<GetSendEmailStatusRequest, GetSendEmailStatusResponse>.ResponseSequence(input: input, region: region, command: self.getSendEmailStatus, logger: logger, on: eventLoop)
