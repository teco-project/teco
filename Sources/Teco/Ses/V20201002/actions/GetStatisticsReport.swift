...
extension Ses {
    ...
    @inlinable
    public func getStatisticsReport(_ input: GetStatisticsReportRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetStatisticsReportResponse> {
        self.client.execute(action: "GetStatisticsReport", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    /// 获取近期发送的统计情况，包含发送量、送达率、打开率、退信率等一系列数据。
    @inlinable
    public func getStatisticsReport(_ input: GetStatisticsReportRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetStatisticsReportResponse {
        try await self.client.execute(action: "GetStatisticsReport", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop).get()
    }
    ...
    public func getStatisticsReport(startDate: Date, endDate: Date, domain: String? = nil, receivingMailboxType: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<GetStatisticsReportResponse> {
        self.getStatisticsReport(GetStatisticsReportRequest(startDate: startDate, endDate: endDate, domain: domain, receivingMailboxType: receivingMailboxType), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func getStatisticsReport(startDate: Date, endDate: Date, domain: String? = nil, receivingMailboxType: String? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> GetStatisticsReportResponse {
        try await self.getStatisticsReport(GetStatisticsReportRequest(startDate: startDate, endDate: endDate, domain: domain, receivingMailboxType: receivingMailboxType), region: region, logger: logger, on: eventLoop)
    }
}
