...
extension TCSmhError.RequestLimitExceeded: Equatable {
    public static func == (lhs: TCSmhError.RequestLimitExceeded, rhs: TCSmhError.RequestLimitExceeded) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCSmhError.RequestLimitExceeded: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCSmhError.RequestLimitExceeded {
