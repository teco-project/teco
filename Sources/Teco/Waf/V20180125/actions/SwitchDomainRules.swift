...
extension Waf {
    ...
    public struct SwitchDomainRulesRequest: TCRequest {
        ...
        public init(domain: String? = nil, ids: [UInt64]? = nil, status: UInt64? = nil, reason: UInt64? = nil) {
            self.domain = domain
            self.ids = ids
            self.status = status
            self.reason = reason
    ...
    /// 切换域名的规则开关
    @inlinable @discardableResult
    public func switchDomainRules(domain: String? = nil, ids: [UInt64]? = nil, status: UInt64? = nil, reason: UInt64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<SwitchDomainRulesResponse> {
        self.switchDomainRules(.init(domain: domain, ids: ids, status: status, reason: reason), region: region, logger: logger, on: eventLoop)
    }

    /// 切换域名的规则开关
    @inlinable @discardableResult
    public func switchDomainRules(domain: String? = nil, ids: [UInt64]? = nil, status: UInt64? = nil, reason: UInt64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> SwitchDomainRulesResponse {
