...
extension TCWafError.FailedOperation: Equatable {
    public static func == (lhs: TCWafError.FailedOperation, rhs: TCWafError.FailedOperation) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCWafError.FailedOperation: CustomStringConvertible {
