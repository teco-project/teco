...
extension Domain {
    ...
    public struct CertificateInfo: TCInputModel, TCOutputModel {
        ...
        /// 联系人证件号码。
        /// 注意：此字段可能返回 null，表示取不到有效值。
        public let registrantCertificateCode: String?
        ...
        /// GZJGZY: 公证机构执业证。
        /// 注意：此字段可能返回 null，表示取不到有效值。
        public let registrantCertificateType: String?

        /// 联系人证件照片地址。
        /// 注意：此字段可能返回 null，表示取不到有效值。
        public let registrantImgUrl: String?

        public init(certificateCode: String, certificateType: String, imgUrl: String, originImgUrl: String? = nil, registrantCertificateCode: String? = nil, registrantCertificateType: String? = nil, registrantImgUrl: String? = nil) {
            self.certificateCode = certificateCode
            self.certificateType = certificateType
            self.imgUrl = imgUrl
            self.originImgUrl = originImgUrl
            self.registrantCertificateCode = registrantCertificateCode
            self.registrantCertificateType = registrantCertificateType
            self.registrantImgUrl = registrantImgUrl
        }
        ...
        enum CodingKeys: String, CodingKey {
            ...
            case imgUrl = "ImgUrl"
            case originImgUrl = "OriginImgUrl"
            case registrantCertificateCode = "RegistrantCertificateCode"
            case registrantCertificateType = "RegistrantCertificateType"
            case registrantImgUrl = "RegistrantImgUrl"
        }
    }
