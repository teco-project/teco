...
extension Dcdb {
    ...
    public struct DescribeDCDBInstancesRequest: TCPaginatedRequest {
    ...
    public func describeDCDBInstances(instanceIds: [String]? = nil, searchName: String? = nil, searchKey: String? = nil, projectIds: [Int64]? = nil, isFilterVpc: Bool? = nil, vpcId: String? = nil, subnetId: String? = nil, orderBy: String? = nil, orderByType: String? = nil, offset: Int64? = nil, limit: Int64? = nil, exclusterType: Int64? = nil, isFilterExcluster: Bool? = nil, exclusterIds: [String]? = nil, tagKeys: [String]? = nil, filterInstanceType: String? = nil, status: [Int64]? = nil, excludeStatus: [Int64]? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeDCDBInstancesResponse> {
        let input = DescribeDCDBInstancesRequest(instanceIds: instanceIds, searchName: searchName, searchKey: searchKey, projectIds: projectIds, isFilterVpc: isFilterVpc, vpcId: vpcId, subnetId: subnetId, orderBy: orderBy, orderByType: orderByType, offset: offset, limit: limit, exclusterType: exclusterType, isFilterExcluster: isFilterExcluster, exclusterIds: exclusterIds, tagKeys: tagKeys, filterInstanceType: filterInstanceType, status: status, excludeStatus: excludeStatus)
        return self.client.execute(action: "DescribeDCDBInstances", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeDCDBInstances(instanceIds: [String]? = nil, searchName: String? = nil, searchKey: String? = nil, projectIds: [Int64]? = nil, isFilterVpc: Bool? = nil, vpcId: String? = nil, subnetId: String? = nil, orderBy: String? = nil, orderByType: String? = nil, offset: Int64? = nil, limit: Int64? = nil, exclusterType: Int64? = nil, isFilterExcluster: Bool? = nil, exclusterIds: [String]? = nil, tagKeys: [String]? = nil, filterInstanceType: String? = nil, status: [Int64]? = nil, excludeStatus: [Int64]? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeDCDBInstancesResponse {
        let input = DescribeDCDBInstancesRequest(instanceIds: instanceIds, searchName: searchName, searchKey: searchKey, projectIds: projectIds, isFilterVpc: isFilterVpc, vpcId: vpcId, subnetId: subnetId, orderBy: orderBy, orderByType: orderByType, offset: offset, limit: limit, exclusterType: exclusterType, isFilterExcluster: isFilterExcluster, exclusterIds: exclusterIds, tagKeys: tagKeys, filterInstanceType: filterInstanceType, status: status, excludeStatus: excludeStatus)
        return try await self.client.execute(action: "DescribeDCDBInstances", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop).get()
    }
    ...
    /// 如果不指定任何筛选条件，则默认返回10条实例记录，单次请求最多支持返回100条实例记录。
    @inlinable
    public func describeDCDBInstancesPaginated(_ input: DescribeDCDBInstancesRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<(Int64?, [DCDBInstanceInfo])> {
        self.client.paginate(input: input, region: region, command: self.describeDCDBInstances, logger: logger, on: eventLoop)
    }
