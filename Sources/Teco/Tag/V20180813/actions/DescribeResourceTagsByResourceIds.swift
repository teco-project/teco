...
extension Tag {
    ...
    public struct DescribeResourceTagsByResourceIdsRequest: TCPaginatedRequest {
        ...
        public func getNextPaginatedRequest(with response: DescribeResourceTagsByResourceIdsResponse) -> DescribeResourceTagsByResourceIdsRequest? {
            ...
            return DescribeResourceTagsByResourceIdsRequest(serviceType: self.serviceType, resourcePrefix: self.resourcePrefix, resourceIds: self.resourceIds, resourceRegion: self.resourceRegion, offset: (self.offset ?? 0) + response.offset, limit: self.limit)
        }
    }
