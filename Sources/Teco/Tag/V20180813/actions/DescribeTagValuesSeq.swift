...
extension Tag {
    ...
    public struct DescribeTagValuesSeqRequest: TCPaginatedRequest {
        ...
        public func getNextPaginatedRequest(with response: DescribeTagValuesSeqResponse) -> DescribeTagValuesSeqRequest? {
            guard !response.getItems().isEmpty else {
                return nil
            }
            return DescribeTagValuesSeqRequest(tagKeys: self.tagKeys, createUin: self.createUin, offset: (self.offset ?? 0) + response.offset, limit: self.limit)
        }
    }
