...
extension Tag {
    ...
    public struct DescribeResourceTagsByTagKeysRequest: TCPaginatedRequest {
        ...
        public func getNextPaginatedRequest(with response: DescribeResourceTagsByTagKeysResponse) -> DescribeResourceTagsByTagKeysRequest? {
            ...
            return DescribeResourceTagsByTagKeysRequest(serviceType: self.serviceType, resourcePrefix: self.resourcePrefix, resourceRegion: self.resourceRegion, resourceIds: self.resourceIds, tagKeys: self.tagKeys, limit: self.limit, offset: (self.offset ?? 0) + response.offset)
        }
    }
