...
extension Tag {
    ...
    public struct DescribeResourceTagsRequest: TCPaginatedRequest {
        ...
        public func getNextPaginatedRequest(with response: DescribeResourceTagsResponse) -> DescribeResourceTagsRequest? {
            ...
            return DescribeResourceTagsRequest(createUin: self.createUin, resourceRegion: self.resourceRegion, serviceType: self.serviceType, resourcePrefix: self.resourcePrefix, resourceId: self.resourceId, offset: (self.offset ?? 0) + response.offset, limit: self.limit, cosResourceId: self.cosResourceId)
        }
    }
