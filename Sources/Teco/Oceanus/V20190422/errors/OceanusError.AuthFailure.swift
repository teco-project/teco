...
extension TCOceanusError.AuthFailure: Equatable {
    public static func == (lhs: TCOceanusError.AuthFailure, rhs: TCOceanusError.AuthFailure) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCOceanusError.AuthFailure: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCOceanusError.AuthFailure {
