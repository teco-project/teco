...
extension Mongodb {
    ...
    public struct InquirePriceCreateDBInstancesRequest: TCRequestModel {
        ...
        /// 每个分片的主从节点数量。
        ///
        /// 取值范围：请通过接口<a href="https://cloud.tencent.com/document/product/240/38567">DescribeSpecInfo</a>查询，其返回的数据结构SpecItems中的参数MinNodeNum与MaxNodeNum分别对应其最小值与最大值。</li></ul>
        public let nodeNum: Int64

        /// 实例内存大小。
        /// - 单位：GB。
        /// - 取值范围：请通过接口<a href="https://cloud.tencent.com/document/product/240/38567">DescribeSpecInfo</a>查询，其返回的数据结构SpecItems中的参数CPU与Memory分别对应CPU核数与内存规格。
        public let memory: Int64

        /// 实例硬盘大小。
        /// - 单位：GB。
        /// - 取值范围：请通过接口<a href="https://cloud.tencent.com/document/product/240/38567">DescribeSpecInfo</a>查询，其返回的数据结构SpecItems中的参数MinStorage与MaxStorage分别对应其最小磁盘规格与最大磁盘规格。
        public let volume: Int64

        /// 实例版本信息。
        /// - 具体支持的版本，请通过接口<a href="https://cloud.tencent.com/document/product/240/38567">DescribeSpecInfo</a>查询，其返回的数据结构SpecItems中的参数MongoVersionCode为实例所支持的版本信息。</li>
        /// - 版本信息与版本号对应关系如下：
        ...
        /// 副本集个数。
        /// - 创建副本集实例时，该参数固定设置为1。
        /// - 创建分片集群时，指分片数量，请通过接口<a href="https://cloud.tencent.com/document/product/240/38567">DescribeSpecInfo</a>查询，其返回的数据结构SpecItems中的参数MinReplicateSetNum与MaxReplicateSetNum分别对应其最小值与最大值。
        /// - 若为单节点实例，该参数固定设置为0。
        public let replicateSetNum: Int64

        /// 选择包年包月计费模式时，您需要设定购买实例的时长。即**InstanceChargeType**设定为**PREPAID**时，该参数必须配置。
        /// - 单位：月。
    ...
    public func inquirePriceCreateDBInstances(zone: String, nodeNum: Int64, memory: Int64, volume: Int64, mongoVersion: String, machineCode: String, goodsNum: Int64, clusterType: String, replicateSetNum: Int64, period: Int64? = nil, instanceChargeType: String? = nil, mongosCpu: UInt64? = nil, mongosMemory: UInt64? = nil, mongosNum: UInt64? = nil, configServerCpu: UInt64? = nil, configServerMemory: UInt64? = nil, configServerVolume: UInt64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<InquirePriceCreateDBInstancesResponse> {
        self.inquirePriceCreateDBInstances(.init(zone: zone, nodeNum: nodeNum, memory: memory, volume: volume, mongoVersion: mongoVersion, machineCode: machineCode, goodsNum: goodsNum, clusterType: clusterType, replicateSetNum: replicateSetNum, period: period, instanceChargeType: instanceChargeType, mongosCpu: mongosCpu, mongosMemory: mongosMemory, mongosNum: mongosNum, configServerCpu: configServerCpu, configServerMemory: configServerMemory, configServerVolume: configServerVolume), region: region, logger: logger, on: eventLoop)
    }
