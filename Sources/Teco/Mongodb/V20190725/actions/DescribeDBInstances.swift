...
extension Mongodb {
    ...
    public struct DescribeDBInstancesRequest: TCRequestModel {
        ...
        public init (instanceIds: [String]?, instanceType: Int64?, clusterType: Int64?, status: [Int64]?, vpcId: String?, subnetId: String?, payMode: Int64?, limit: UInt64?, offset: UInt64?, orderBy: String?, orderByType: String?, projectIds: [UInt64]?, searchKey: String?, tags: TagInfo) {
