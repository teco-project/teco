...
extension TCDtsError.RequestLimitExceeded: Equatable {
    public static func == (lhs: TCDtsError.RequestLimitExceeded, rhs: TCDtsError.RequestLimitExceeded) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCDtsError.RequestLimitExceeded: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCDtsError.RequestLimitExceeded {
