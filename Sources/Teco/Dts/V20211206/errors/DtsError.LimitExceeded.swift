...
extension TCDtsError.LimitExceeded: Equatable {
    public static func == (lhs: TCDtsError.LimitExceeded, rhs: TCDtsError.LimitExceeded) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCDtsError.LimitExceeded: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCDtsError.LimitExceeded {
