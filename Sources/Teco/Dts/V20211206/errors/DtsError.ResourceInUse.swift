...
extension TCDtsError.ResourceInUse: Equatable {
    public static func == (lhs: TCDtsError.ResourceInUse, rhs: TCDtsError.ResourceInUse) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCDtsError.ResourceInUse: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCDtsError.ResourceInUse {
