...
extension TCDtsError.ResourcesSoldOut: Equatable {
    public static func == (lhs: TCDtsError.ResourcesSoldOut, rhs: TCDtsError.ResourcesSoldOut) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCDtsError.ResourcesSoldOut: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCDtsError.ResourcesSoldOut {
