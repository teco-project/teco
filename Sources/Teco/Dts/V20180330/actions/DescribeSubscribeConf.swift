...
extension Dts {
    ...
    @inlinable
    public func describeSubscribeConf(_ input: DescribeSubscribeConfRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeSubscribeConfResponse> {
        self.client.execute(action: "DescribeSubscribeConf", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    /// 本接口（DescribeSubscribeConf）用于查询订阅实例配置
    @inlinable
    public func describeSubscribeConf(_ input: DescribeSubscribeConfRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeSubscribeConfResponse {
        try await self.client.execute(action: "DescribeSubscribeConf", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop).get()
    }
    ...
    public func describeSubscribeConf(subscribeId: String, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeSubscribeConfResponse> {
        self.describeSubscribeConf(DescribeSubscribeConfRequest(subscribeId: subscribeId), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func describeSubscribeConf(subscribeId: String, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeSubscribeConfResponse {
        try await self.describeSubscribeConf(DescribeSubscribeConfRequest(subscribeId: subscribeId), region: region, logger: logger, on: eventLoop)
    }
}
