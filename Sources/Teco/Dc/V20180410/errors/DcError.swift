public struct TCDcError: TCErrorType {
    enum Code: String {
...
extension TCDcError {
    public static var domains: [TCErrorType.Type] {
        return [AuthFailure.self, InvalidParameter.self, InvalidParameterValue.self, LimitExceeded.self, ResourceInUse.self, ResourceNotFound.self, ResourceUnavailable.self, UnsupportedOperation.self]
    }
}

extension TCDcError: Equatable {
    public static func == (lhs: TCDcError, rhs: TCDcError) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCDcError: CustomStringConvertible {
