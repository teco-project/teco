...
extension Scf {
    ...
    public struct ListFunctionsRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: ListFunctionsResponse) -> ListFunctionsRequest? {
    ...
    public struct ListFunctionsResponse: TCPaginatedResponse {
        /// 函数列表
        ...
        /// Extract the returned ``Function`` list from the paginated response.
        public func getItems() -> [Function] {
            self.functions
        }
