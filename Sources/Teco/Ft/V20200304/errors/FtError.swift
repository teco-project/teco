public struct TCFtError: TCErrorType {
    enum Code: String {
...
extension TCFtError {
    public static var domains: [TCErrorType.Type] {
        return [FailedOperation.self, InvalidParameterValue.self, ResourceUnavailable.self, ResourcesSoldOut.self, UnsupportedOperation.self]
    }
}

extension TCFtError: Equatable {
    public static func == (lhs: TCFtError, rhs: TCFtError) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCFtError: CustomStringConvertible {
