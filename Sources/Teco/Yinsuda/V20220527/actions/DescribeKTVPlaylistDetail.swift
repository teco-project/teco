...
extension Yinsuda {
    ...
    public struct DescribeKTVPlaylistDetailRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribeKTVPlaylistDetailResponse) -> DescribeKTVPlaylistDetailRequest? {
            ...
            return .init(appName: self.appName, userId: self.userId, playlistId: self.playlistId, scrollToken: response.scrollToken, limit: self.limit, rightFilters: self.rightFilters, playScene: self.playScene, materialFilters: self.materialFilters)
        }
    }
