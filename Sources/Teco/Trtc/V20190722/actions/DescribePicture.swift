...
extension Trtc {
    ...
    public func describePicturePaginator(_ input: DescribePictureRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> (results: TCClient.Paginator<DescribePictureRequest, DescribePictureResponse>.ResultSequence, responses: TCClient.Paginator<DescribePictureRequest, DescribePictureResponse>.ResponseSequence) {
        let results = TCClient.Paginator<DescribePictureRequest, DescribePictureResponse>.ResultSequence(input: input, region: region, command: self.describePicture, logger: logger, on: eventLoop)
        let responses = TCClient.Paginator<DescribePictureRequest, DescribePictureResponse>.ResponseSequence(input: input, region: region, command: self.describePicture, logger: logger, on: eventLoop)
