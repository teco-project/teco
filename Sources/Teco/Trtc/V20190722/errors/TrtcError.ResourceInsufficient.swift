...
extension TCTrtcError {
    public struct ResourceInsufficient: TCErrorType {
        enum Code: String {
            case requestRejection = "ResourceInsufficient.RequestRejection"
        }
...
extension TCTrtcError.ResourceInsufficient: Equatable {
    public static func == (lhs: TCTrtcError.ResourceInsufficient, rhs: TCTrtcError.ResourceInsufficient) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCTrtcError.ResourceInsufficient: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCTrtcError.ResourceInsufficient {
