...
extension Gse {
    ...
    /// 本接口（DescribeTimerScalingPolicies）用于查询fleet下的定时器列表。可以通过fleetid，定时器名称分页查询。
    @inlinable
    public func describeTimerScalingPolicies(fleetId: String? = nil, timerName: String? = nil, beginTime: String? = nil, endTime: String? = nil, offset: Int64? = nil, limit: Int64? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture < DescribeTimerScalingPoliciesResponse > {
        self.describeTimerScalingPolicies(DescribeTimerScalingPoliciesRequest(fleetId: fleetId, timerName: timerName, beginTime: beginTime, endTime: endTime, offset: offset, limit: limit), logger: logger, on: eventLoop)
    }
    ...
    /// 本接口（DescribeTimerScalingPolicies）用于查询fleet下的定时器列表。可以通过fleetid，定时器名称分页查询。
    @inlinable
    public func describeTimerScalingPolicies(fleetId: String? = nil, timerName: String? = nil, beginTime: String? = nil, endTime: String? = nil, offset: Int64? = nil, limit: Int64? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DescribeTimerScalingPoliciesResponse {
        try await self.describeTimerScalingPolicies(DescribeTimerScalingPoliciesRequest(fleetId: fleetId, timerName: timerName, beginTime: beginTime, endTime: endTime, offset: offset, limit: limit), logger: logger, on: eventLoop)
    }
}
