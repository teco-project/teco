...
extension Gse {
    ...
    /// 本接口（CreateFleet）用于创建服务器舰队。
    @inlinable
    public func createFleet(assetId: String? = nil, description: String? = nil, inboundPermissions: [InboundPermission]? = nil, instanceType: String? = nil, fleetType: String? = nil, name: String? = nil, newGameServerSessionProtectionPolicy: String? = nil, peerVpcId: String? = nil, resourceCreationLimitPolicy: ResourceCreationLimitPolicy? = nil, runtimeConfiguration: RuntimeConfiguration? = nil, subNetId: String? = nil, gameServerSessionProtectionTimeLimit: Int64? = nil, tags: [Tag]? = nil, systemDiskInfo: DiskInfo? = nil, dataDiskInfo: [DiskInfo]? = nil, ccnInfos: [CcnInfo]? = nil, internetMaxBandwidthOut: Int64? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture < CreateFleetResponse > {
        self.createFleet(CreateFleetRequest(assetId: assetId, description: description, inboundPermissions: inboundPermissions, instanceType: instanceType, fleetType: fleetType, name: name, newGameServerSessionProtectionPolicy: newGameServerSessionProtectionPolicy, peerVpcId: peerVpcId, resourceCreationLimitPolicy: resourceCreationLimitPolicy, runtimeConfiguration: runtimeConfiguration, subNetId: subNetId, gameServerSessionProtectionTimeLimit: gameServerSessionProtectionTimeLimit, tags: tags, systemDiskInfo: systemDiskInfo, dataDiskInfo: dataDiskInfo, ccnInfos: ccnInfos, internetMaxBandwidthOut: internetMaxBandwidthOut), logger: logger, on: eventLoop)
    }
    ...
    /// 本接口（CreateFleet）用于创建服务器舰队。
    @inlinable
    public func createFleet(assetId: String? = nil, description: String? = nil, inboundPermissions: [InboundPermission]? = nil, instanceType: String? = nil, fleetType: String? = nil, name: String? = nil, newGameServerSessionProtectionPolicy: String? = nil, peerVpcId: String? = nil, resourceCreationLimitPolicy: ResourceCreationLimitPolicy? = nil, runtimeConfiguration: RuntimeConfiguration? = nil, subNetId: String? = nil, gameServerSessionProtectionTimeLimit: Int64? = nil, tags: [Tag]? = nil, systemDiskInfo: DiskInfo? = nil, dataDiskInfo: [DiskInfo]? = nil, ccnInfos: [CcnInfo]? = nil, internetMaxBandwidthOut: Int64? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateFleetResponse {
