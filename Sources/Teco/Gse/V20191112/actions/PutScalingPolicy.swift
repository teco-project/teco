...
extension Gse {
    ...
    public struct PutScalingPolicyRequest: TCRequestModel {
        ...
        public init (fleetId: String, name: String?, scalingAdjustment: Int64?, scalingAdjustmentType: String?, threshold: Float?, comparisonOperator: String?, evaluationPeriods: Int64?, metricName: String?, policyType: String?, targetConfiguration: TargetConfiguration) {
