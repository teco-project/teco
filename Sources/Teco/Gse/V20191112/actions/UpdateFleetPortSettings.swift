...
extension Gse {
    ...
    /// 本接口（UpdateFleetPortSettings）用于更新服务器舰队安全组。
    @inlinable
    public func updateFleetPortSettings(fleetId: String, inboundPermissionAuthorizations: [InboundPermissionAuthorization]? = nil, inboundPermissionRevocations: [InboundPermissionRevocations]? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture < UpdateFleetPortSettingsResponse > {
        self.updateFleetPortSettings(UpdateFleetPortSettingsRequest(fleetId: fleetId, inboundPermissionAuthorizations: inboundPermissionAuthorizations, inboundPermissionRevocations: inboundPermissionRevocations), logger: logger, on: eventLoop)
    }
    ...
    /// 本接口（UpdateFleetPortSettings）用于更新服务器舰队安全组。
    @inlinable
    public func updateFleetPortSettings(fleetId: String, inboundPermissionAuthorizations: [InboundPermissionAuthorization]? = nil, inboundPermissionRevocations: [InboundPermissionRevocations]? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> UpdateFleetPortSettingsResponse {
        try await self.updateFleetPortSettings(UpdateFleetPortSettingsRequest(fleetId: fleetId, inboundPermissionAuthorizations: inboundPermissionAuthorizations, inboundPermissionRevocations: inboundPermissionRevocations), logger: logger, on: eventLoop)
    }
}
