...
extension Gse {
    ...
    public struct SearchGameServerSessionsRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: SearchGameServerSessionsResponse) -> SearchGameServerSessionsRequest? {
            ...
            return .init(aliasId: self.aliasId, fleetId: self.fleetId, limit: self.limit, nextToken: response.nextToken, filterExpression: self.filterExpression, sortExpression: self.sortExpression)
        }
    }
