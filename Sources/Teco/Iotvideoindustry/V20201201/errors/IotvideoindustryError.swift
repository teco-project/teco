public struct TCIotvideoindustryError: TCErrorType {
    enum Code: String {
...
extension TCIotvideoindustryError {
    public static var domains: [TCErrorType.Type] {
        return [InternalError.self, InvalidParameter.self, InvalidParameterValue.self, ResourceNotFound.self, ResourceUnavailable.self, UnauthorizedOperation.self, UnsupportedOperation.self]
    }
}

extension TCIotvideoindustryError: Equatable {
    public static func == (lhs: TCIotvideoindustryError, rhs: TCIotvideoindustryError) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCIotvideoindustryError: CustomStringConvertible {
