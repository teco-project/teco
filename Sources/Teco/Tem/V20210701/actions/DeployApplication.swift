...
extension Tem {
    ...
    /// 应用部署
    @inlinable
    public func deployApplication(_ input: DeployApplicationRequest, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture < DeployApplicationResponse > {
        self.client.execute(action: "DeployApplication", serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    /// 应用部署
    @inlinable
    public func deployApplication(_ input: DeployApplicationRequest, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeployApplicationResponse {
        try await self.client.execute(action: "DeployApplication", serviceConfig: self.config, input: input, logger: logger, on: eventLoop).get()
    }
    ...
    public struct DeployApplicationRequest: TCRequestModel {
        ...
        public init (applicationId: String, initPodNum: UInt64, cpuSpec: Float, memorySpec: Float, environmentId: String, imgRepo: String?, versionDesc: String?, jvmOpts: String?, esInfo: EsInfo, envConf: [Pair]?, logConfs: [String]?, storageConfs: [StorageConf]?, storageMountConfs: [StorageMountConf]?, deployMode: String?, deployVersion: String?, pkgName: String?, jdkVersion: String?, securityGroupIds: [String]?, logOutputConf: LogOutputConf, sourceChannel: Int64?, description: String?, imageCommand: String?, imageArgs: [String]?, useRegistryDefaultConfig: Bool?, settingConfs: [MountedSettingConf]?, service: EksService, versionId: String?, postStart: String?, preStop: String?, liveness: HealthCheckConfig, readiness: HealthCheckConfig, deployStrategyConf: DeployStrategyConf, horizontalAutoscaler: [HorizontalAutoscaler]?, cronHorizontalAutoscaler: [CronHorizontalAutoscaler]?, logEnable: Int64?, confEdited: Bool?, speedUp: Bool?, startupProbe: HealthCheckConfig, osFlavour: String?, enablePrometheusConf: EnablePrometheusConf, enableTracing: Int64?, enableMetrics: Int64?, tcrInstanceId: String?, repoServer: String?, repoType: Int64?) {
