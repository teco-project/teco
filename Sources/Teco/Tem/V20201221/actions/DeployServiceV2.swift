...
extension Tem {
    ...
    /// 服务部署
    @inlinable
    public func deployServiceV2(_ input: DeployServiceV2Request, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeployServiceV2Response> {
        self.client.execute(action: "DeployServiceV2", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// 服务部署
    @inlinable
    public func deployServiceV2(_ input: DeployServiceV2Request, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeployServiceV2Response {
        try await self.client.execute(action: "DeployServiceV2", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop).get()
    }

    /// 服务部署
    @inlinable
    public func deployServiceV2(serviceId: String, containerPort: UInt64, initPodNum: UInt64, cpuSpec: Float, memorySpec: Float, namespaceId: String, imgRepo: String? = nil, versionDesc: String? = nil, jvmOpts: String? = nil, esInfo: EsInfo? = nil, envConf: [Pair]? = nil, logConfs: [String]? = nil, storageConfs: [StorageConf]? = nil, storageMountConfs: [StorageMountConf]? = nil, deployMode: String? = nil, deployVersion: String? = nil, pkgName: String? = nil, jdkVersion: String? = nil, securityGroupIds: [String]? = nil, logOutputConf: LogOutputConf? = nil, sourceChannel: Int64? = nil, description: String? = nil, imageCommand: String? = nil, imageArgs: [String]? = nil, portMappings: [PortMapping]? = nil, useRegistryDefaultConfig: Bool? = nil, settingConfs: [MountedSettingConf]? = nil, eksService: EksService? = nil, versionId: String? = nil, postStart: String? = nil, preStop: String? = nil, deployStrategyConf: DeployStrategyConf? = nil, liveness: HealthCheckConfig? = nil, readiness: HealthCheckConfig? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DeployServiceV2Response> {
        let input = DeployServiceV2Request(serviceId: serviceId, containerPort: containerPort, initPodNum: initPodNum, cpuSpec: cpuSpec, memorySpec: memorySpec, namespaceId: namespaceId, imgRepo: imgRepo, versionDesc: versionDesc, jvmOpts: jvmOpts, esInfo: esInfo, envConf: envConf, logConfs: logConfs, storageConfs: storageConfs, storageMountConfs: storageMountConfs, deployMode: deployMode, deployVersion: deployVersion, pkgName: pkgName, jdkVersion: jdkVersion, securityGroupIds: securityGroupIds, logOutputConf: logOutputConf, sourceChannel: sourceChannel, description: description, imageCommand: imageCommand, imageArgs: imageArgs, portMappings: portMappings, useRegistryDefaultConfig: useRegistryDefaultConfig, settingConfs: settingConfs, eksService: eksService, versionId: versionId, postStart: postStart, preStop: preStop, deployStrategyConf: deployStrategyConf, liveness: liveness, readiness: readiness)
        return self.client.execute(action: "DeployServiceV2", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// 服务部署
    @inlinable
    public func deployServiceV2(serviceId: String, containerPort: UInt64, initPodNum: UInt64, cpuSpec: Float, memorySpec: Float, namespaceId: String, imgRepo: String? = nil, versionDesc: String? = nil, jvmOpts: String? = nil, esInfo: EsInfo? = nil, envConf: [Pair]? = nil, logConfs: [String]? = nil, storageConfs: [StorageConf]? = nil, storageMountConfs: [StorageMountConf]? = nil, deployMode: String? = nil, deployVersion: String? = nil, pkgName: String? = nil, jdkVersion: String? = nil, securityGroupIds: [String]? = nil, logOutputConf: LogOutputConf? = nil, sourceChannel: Int64? = nil, description: String? = nil, imageCommand: String? = nil, imageArgs: [String]? = nil, portMappings: [PortMapping]? = nil, useRegistryDefaultConfig: Bool? = nil, settingConfs: [MountedSettingConf]? = nil, eksService: EksService? = nil, versionId: String? = nil, postStart: String? = nil, preStop: String? = nil, deployStrategyConf: DeployStrategyConf? = nil, liveness: HealthCheckConfig? = nil, readiness: HealthCheckConfig? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> DeployServiceV2Response {
        let input = DeployServiceV2Request(serviceId: serviceId, containerPort: containerPort, initPodNum: initPodNum, cpuSpec: cpuSpec, memorySpec: memorySpec, namespaceId: namespaceId, imgRepo: imgRepo, versionDesc: versionDesc, jvmOpts: jvmOpts, esInfo: esInfo, envConf: envConf, logConfs: logConfs, storageConfs: storageConfs, storageMountConfs: storageMountConfs, deployMode: deployMode, deployVersion: deployVersion, pkgName: pkgName, jdkVersion: jdkVersion, securityGroupIds: securityGroupIds, logOutputConf: logOutputConf, sourceChannel: sourceChannel, description: description, imageCommand: imageCommand, imageArgs: imageArgs, portMappings: portMappings, useRegistryDefaultConfig: useRegistryDefaultConfig, settingConfs: settingConfs, eksService: eksService, versionId: versionId, postStart: postStart, preStop: preStop, deployStrategyConf: deployStrategyConf, liveness: liveness, readiness: readiness)
        return try await self.client.execute(action: "DeployServiceV2", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop).get()
    }
}
