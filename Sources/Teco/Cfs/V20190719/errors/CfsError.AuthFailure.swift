...
extension TCCfsError.AuthFailure: Equatable {
    public static func == (lhs: TCCfsError.AuthFailure, rhs: TCCfsError.AuthFailure) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCCfsError.AuthFailure: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCCfsError.AuthFailure {
