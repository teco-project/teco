...
extension TCAaError.UnknownParameter: Equatable {
    public static func == (lhs: TCAaError.UnknownParameter, rhs: TCAaError.UnknownParameter) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCAaError.UnknownParameter: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCAaError.UnknownParameter {
