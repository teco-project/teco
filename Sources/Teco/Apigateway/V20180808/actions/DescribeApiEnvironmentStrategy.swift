...
extension Apigateway {
    ...
    public struct DescribeApiEnvironmentStrategyRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribeApiEnvironmentStrategyResponse) -> DescribeApiEnvironmentStrategyRequest? {
            ...
            return .init(serviceId: self.serviceId, environmentNames: self.environmentNames, apiId: self.apiId, limit: self.limit, offset: (self.offset ?? 0) + .init(response.getItems().count))
        }
    }
    ...
    public struct DescribeApiEnvironmentStrategyResponse: TCPaginatedResponse {
        ...
        public let result: ApiEnvironmentStrategyStatus?
