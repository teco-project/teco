public struct TCDlcError: TCErrorType {
    enum Code: String {
...
extension TCDlcError {
    public static var domains: [TCErrorType.Type] {
        return [FailedOperation.self, InternalError.self, InvalidParameter.self, ResourceNotFound.self, ResourceUnavailable.self, ResourcesSoldOut.self, UnauthorizedOperation.self, UnsupportedOperation.self]
    }
}

extension TCDlcError: Equatable {
    public static func == (lhs: TCDlcError, rhs: TCDlcError) -> Bool {
        lhs.error == rhs.error
    }
}
