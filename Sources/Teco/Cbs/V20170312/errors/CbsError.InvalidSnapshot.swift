...
extension TCCbsError {
    public struct InvalidSnapshot: TCErrorType {
        enum Code: String {
...
extension TCCbsError.InvalidSnapshot: Equatable {
    public static func == (lhs: TCCbsError.InvalidSnapshot, rhs: TCCbsError.InvalidSnapshot) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCCbsError.InvalidSnapshot: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCCbsError.InvalidSnapshot {
