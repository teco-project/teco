...
extension TCCbsError {
    public struct InvalidSnapshotId: TCErrorType {
        enum Code: String {
...
extension TCCbsError.InvalidSnapshotId: Equatable {
    public static func == (lhs: TCCbsError.InvalidSnapshotId, rhs: TCCbsError.InvalidSnapshotId) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCCbsError.InvalidSnapshotId: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCCbsError.InvalidSnapshotId {
