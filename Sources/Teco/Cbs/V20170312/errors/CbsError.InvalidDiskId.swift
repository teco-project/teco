...
extension TCCbsError {
    public struct InvalidDiskId: TCErrorType {
        enum Code: String {
...
extension TCCbsError.InvalidDiskId: Equatable {
    public static func == (lhs: TCCbsError.InvalidDiskId, rhs: TCCbsError.InvalidDiskId) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCCbsError.InvalidDiskId: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCCbsError.InvalidDiskId {
