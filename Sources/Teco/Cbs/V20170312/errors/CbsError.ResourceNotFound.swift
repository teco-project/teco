...
extension TCCbsError.ResourceNotFound: Equatable {
    public static func == (lhs: TCCbsError.ResourceNotFound, rhs: TCCbsError.ResourceNotFound) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCCbsError.ResourceNotFound: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCCbsError.ResourceNotFound {
