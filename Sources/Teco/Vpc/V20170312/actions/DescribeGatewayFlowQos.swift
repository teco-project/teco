...
extension Vpc {
    ...
    public struct DescribeGatewayFlowQosRequest: TCPaginatedRequest {
        ...
        public func makeNextRequest(with response: DescribeGatewayFlowQosResponse) -> DescribeGatewayFlowQosRequest? {
            ...
            return DescribeGatewayFlowQosRequest(gatewayId: self.gatewayId, ipAddresses: self.ipAddresses, offset: (self.offset ?? 0) + .init(response.getItems().count), limit: self.limit)
        }
    }
