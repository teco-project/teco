...
extension Vpc {
    ...
    public struct DescribeDirectConnectGatewayCcnRoutesRequest: TCPaginatedRequest {
        ...
        public func getNextPaginatedRequest(with response: DescribeDirectConnectGatewayCcnRoutesResponse) -> DescribeDirectConnectGatewayCcnRoutesRequest? {
            guard !response.getItems().isEmpty else {
                return nil
            }
            return DescribeDirectConnectGatewayCcnRoutesRequest(directConnectGatewayId: self.directConnectGatewayId, ccnRouteType: self.ccnRouteType, offset: (self.offset ?? 0) + .init(response.getItems().count), limit: self.limit)
        }
    }
    ...
    public func describeDirectConnectGatewayCcnRoutesPaginator(_ input: DescribeDirectConnectGatewayCcnRoutesRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> (results: TCClient.Paginator<DescribeDirectConnectGatewayCcnRoutesRequest, DescribeDirectConnectGatewayCcnRoutesResponse>.ResultSequence, responses: TCClient.Paginator<DescribeDirectConnectGatewayCcnRoutesRequest, DescribeDirectConnectGatewayCcnRoutesResponse>.ResponseSequence) {
        let results = TCClient.Paginator<DescribeDirectConnectGatewayCcnRoutesRequest, DescribeDirectConnectGatewayCcnRoutesResponse>.ResultSequence(input: input, region: region, command: self.describeDirectConnectGatewayCcnRoutes, logger: logger, on: eventLoop)
        let responses = TCClient.Paginator<DescribeDirectConnectGatewayCcnRoutesRequest, DescribeDirectConnectGatewayCcnRoutesResponse>.ResponseSequence(input: input, region: region, command: self.describeDirectConnectGatewayCcnRoutes, logger: logger, on: eventLoop)
