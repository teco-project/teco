...
extension Vpc {
    ...
    public struct DeleteNatGatewayDestinationIpPortTranslationNatRuleRequest: TCRequest {
    ...
    public struct DeleteNatGatewayDestinationIpPortTranslationNatRuleResponse: TCResponse {
