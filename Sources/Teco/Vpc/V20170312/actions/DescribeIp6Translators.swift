...
extension Vpc {
    ...
    public struct DescribeIp6TranslatorsRequest: TCRequestModel {
        ...
        public init (ip6TranslatorIds: [String]?, filters: [Filter]?, offset: Int64?, limit: Int64?) {
    ...
    public struct DescribeIp6TranslatorsResponse: TCResponseModel {
        /// 符合过滤条件的IPV6转换实例数量。
