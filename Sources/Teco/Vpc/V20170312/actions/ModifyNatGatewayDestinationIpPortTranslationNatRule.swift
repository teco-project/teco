...
extension Vpc {
    ...
    public struct ModifyNatGatewayDestinationIpPortTranslationNatRuleRequest: TCRequest {
    ...
    public struct ModifyNatGatewayDestinationIpPortTranslationNatRuleResponse: TCResponse {
