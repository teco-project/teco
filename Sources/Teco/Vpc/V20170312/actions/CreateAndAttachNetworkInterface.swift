...
extension Vpc {
    ...
    public struct CreateAndAttachNetworkInterfaceRequest: TCRequestModel {
        ...
        public init (vpcId: String, networkInterfaceName: String, subnetId: String, instanceId: String, privateIpAddresses: [PrivateIpAddressSpecification]?, secondaryPrivateIpAddressCount: UInt64?, securityGroupIds: [String]?, networkInterfaceDescription: String?, tags: [Tag]?, attachType: UInt64?) {
            self.vpcId = vpcId
