...
extension Vpc {
    ...
    public struct DescribeCrossBorderComplianceRequest: TCPaginatedRequest {
        /// （精确匹配）服务商，可选值：`UNICOM`。
    ...
    public struct DescribeCrossBorderComplianceResponse: TCPaginatedResponse {
        /// 合规化审批单列表。
    ...
    public func describeCrossBorderCompliance(serviceProvider: String? = nil, complianceId: UInt64? = nil, company: String? = nil, uniformSocialCreditCode: String? = nil, legalPerson: String? = nil, issuingAuthority: String? = nil, businessAddress: String? = nil, postCode: UInt64? = nil, manager: String? = nil, managerId: String? = nil, managerAddress: String? = nil, managerTelephone: String? = nil, email: String? = nil, serviceStartDate: String? = nil, serviceEndDate: String? = nil, state: String? = nil, offset: UInt64? = nil, limit: UInt64? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<DescribeCrossBorderComplianceResponse> {
        ...
        return self.client.execute(action: "DescribeCrossBorderCompliance", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }
    ...
    public func describeCrossBorderCompliancePaginator(_ input: DescribeCrossBorderComplianceRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> (results: TCClient.Paginator<DescribeCrossBorderComplianceRequest, DescribeCrossBorderComplianceResponse>.ResultSequence, responses: TCClient.Paginator<DescribeCrossBorderComplianceRequest, DescribeCrossBorderComplianceResponse>.ResponseSequence) {
        let results = TCClient.Paginator<DescribeCrossBorderComplianceRequest, DescribeCrossBorderComplianceResponse>.ResultSequence(input: input, region: region, command: self.describeCrossBorderCompliance, logger: logger, on: eventLoop)
        let responses = TCClient.Paginator<DescribeCrossBorderComplianceRequest, DescribeCrossBorderComplianceResponse>.ResponseSequence(input: input, region: region, command: self.describeCrossBorderCompliance, logger: logger, on: eventLoop)
