...
extension TCVpcError.OperationDenied: Equatable {
    public static func == (lhs: TCVpcError.OperationDenied, rhs: TCVpcError.OperationDenied) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCVpcError.OperationDenied: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCVpcError.OperationDenied {
