...
extension TCVpcError.ResourceUnavailable: Equatable {
    public static func == (lhs: TCVpcError.ResourceUnavailable, rhs: TCVpcError.ResourceUnavailable) -> Bool {
        lhs.error == rhs.error
    }
}

extension TCVpcError.ResourceUnavailable: CustomStringConvertible {
    public var description: String {
        return "\(self.error.rawValue): \(message ?? "")"
    }
}

extension TCVpcError.ResourceUnavailable {
