...
extension Cfw {
    ...
    public struct CreateNatFwInstanceWithDomainRequest: TCRequest {
        /// 防火墙实例名称
    ...
    public struct CreateNatFwInstanceWithDomainResponse: TCResponse {
        /// nat实例信息
    ...
    @inlinable
    public func createNatFwInstanceWithDomain(_ input: CreateNatFwInstanceWithDomainRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateNatFwInstanceWithDomainResponse> {
        self.client.execute(action: "CreateNatFwInstanceWithDomain", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop)
    }

    /// 创建防火墙实例和接入域名（Region参数必填）
    @inlinable
    public func createNatFwInstanceWithDomain(_ input: CreateNatFwInstanceWithDomainRequest, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateNatFwInstanceWithDomainResponse {
        try await self.client.execute(action: "CreateNatFwInstanceWithDomain", region: region, serviceConfig: self.config, input: input, logger: logger, on: eventLoop).get()
    }
    ...
    public func createNatFwInstanceWithDomain(name: String, width: Int64, mode: Int64, newModeItems: NewModeItems? = nil, natGwList: [String]? = nil, zone: String? = nil, zoneBak: String? = nil, crossAZone: Int64? = nil, isCreateDomain: Int64? = nil, domain: String? = nil, fwCidrInfo: FwCidrInfo? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) -> EventLoopFuture<CreateNatFwInstanceWithDomainResponse> {
        self.createNatFwInstanceWithDomain(.init(name: name, width: width, mode: mode, newModeItems: newModeItems, natGwList: natGwList, zone: zone, zoneBak: zoneBak, crossAZone: crossAZone, isCreateDomain: isCreateDomain, domain: domain, fwCidrInfo: fwCidrInfo), region: region, logger: logger, on: eventLoop)
    }
    ...
    public func createNatFwInstanceWithDomain(name: String, width: Int64, mode: Int64, newModeItems: NewModeItems? = nil, natGwList: [String]? = nil, zone: String? = nil, zoneBak: String? = nil, crossAZone: Int64? = nil, isCreateDomain: Int64? = nil, domain: String? = nil, fwCidrInfo: FwCidrInfo? = nil, region: TCRegion? = nil, logger: Logger = TCClient.loggingDisabled, on eventLoop: EventLoop? = nil) async throws -> CreateNatFwInstanceWithDomainResponse {
        try await self.createNatFwInstanceWithDomain(.init(name: name, width: width, mode: mode, newModeItems: newModeItems, natGwList: natGwList, zone: zone, zoneBak: zoneBak, crossAZone: crossAZone, isCreateDomain: isCreateDomain, domain: domain, fwCidrInfo: fwCidrInfo), region: region, logger: logger, on: eventLoop)
    }
}
